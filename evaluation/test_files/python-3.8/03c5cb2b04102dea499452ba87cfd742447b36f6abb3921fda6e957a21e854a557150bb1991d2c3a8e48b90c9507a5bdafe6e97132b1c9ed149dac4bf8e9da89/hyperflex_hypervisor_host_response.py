...
class HyperflexHypervisorHostResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {'hyperflex.HypervisorHost.List': HyperflexHypervisorHostList, 'mo.AggregateTransform': MoAggregateTransform, 'mo.DocumentCount': MoDocumentCount, 'mo.TagSummary': MoTagSummary}
        if not val:
            return None
    ...
    def _composed_schemas():
        lazy_import()
        return {'anyOf': [], 'allOf': [], 'oneOf': [HyperflexHypervisorHostList, MoAggregateTransform, MoDocumentCount, MoTagSummary]}