...
def generate_numba_apply_func(kwargs: dict[str, Any], func: Callable[..., Scalar], engine_kwargs: dict[str, bool] | None, name: str):
    """
...
def generate_numba_ewm_func(engine_kwargs: dict[str, bool] | None, com: float, adjust: bool, ignore_na: bool, deltas: np.ndarray, normalize: bool):
    """
...
def generate_numba_table_func(kwargs: dict[str, Any], func: Callable[..., np.ndarray], engine_kwargs: dict[str, bool] | None, name: str):
    """
...
def generate_numba_ewm_table_func(engine_kwargs: dict[str, bool] | None, com: float, adjust: bool, ignore_na: bool, deltas: np.ndarray, normalize: bool):
    """
