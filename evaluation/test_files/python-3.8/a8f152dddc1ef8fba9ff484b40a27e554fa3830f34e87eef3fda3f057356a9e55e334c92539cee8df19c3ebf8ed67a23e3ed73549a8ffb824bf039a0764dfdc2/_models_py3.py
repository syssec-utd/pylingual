...
class AddressSpace(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'address_prefixes': {'key': 'addressPrefixes', 'type': '[str]'}}
...
class Resource(msrest.serialization.Model):
    ...
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}}

    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, **kwargs):
        """
...
class ApplicationGatewayAuthenticationCertificate(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'data': {'key': 'properties.data', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, type: Optional[str]=None, data: Optional[str]=None, provisioning_state: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
...
class ApplicationGatewayAutoscaleConfiguration(msrest.serialization.Model):
    ...
    """
    _validation = {'min_capacity': {'required': True, 'minimum': 2}}
    _attribute_map = {'min_capacity': {'key': 'minCapacity', 'type': 'int'}}
...
class ApplicationGatewayAvailableSslOptions(Resource):
    ...
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'predefined_policies': {'key': 'properties.predefinedPolicies', 'type': '[SubResource]'}, 'default_policy': {'key': 'properties.defaultPolicy', 'type': 'str'}, 'available_cipher_suites': {'key': 'properties.availableCipherSuites', 'type': '[str]'}, 'available_protocols': {'key': 'properties.availableProtocols', 'type': '[str]'}}

    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, predefined_policies: Optional[List['_models.SubResource']]=None, default_policy: Optional[Union[str, '_models.ApplicationGatewaySslPolicyName']]=None, available_cipher_suites: Optional[List[Union[str, '_models.ApplicationGatewaySslCipherSuite']]]=None, available_protocols: Optional[List[Union[str, '_models.ApplicationGatewaySslProtocol']]]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class ApplicationGatewayAvailableSslPredefinedPolicies(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[ApplicationGatewaySslPredefinedPolicy]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.ApplicationGatewaySslPredefinedPolicy']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ApplicationGatewayAvailableWafRuleSetsResult(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[ApplicationGatewayFirewallRuleSet]'}}
...
class ApplicationGatewayBackendAddress(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'fqdn': {'key': 'fqdn', 'type': 'str'}, 'ip_address': {'key': 'ipAddress', 'type': 'str'}}
...
class ApplicationGatewayBackendHealth(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'backend_address_pools': {'key': 'backendAddressPools', 'type': '[ApplicationGatewayBackendHealthPool]'}}

    def __init__(self, *, backend_address_pools: Optional[List['_models.ApplicationGatewayBackendHealthPool']]=None, **kwargs):
        """
...
class ApplicationGatewayBackendHealthHttpSettings(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'backend_http_settings': {'key': 'backendHttpSettings', 'type': 'ApplicationGatewayBackendHttpSettings'}, 'servers': {'key': 'servers', 'type': '[ApplicationGatewayBackendHealthServer]'}}

    def __init__(self, *, backend_http_settings: Optional['_models.ApplicationGatewayBackendHttpSettings']=None, servers: Optional[List['_models.ApplicationGatewayBackendHealthServer']]=None, **kwargs):
        """
...
class ApplicationGatewayBackendHealthPool(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'backend_address_pool': {'key': 'backendAddressPool', 'type': 'ApplicationGatewayBackendAddressPool'}, 'backend_http_settings_collection': {'key': 'backendHttpSettingsCollection', 'type': '[ApplicationGatewayBackendHealthHttpSettings]'}}

    def __init__(self, *, backend_address_pool: Optional['_models.ApplicationGatewayBackendAddressPool']=None, backend_http_settings_collection: Optional[List['_models.ApplicationGatewayBackendHealthHttpSettings']]=None, **kwargs):
        """
...
class ApplicationGatewayBackendHealthServer(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'address': {'key': 'address', 'type': 'str'}, 'ip_configuration': {'key': 'ipConfiguration', 'type': 'NetworkInterfaceIPConfiguration'}, 'health': {'key': 'health', 'type': 'str'}}

    def __init__(self, *, address: Optional[str]=None, ip_configuration: Optional['_models.NetworkInterfaceIPConfiguration']=None, health: Optional[Union[str, '_models.ApplicationGatewayBackendHealthServerHealth']]=None, **kwargs):
        """
...
class ApplicationGatewayConnectionDraining(msrest.serialization.Model):
    ...
    """
    _validation = {'enabled': {'required': True}, 'drain_timeout_in_sec': {'required': True, 'maximum': 3600, 'minimum': 1}}
    _attribute_map = {'enabled': {'key': 'enabled', 'type': 'bool'}, 'drain_timeout_in_sec': {'key': 'drainTimeoutInSec', 'type': 'int'}}
...
class ApplicationGatewayCustomError(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'status_code': {'key': 'statusCode', 'type': 'str'}, 'custom_error_page_url': {'key': 'customErrorPageUrl', 'type': 'str'}}

    def __init__(self, *, status_code: Optional[Union[str, '_models.ApplicationGatewayCustomErrorStatusCode']]=None, custom_error_page_url: Optional[str]=None, **kwargs):
        """
...
class ApplicationGatewayFirewallDisabledRuleGroup(msrest.serialization.Model):
    ...
    """
    _validation = {'rule_group_name': {'required': True}}
    _attribute_map = {'rule_group_name': {'key': 'ruleGroupName', 'type': 'str'}, 'rules': {'key': 'rules', 'type': '[int]'}}
...
class ApplicationGatewayFirewallExclusion(msrest.serialization.Model):
    ...
    """
    _validation = {'match_variable': {'required': True}, 'selector_match_operator': {'required': True}, 'selector': {'required': True}}
    _attribute_map = {'match_variable': {'key': 'matchVariable', 'type': 'str'}, 'selector_match_operator': {'key': 'selectorMatchOperator', 'type': 'str'}, 'selector': {'key': 'selector', 'type': 'str'}}
...
class ApplicationGatewayFirewallRule(msrest.serialization.Model):
    ...
    """
    _validation = {'rule_id': {'required': True}}
    _attribute_map = {'rule_id': {'key': 'ruleId', 'type': 'int'}, 'description': {'key': 'description', 'type': 'str'}}
...
class ApplicationGatewayFirewallRuleGroup(msrest.serialization.Model):
    ...
    """
    _validation = {'rule_group_name': {'required': True}, 'rules': {'required': True}}
    _attribute_map = {'rule_group_name': {'key': 'ruleGroupName', 'type': 'str'}, 'description': {'key': 'description', 'type': 'str'}, 'rules': {'key': 'rules', 'type': '[ApplicationGatewayFirewallRule]'}}

    def __init__(self, *, rule_group_name: str, rules: List['_models.ApplicationGatewayFirewallRule'], description: Optional[str]=None, **kwargs):
        """
...
class ApplicationGatewayFirewallRuleSet(Resource):
    ...
    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, provisioning_state: Optional[str]=None, rule_set_type: Optional[str]=None, rule_set_version: Optional[str]=None, rule_groups: Optional[List['_models.ApplicationGatewayFirewallRuleGroup']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class ApplicationGatewayFrontendPort(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'port': {'key': 'properties.port', 'type': 'int'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, type: Optional[str]=None, port: Optional[int]=None, provisioning_state: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
...
class ApplicationGatewayHttpListener(SubResource):
    ...
    :vartype custom_error_configurations:
     list[~azure.mgmt.network.v2018_08_01.models.ApplicationGatewayCustomError]
    """
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'frontend_ip_configuration': {'key': 'properties.frontendIPConfiguration', 'type': 'SubResource'}, 'frontend_port': {'key': 'properties.frontendPort', 'type': 'SubResource'}, 'protocol': {'key': 'properties.protocol', 'type': 'str'}, 'host_name': {'key': 'properties.hostName', 'type': 'str'}, 'ssl_certificate': {'key': 'properties.sslCertificate', 'type': 'SubResource'}, 'require_server_name_indication': {'key': 'properties.requireServerNameIndication', 'type': 'bool'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}, 'custom_error_configurations': {'key': 'properties.customErrorConfigurations', 'type': '[ApplicationGatewayCustomError]'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, type: Optional[str]=None, frontend_ip_configuration: Optional['_models.SubResource']=None, frontend_port: Optional['_models.SubResource']=None, protocol: Optional[Union[str, '_models.ApplicationGatewayProtocol']]=None, host_name: Optional[str]=None, ssl_certificate: Optional['_models.SubResource']=None, require_server_name_indication: Optional[bool]=None, provisioning_state: Optional[str]=None, custom_error_configurations: Optional[List['_models.ApplicationGatewayCustomError']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
...
class ApplicationGatewayIPConfiguration(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'subnet': {'key': 'properties.subnet', 'type': 'SubResource'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, type: Optional[str]=None, subnet: Optional['_models.SubResource']=None, provisioning_state: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
...
class ApplicationGatewayListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[ApplicationGateway]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.ApplicationGateway']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ApplicationGatewayProbeHealthResponseMatch(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'body': {'key': 'body', 'type': 'str'}, 'status_codes': {'key': 'statusCodes', 'type': '[str]'}}
...
class ApplicationGatewayRequestRoutingRule(SubResource):
    ...
    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, type: Optional[str]=None, rule_type: Optional[Union[str, '_models.ApplicationGatewayRequestRoutingRuleType']]=None, backend_address_pool: Optional['_models.SubResource']=None, backend_http_settings: Optional['_models.SubResource']=None, http_listener: Optional['_models.SubResource']=None, url_path_map: Optional['_models.SubResource']=None, redirect_configuration: Optional['_models.SubResource']=None, provisioning_state: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
...
class ApplicationGatewaySku(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'tier': {'key': 'tier', 'type': 'str'}, 'capacity': {'key': 'capacity', 'type': 'int'}}

    def __init__(self, *, name: Optional[Union[str, '_models.ApplicationGatewaySkuName']]=None, tier: Optional[Union[str, '_models.ApplicationGatewayTier']]=None, capacity: Optional[int]=None, **kwargs):
        """
...
class ApplicationGatewaySslCertificate(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'data': {'key': 'properties.data', 'type': 'str'}, 'password': {'key': 'properties.password', 'type': 'str'}, 'public_cert_data': {'key': 'properties.publicCertData', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, type: Optional[str]=None, data: Optional[str]=None, password: Optional[str]=None, public_cert_data: Optional[str]=None, provisioning_state: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
...
class ApplicationGatewaySslPredefinedPolicy(SubResource):
    ...
    :vartype min_protocol_version: str or
     ~azure.mgmt.network.v2018_08_01.models.ApplicationGatewaySslProtocol
    """
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'cipher_suites': {'key': 'properties.cipherSuites', 'type': '[str]'}, 'min_protocol_version': {'key': 'properties.minProtocolVersion', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, cipher_suites: Optional[List[Union[str, '_models.ApplicationGatewaySslCipherSuite']]]=None, min_protocol_version: Optional[Union[str, '_models.ApplicationGatewaySslProtocol']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
...
class ApplicationGatewayTrustedRootCertificate(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'data': {'key': 'properties.data', 'type': 'str'}, 'keyvault_secret_id': {'key': 'properties.keyvaultSecretId', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, type: Optional[str]=None, data: Optional[str]=None, keyvault_secret_id: Optional[str]=None, provisioning_state: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
...
class ApplicationGatewayUrlPathMap(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'default_backend_address_pool': {'key': 'properties.defaultBackendAddressPool', 'type': 'SubResource'}, 'default_backend_http_settings': {'key': 'properties.defaultBackendHttpSettings', 'type': 'SubResource'}, 'default_redirect_configuration': {'key': 'properties.defaultRedirectConfiguration', 'type': 'SubResource'}, 'path_rules': {'key': 'properties.pathRules', 'type': '[ApplicationGatewayPathRule]'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, type: Optional[str]=None, default_backend_address_pool: Optional['_models.SubResource']=None, default_backend_http_settings: Optional['_models.SubResource']=None, default_redirect_configuration: Optional['_models.SubResource']=None, path_rules: Optional[List['_models.ApplicationGatewayPathRule']]=None, provisioning_state: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
...
class ApplicationSecurityGroup(Resource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'etag': {'readonly': True}, 'resource_guid': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'etag': {'key': 'etag', 'type': 'str'}, 'resource_guid': {'key': 'properties.resourceGuid', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}
...
class ApplicationSecurityGroupListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[ApplicationSecurityGroup]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class AuthorizationListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[ExpressRouteCircuitAuthorization]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.ExpressRouteCircuitAuthorization']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class Availability(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'time_grain': {'key': 'timeGrain', 'type': 'str'}, 'retention': {'key': 'retention', 'type': 'str'}, 'blob_duration': {'key': 'blobDuration', 'type': 'str'}}

    def __init__(self, *, time_grain: Optional[str]=None, retention: Optional[str]=None, blob_duration: Optional[str]=None, **kwargs):
        """
...
class AvailableDelegation(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'id': {'key': 'id', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'service_name': {'key': 'serviceName', 'type': 'str'}, 'actions': {'key': 'actions', 'type': '[str]'}}

    def __init__(self, *, name: Optional[str]=None, id: Optional[str]=None, type: Optional[str]=None, service_name: Optional[str]=None, actions: Optional[List[str]]=None, **kwargs):
        """
...
class AvailableDelegationsResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[AvailableDelegation]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class AvailableProvidersList(msrest.serialization.Model):
    ...
    """
    _validation = {'countries': {'required': True}}
    _attribute_map = {'countries': {'key': 'countries', 'type': '[AvailableProvidersListCountry]'}}
...
class AvailableProvidersListCity(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'city_name': {'key': 'cityName', 'type': 'str'}, 'providers': {'key': 'providers', 'type': '[str]'}}
...
class AvailableProvidersListParameters(msrest.serialization.Model):
    ...
    :vartype city: str
    """
    _attribute_map = {'azure_locations': {'key': 'azureLocations', 'type': '[str]'}, 'country': {'key': 'country', 'type': 'str'}, 'state': {'key': 'state', 'type': 'str'}, 'city': {'key': 'city', 'type': 'str'}}

    def __init__(self, *, azure_locations: Optional[List[str]]=None, country: Optional[str]=None, state: Optional[str]=None, city: Optional[str]=None, **kwargs):
        """
...
class AvailableProvidersListState(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'state_name': {'key': 'stateName', 'type': 'str'}, 'providers': {'key': 'providers', 'type': '[str]'}, 'cities': {'key': 'cities', 'type': '[AvailableProvidersListCity]'}}

    def __init__(self, *, state_name: Optional[str]=None, providers: Optional[List[str]]=None, cities: Optional[List['_models.AvailableProvidersListCity']]=None, **kwargs):
        """
...
class AzureAsyncOperationResult(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'status': {'key': 'status', 'type': 'str'}, 'error': {'key': 'error', 'type': 'Error'}}

    def __init__(self, *, status: Optional[Union[str, '_models.NetworkOperationStatus']]=None, error: Optional['_models.Error']=None, **kwargs):
        """
...
class AzureFirewall(Resource):
    ...
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'etag': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'etag': {'key': 'etag', 'type': 'str'}, 'application_rule_collections': {'key': 'properties.applicationRuleCollections', 'type': '[AzureFirewallApplicationRuleCollection]'}, 'nat_rule_collections': {'key': 'properties.natRuleCollections', 'type': '[AzureFirewallNatRuleCollection]'}, 'network_rule_collections': {'key': 'properties.networkRuleCollections', 'type': '[AzureFirewallNetworkRuleCollection]'}, 'ip_configurations': {'key': 'properties.ipConfigurations', 'type': '[AzureFirewallIPConfiguration]'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, application_rule_collections: Optional[List['_models.AzureFirewallApplicationRuleCollection']]=None, nat_rule_collections: Optional[List['_models.AzureFirewallNatRuleCollection']]=None, network_rule_collections: Optional[List['_models.AzureFirewallNetworkRuleCollection']]=None, ip_configurations: Optional[List['_models.AzureFirewallIPConfiguration']]=None, provisioning_state: Optional[Union[str, '_models.ProvisioningState']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class AzureFirewallApplicationRule(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'description': {'key': 'description', 'type': 'str'}, 'source_addresses': {'key': 'sourceAddresses', 'type': '[str]'}, 'protocols': {'key': 'protocols', 'type': '[AzureFirewallApplicationRuleProtocol]'}, 'target_fqdns': {'key': 'targetFqdns', 'type': '[str]'}, 'fqdn_tags': {'key': 'fqdnTags', 'type': '[str]'}}

    def __init__(self, *, name: Optional[str]=None, description: Optional[str]=None, source_addresses: Optional[List[str]]=None, protocols: Optional[List['_models.AzureFirewallApplicationRuleProtocol']]=None, target_fqdns: Optional[List[str]]=None, fqdn_tags: Optional[List[str]]=None, **kwargs):
        """
...
class AzureFirewallApplicationRuleCollection(SubResource):
    ...
    :vartype provisioning_state: str or ~azure.mgmt.network.v2018_08_01.models.ProvisioningState
    """
    _validation = {'etag': {'readonly': True}, 'priority': {'maximum': 65000, 'minimum': 100}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'priority': {'key': 'properties.priority', 'type': 'int'}, 'action': {'key': 'properties.action', 'type': 'AzureFirewallRCAction'}, 'rules': {'key': 'properties.rules', 'type': '[AzureFirewallApplicationRule]'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, priority: Optional[int]=None, action: Optional['_models.AzureFirewallRCAction']=None, rules: Optional[List['_models.AzureFirewallApplicationRule']]=None, provisioning_state: Optional[Union[str, '_models.ProvisioningState']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
...
class AzureFirewallApplicationRuleProtocol(msrest.serialization.Model):
    ...
    :vartype port: int
    """
    _validation = {'port': {'maximum': 64000, 'minimum': 0}}
    _attribute_map = {'protocol_type': {'key': 'protocolType', 'type': 'str'}, 'port': {'key': 'port', 'type': 'int'}}

    def __init__(self, *, protocol_type: Optional[Union[str, '_models.AzureFirewallApplicationRuleProtocolType']]=None, port: Optional[int]=None, **kwargs):
        """
...
class AzureFirewallFqdnTag(Resource):
    ...
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'etag': {'readonly': True}, 'provisioning_state': {'readonly': True}, 'fqdn_tag_name': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'etag': {'key': 'etag', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}, 'fqdn_tag_name': {'key': 'properties.fqdnTagName', 'type': 'str'}}
...
class AzureFirewallFqdnTagListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[AzureFirewallFqdnTag]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.AzureFirewallFqdnTag']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class AzureFirewallIPConfiguration(SubResource):
    ...
    :vartype provisioning_state: str or ~azure.mgmt.network.v2018_08_01.models.ProvisioningState
    """
    _validation = {'etag': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'private_ip_address': {'key': 'properties.privateIPAddress', 'type': 'str'}, 'subnet': {'key': 'properties.subnet', 'type': 'SubResource'}, 'public_ip_address': {'key': 'properties.publicIPAddress', 'type': 'SubResource'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, private_ip_address: Optional[str]=None, subnet: Optional['_models.SubResource']=None, public_ip_address: Optional['_models.SubResource']=None, provisioning_state: Optional[Union[str, '_models.ProvisioningState']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
...
class AzureFirewallListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[AzureFirewall]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.AzureFirewall']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class AzureFirewallNatRuleCollection(SubResource):
    ...
    """
    _validation = {'etag': {'readonly': True}, 'priority': {'maximum': 65000, 'minimum': 100}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'priority': {'key': 'properties.priority', 'type': 'int'}, 'action': {'key': 'properties.action', 'type': 'AzureFirewallNatRCAction'}, 'rules': {'key': 'properties.rules', 'type': '[AzureFirewallNatRule]'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, priority: Optional[int]=None, action: Optional['_models.AzureFirewallNatRCAction']=None, rules: Optional[List['_models.AzureFirewallNatRule']]=None, provisioning_state: Optional[Union[str, '_models.ProvisioningState']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: Gets name of the resource that is unique within a resource group. This name can
...
class AzureFirewallNetworkRule(msrest.serialization.Model):
    ...
    :vartype destination_ports: list[str]
    """
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'description': {'key': 'description', 'type': 'str'}, 'protocols': {'key': 'protocols', 'type': '[str]'}, 'source_addresses': {'key': 'sourceAddresses', 'type': '[str]'}, 'destination_addresses': {'key': 'destinationAddresses', 'type': '[str]'}, 'destination_ports': {'key': 'destinationPorts', 'type': '[str]'}}

    def __init__(self, *, name: Optional[str]=None, description: Optional[str]=None, protocols: Optional[List[Union[str, '_models.AzureFirewallNetworkRuleProtocol']]]=None, source_addresses: Optional[List[str]]=None, destination_addresses: Optional[List[str]]=None, destination_ports: Optional[List[str]]=None, **kwargs):
        """
...
class AzureFirewallNetworkRuleCollection(SubResource):
    ...
    """
    _validation = {'etag': {'readonly': True}, 'priority': {'maximum': 65000, 'minimum': 100}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'priority': {'key': 'properties.priority', 'type': 'int'}, 'action': {'key': 'properties.action', 'type': 'AzureFirewallRCAction'}, 'rules': {'key': 'properties.rules', 'type': '[AzureFirewallNetworkRule]'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, priority: Optional[int]=None, action: Optional['_models.AzureFirewallRCAction']=None, rules: Optional[List['_models.AzureFirewallNetworkRule']]=None, provisioning_state: Optional[Union[str, '_models.ProvisioningState']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: Gets name of the resource that is unique within a resource group. This name can
...
class AzureReachabilityReport(msrest.serialization.Model):
    ...
    """
    _validation = {'aggregation_level': {'required': True}, 'provider_location': {'required': True}, 'reachability_report': {'required': True}}
    _attribute_map = {'aggregation_level': {'key': 'aggregationLevel', 'type': 'str'}, 'provider_location': {'key': 'providerLocation', 'type': 'AzureReachabilityReportLocation'}, 'reachability_report': {'key': 'reachabilityReport', 'type': '[AzureReachabilityReportItem]'}}

    def __init__(self, *, aggregation_level: str, provider_location: '_models.AzureReachabilityReportLocation', reachability_report: List['_models.AzureReachabilityReportItem'], **kwargs):
        """
...
class AzureReachabilityReportItem(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'provider': {'key': 'provider', 'type': 'str'}, 'azure_location': {'key': 'azureLocation', 'type': 'str'}, 'latencies': {'key': 'latencies', 'type': '[AzureReachabilityReportLatencyInfo]'}}

    def __init__(self, *, provider: Optional[str]=None, azure_location: Optional[str]=None, latencies: Optional[List['_models.AzureReachabilityReportLatencyInfo']]=None, **kwargs):
        """
...
class AzureReachabilityReportLatencyInfo(msrest.serialization.Model):
    ...
    :vartype score: int
    """
    _validation = {'score': {'maximum': 100, 'minimum': 1}}
    _attribute_map = {'time_stamp': {'key': 'timeStamp', 'type': 'iso-8601'}, 'score': {'key': 'score', 'type': 'int'}}
...
class AzureReachabilityReportLocation(msrest.serialization.Model):
    ...
    :vartype city: str
    """
    _validation = {'country': {'required': True}}
    _attribute_map = {'country': {'key': 'country', 'type': 'str'}, 'state': {'key': 'state', 'type': 'str'}, 'city': {'key': 'city', 'type': 'str'}}
...
class AzureReachabilityReportParameters(msrest.serialization.Model):
    ...
    """
    _validation = {'provider_location': {'required': True}, 'start_time': {'required': True}, 'end_time': {'required': True}}
    _attribute_map = {'provider_location': {'key': 'providerLocation', 'type': 'AzureReachabilityReportLocation'}, 'providers': {'key': 'providers', 'type': '[str]'}, 'azure_locations': {'key': 'azureLocations', 'type': '[str]'}, 'start_time': {'key': 'startTime', 'type': 'iso-8601'}, 'end_time': {'key': 'endTime', 'type': 'iso-8601'}}

    def __init__(self, *, provider_location: '_models.AzureReachabilityReportLocation', start_time: datetime.datetime, end_time: datetime.datetime, providers: Optional[List[str]]=None, azure_locations: Optional[List[str]]=None, **kwargs):
        """
        :keyword provider_location: Required. Parameters that define a geographic location.
        :paramtype provider_location:
         ~azure.mgmt.network.v2018_08_01.models.AzureReachabilityReportLocation
...
class BackendAddressPool(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'backend_ip_configurations': {'readonly': True}, 'load_balancing_rules': {'readonly': True}, 'outbound_rule': {'readonly': True}, 'outbound_rules': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'backend_ip_configurations': {'key': 'properties.backendIPConfigurations', 'type': '[NetworkInterfaceIPConfiguration]'}, 'load_balancing_rules': {'key': 'properties.loadBalancingRules', 'type': '[SubResource]'}, 'outbound_rule': {'key': 'properties.outboundRule', 'type': 'SubResource'}, 'outbound_rules': {'key': 'properties.outboundRules', 'type': '[SubResource]'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, provisioning_state: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: Gets name of the resource that is unique within a resource group. This name can
...
class BGPCommunity(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'service_supported_region': {'key': 'serviceSupportedRegion', 'type': 'str'}, 'community_name': {'key': 'communityName', 'type': 'str'}, 'community_value': {'key': 'communityValue', 'type': 'str'}, 'community_prefixes': {'key': 'communityPrefixes', 'type': '[str]'}, 'is_authorized_to_use': {'key': 'isAuthorizedToUse', 'type': 'bool'}, 'service_group': {'key': 'serviceGroup', 'type': 'str'}}

    def __init__(self, *, service_supported_region: Optional[str]=None, community_name: Optional[str]=None, community_value: Optional[str]=None, community_prefixes: Optional[List[str]]=None, is_authorized_to_use: Optional[bool]=None, service_group: Optional[str]=None, **kwargs):
        """
...
class BgpPeerStatus(msrest.serialization.Model):
    ...
    """
    _validation = {'local_address': {'readonly': True}, 'neighbor': {'readonly': True}, 'asn': {'readonly': True}, 'state': {'readonly': True}, 'connected_duration': {'readonly': True}, 'routes_received': {'readonly': True}, 'messages_sent': {'readonly': True}, 'messages_received': {'readonly': True}}
    _attribute_map = {'local_address': {'key': 'localAddress', 'type': 'str'}, 'neighbor': {'key': 'neighbor', 'type': 'str'}, 'asn': {'key': 'asn', 'type': 'int'}, 'state': {'key': 'state', 'type': 'str'}, 'connected_duration': {'key': 'connectedDuration', 'type': 'str'}, 'routes_received': {'key': 'routesReceived', 'type': 'long'}, 'messages_sent': {'key': 'messagesSent', 'type': 'long'}, 'messages_received': {'key': 'messagesReceived', 'type': 'long'}}
...
class BgpPeerStatusListResult(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[BgpPeerStatus]'}}
...
class BgpServiceCommunity(Resource):
    ...
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'service_name': {'key': 'properties.serviceName', 'type': 'str'}, 'bgp_communities': {'key': 'properties.bgpCommunities', 'type': '[BGPCommunity]'}}

    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, service_name: Optional[str]=None, bgp_communities: Optional[List['_models.BGPCommunity']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class BgpServiceCommunityListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[BgpServiceCommunity]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.BgpServiceCommunity']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class BgpSettings(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'asn': {'key': 'asn', 'type': 'long'}, 'bgp_peering_address': {'key': 'bgpPeeringAddress', 'type': 'str'}, 'peer_weight': {'key': 'peerWeight', 'type': 'int'}}

    def __init__(self, *, asn: Optional[int]=None, bgp_peering_address: Optional[str]=None, peer_weight: Optional[int]=None, **kwargs):
        """
...
class ConnectionMonitor(msrest.serialization.Model):
    ...
    """
    _validation = {'source': {'required': True}, 'destination': {'required': True}}
    _attribute_map = {'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'source': {'key': 'properties.source', 'type': 'ConnectionMonitorSource'}, 'destination': {'key': 'properties.destination', 'type': 'ConnectionMonitorDestination'}, 'auto_start': {'key': 'properties.autoStart', 'type': 'bool'}, 'monitoring_interval_in_seconds': {'key': 'properties.monitoringIntervalInSeconds', 'type': 'int'}}

    def __init__(self, *, source: '_models.ConnectionMonitorSource', destination: '_models.ConnectionMonitorDestination', location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, auto_start: Optional[bool]=True, monitoring_interval_in_seconds: Optional[int]=60, **kwargs):
        """
...
class ConnectionMonitorDestination(msrest.serialization.Model):
    ...
    :vartype port: int
    """
    _attribute_map = {'resource_id': {'key': 'resourceId', 'type': 'str'}, 'address': {'key': 'address', 'type': 'str'}, 'port': {'key': 'port', 'type': 'int'}}

    def __init__(self, *, resource_id: Optional[str]=None, address: Optional[str]=None, port: Optional[int]=None, **kwargs):
        """
...
class ConnectionMonitorListResult(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[ConnectionMonitorResult]'}}
...
class ConnectionMonitorParameters(msrest.serialization.Model):
    ...
    """
    _validation = {'source': {'required': True}, 'destination': {'required': True}}
    _attribute_map = {'source': {'key': 'source', 'type': 'ConnectionMonitorSource'}, 'destination': {'key': 'destination', 'type': 'ConnectionMonitorDestination'}, 'auto_start': {'key': 'autoStart', 'type': 'bool'}, 'monitoring_interval_in_seconds': {'key': 'monitoringIntervalInSeconds', 'type': 'int'}}

    def __init__(self, *, source: '_models.ConnectionMonitorSource', destination: '_models.ConnectionMonitorDestination', auto_start: Optional[bool]=True, monitoring_interval_in_seconds: Optional[int]=60, **kwargs):
        """
        :keyword source: Required. Describes the source of connection monitor.
        :paramtype source: ~azure.mgmt.network.v2018_08_01.models.ConnectionMonitorSource
        :keyword destination: Required. Describes the destination of connection monitor.
...
class ConnectionMonitorResult(msrest.serialization.Model):
    ...
    """
    _validation = {'name': {'readonly': True}, 'id': {'readonly': True}, 'type': {'readonly': True}}
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'id': {'key': 'id', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'source': {'key': 'properties.source', 'type': 'ConnectionMonitorSource'}, 'destination': {'key': 'properties.destination', 'type': 'ConnectionMonitorDestination'}, 'auto_start': {'key': 'properties.autoStart', 'type': 'bool'}, 'monitoring_interval_in_seconds': {'key': 'properties.monitoringIntervalInSeconds', 'type': 'int'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}, 'start_time': {'key': 'properties.startTime', 'type': 'iso-8601'}, 'monitoring_status': {'key': 'properties.monitoringStatus', 'type': 'str'}}

    def __init__(self, *, etag: Optional[str]='A unique read-only string that changes whenever the resource is updated.', location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, source: Optional['_models.ConnectionMonitorSource']=None, destination: Optional['_models.ConnectionMonitorDestination']=None, auto_start: Optional[bool]=True, monitoring_interval_in_seconds: Optional[int]=60, provisioning_state: Optional[Union[str, '_models.ProvisioningState']]=None, start_time: Optional[datetime.datetime]=None, monitoring_status: Optional[str]=None, **kwargs):
        """
        :keyword etag:
        :paramtype etag: str
        :keyword location: Connection monitor location.
...
class ConnectionMonitorResultProperties(ConnectionMonitorParameters):
    ...
    """
    _validation = {'source': {'required': True}, 'destination': {'required': True}}
    _attribute_map = {'source': {'key': 'source', 'type': 'ConnectionMonitorSource'}, 'destination': {'key': 'destination', 'type': 'ConnectionMonitorDestination'}, 'auto_start': {'key': 'autoStart', 'type': 'bool'}, 'monitoring_interval_in_seconds': {'key': 'monitoringIntervalInSeconds', 'type': 'int'}, 'provisioning_state': {'key': 'provisioningState', 'type': 'str'}, 'start_time': {'key': 'startTime', 'type': 'iso-8601'}, 'monitoring_status': {'key': 'monitoringStatus', 'type': 'str'}}

    def __init__(self, *, source: '_models.ConnectionMonitorSource', destination: '_models.ConnectionMonitorDestination', auto_start: Optional[bool]=True, monitoring_interval_in_seconds: Optional[int]=60, provisioning_state: Optional[Union[str, '_models.ProvisioningState']]=None, start_time: Optional[datetime.datetime]=None, monitoring_status: Optional[str]=None, **kwargs):
        """
        :keyword source: Required. Describes the source of connection monitor.
        :paramtype source: ~azure.mgmt.network.v2018_08_01.models.ConnectionMonitorSource
        :keyword destination: Required. Describes the destination of connection monitor.
...
class ConnectionMonitorSource(msrest.serialization.Model):
    ...
    :vartype port: int
    """
    _validation = {'resource_id': {'required': True}}
    _attribute_map = {'resource_id': {'key': 'resourceId', 'type': 'str'}, 'port': {'key': 'port', 'type': 'int'}}
...
class ConnectionResetSharedKey(msrest.serialization.Model):
    ...
    """
    _validation = {'key_length': {'required': True, 'maximum': 128, 'minimum': 1}}
    _attribute_map = {'key_length': {'key': 'keyLength', 'type': 'int'}}
...
class ConnectionSharedKey(SubResource):
    ...
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'value': {'key': 'value', 'type': 'str'}}
...
class ConnectionStateSnapshot(msrest.serialization.Model):
    ...
    """
    _validation = {'hops': {'readonly': True}}
    _attribute_map = {'connection_state': {'key': 'connectionState', 'type': 'str'}, 'start_time': {'key': 'startTime', 'type': 'iso-8601'}, 'end_time': {'key': 'endTime', 'type': 'iso-8601'}, 'evaluation_state': {'key': 'evaluationState', 'type': 'str'}, 'avg_latency_in_ms': {'key': 'avgLatencyInMs', 'type': 'int'}, 'min_latency_in_ms': {'key': 'minLatencyInMs', 'type': 'int'}, 'max_latency_in_ms': {'key': 'maxLatencyInMs', 'type': 'int'}, 'probes_sent': {'key': 'probesSent', 'type': 'int'}, 'probes_failed': {'key': 'probesFailed', 'type': 'int'}, 'hops': {'key': 'hops', 'type': '[ConnectivityHop]'}}

    def __init__(self, *, connection_state: Optional[Union[str, '_models.ConnectionState']]=None, start_time: Optional[datetime.datetime]=None, end_time: Optional[datetime.datetime]=None, evaluation_state: Optional[Union[str, '_models.EvaluationState']]=None, avg_latency_in_ms: Optional[int]=None, min_latency_in_ms: Optional[int]=None, max_latency_in_ms: Optional[int]=None, probes_sent: Optional[int]=None, probes_failed: Optional[int]=None, **kwargs):
        """
...
class ConnectivityHop(msrest.serialization.Model):
    ...
    """
    _validation = {'type': {'readonly': True}, 'id': {'readonly': True}, 'address': {'readonly': True}, 'resource_id': {'readonly': True}, 'next_hop_ids': {'readonly': True}, 'issues': {'readonly': True}}
    _attribute_map = {'type': {'key': 'type', 'type': 'str'}, 'id': {'key': 'id', 'type': 'str'}, 'address': {'key': 'address', 'type': 'str'}, 'resource_id': {'key': 'resourceId', 'type': 'str'}, 'next_hop_ids': {'key': 'nextHopIds', 'type': '[str]'}, 'issues': {'key': 'issues', 'type': '[ConnectivityIssue]'}}
...
class ConnectivityInformation(msrest.serialization.Model):
    ...
    :vartype probes_failed: int
    """
    _validation = {'hops': {'readonly': True}, 'connection_status': {'readonly': True}, 'avg_latency_in_ms': {'readonly': True}, 'min_latency_in_ms': {'readonly': True}, 'max_latency_in_ms': {'readonly': True}, 'probes_sent': {'readonly': True}, 'probes_failed': {'readonly': True}}
    _attribute_map = {'hops': {'key': 'hops', 'type': '[ConnectivityHop]'}, 'connection_status': {'key': 'connectionStatus', 'type': 'str'}, 'avg_latency_in_ms': {'key': 'avgLatencyInMs', 'type': 'int'}, 'min_latency_in_ms': {'key': 'minLatencyInMs', 'type': 'int'}, 'max_latency_in_ms': {'key': 'maxLatencyInMs', 'type': 'int'}, 'probes_sent': {'key': 'probesSent', 'type': 'int'}, 'probes_failed': {'key': 'probesFailed', 'type': 'int'}}
...
class ConnectivityIssue(msrest.serialization.Model):
    ...
    """
    _validation = {'origin': {'readonly': True}, 'severity': {'readonly': True}, 'type': {'readonly': True}, 'context': {'readonly': True}}
    _attribute_map = {'origin': {'key': 'origin', 'type': 'str'}, 'severity': {'key': 'severity', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'context': {'key': 'context', 'type': '[{str}]'}}
...
class ConnectivityParameters(msrest.serialization.Model):
    ...
    """
    _validation = {'source': {'required': True}, 'destination': {'required': True}}
    _attribute_map = {'source': {'key': 'source', 'type': 'ConnectivitySource'}, 'destination': {'key': 'destination', 'type': 'ConnectivityDestination'}, 'protocol': {'key': 'protocol', 'type': 'str'}, 'protocol_configuration': {'key': 'protocolConfiguration', 'type': 'ProtocolConfiguration'}}

    def __init__(self, *, source: '_models.ConnectivitySource', destination: '_models.ConnectivityDestination', protocol: Optional[Union[str, '_models.Protocol']]=None, protocol_configuration: Optional['_models.ProtocolConfiguration']=None, **kwargs):
        """
...
class ContainerNetworkInterface(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'type': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'container_network_interface_configuration': {'key': 'properties.containerNetworkInterfaceConfiguration', 'type': 'ContainerNetworkInterfaceConfiguration'}, 'container': {'key': 'properties.container', 'type': 'Container'}, 'ip_configurations': {'key': 'properties.ipConfigurations', 'type': '[ContainerNetworkInterfaceIpConfiguration]'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, container_network_interface_configuration: Optional['_models.ContainerNetworkInterfaceConfiguration']=None, container: Optional['_models.Container']=None, ip_configurations: Optional[List['_models.ContainerNetworkInterfaceIpConfiguration']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
...
class ContainerNetworkInterfaceConfiguration(SubResource):
    ...
    """
    _validation = {'type': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'ip_configurations': {'key': 'properties.ipConfigurations', 'type': '[IPConfigurationProfile]'}, 'container_network_interfaces': {'key': 'properties.containerNetworkInterfaces', 'type': '[ContainerNetworkInterface]'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, ip_configurations: Optional[List['_models.IPConfigurationProfile']]=None, container_network_interfaces: Optional[List['_models.ContainerNetworkInterface']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: The name of the resource. This name can be used to access the resource.
...
class ContainerNetworkInterfaceIpConfiguration(msrest.serialization.Model):
    ...
    """
    _validation = {'type': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}
...
class DdosProtectionPlan(msrest.serialization.Model):
    ...
    """
    _validation = {'id': {'readonly': True}, 'name': {'readonly': True}, 'type': {'readonly': True}, 'etag': {'readonly': True}, 'resource_guid': {'readonly': True}, 'provisioning_state': {'readonly': True}, 'virtual_networks': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'etag': {'key': 'etag', 'type': 'str'}, 'resource_guid': {'key': 'properties.resourceGuid', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}, 'virtual_networks': {'key': 'properties.virtualNetworks', 'type': '[SubResource]'}}
...
class DdosProtectionPlanListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[DdosProtectionPlan]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class Delegation(SubResource):
    ...
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'service_name': {'key': 'properties.serviceName', 'type': 'str'}, 'actions': {'key': 'properties.actions', 'type': '[str]'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, service_name: Optional[str]=None, actions: Optional[List[str]]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
...
class DeviceProperties(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'device_vendor': {'key': 'deviceVendor', 'type': 'str'}, 'device_model': {'key': 'deviceModel', 'type': 'str'}, 'link_speed_in_mbps': {'key': 'linkSpeedInMbps', 'type': 'int'}}

    def __init__(self, *, device_vendor: Optional[str]=None, device_model: Optional[str]=None, link_speed_in_mbps: Optional[int]=None, **kwargs):
        """
...
class DhcpOptions(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'dns_servers': {'key': 'dnsServers', 'type': '[str]'}}
...
class Dimension(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'display_name': {'key': 'displayName', 'type': 'str'}, 'internal_name': {'key': 'internalName', 'type': 'str'}}

    def __init__(self, *, name: Optional[str]=None, display_name: Optional[str]=None, internal_name: Optional[str]=None, **kwargs):
        """
...
class DnsNameAvailabilityResult(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'available': {'key': 'available', 'type': 'bool'}}
...
class EffectiveNetworkSecurityGroup(msrest.serialization.Model):
    ...
    :vartype tag_map: str
    """
    _attribute_map = {'network_security_group': {'key': 'networkSecurityGroup', 'type': 'SubResource'}, 'association': {'key': 'association', 'type': 'EffectiveNetworkSecurityGroupAssociation'}, 'effective_security_rules': {'key': 'effectiveSecurityRules', 'type': '[EffectiveNetworkSecurityRule]'}, 'tag_map': {'key': 'tagMap', 'type': 'str'}}

    def __init__(self, *, network_security_group: Optional['_models.SubResource']=None, association: Optional['_models.EffectiveNetworkSecurityGroupAssociation']=None, effective_security_rules: Optional[List['_models.EffectiveNetworkSecurityRule']]=None, tag_map: Optional[str]=None, **kwargs):
        """
...
class EffectiveNetworkSecurityGroupAssociation(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'subnet': {'key': 'subnet', 'type': 'SubResource'}, 'network_interface': {'key': 'networkInterface', 'type': 'SubResource'}}

    def __init__(self, *, subnet: Optional['_models.SubResource']=None, network_interface: Optional['_models.SubResource']=None, **kwargs):
        """
...
class EffectiveNetworkSecurityGroupListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[EffectiveNetworkSecurityGroup]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class EffectiveRoute(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'source': {'key': 'source', 'type': 'str'}, 'state': {'key': 'state', 'type': 'str'}, 'address_prefix': {'key': 'addressPrefix', 'type': '[str]'}, 'next_hop_ip_address': {'key': 'nextHopIpAddress', 'type': '[str]'}, 'next_hop_type': {'key': 'nextHopType', 'type': 'str'}}

    def __init__(self, *, name: Optional[str]=None, source: Optional[Union[str, '_models.EffectiveRouteSource']]=None, state: Optional[Union[str, '_models.EffectiveRouteState']]=None, address_prefix: Optional[List[str]]=None, next_hop_ip_address: Optional[List[str]]=None, next_hop_type: Optional[Union[str, '_models.RouteNextHopType']]=None, **kwargs):
        """
...
class EffectiveRouteListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[EffectiveRoute]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class EndpointServiceResult(SubResource):
    ...
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}}
...
class EndpointServicesListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[EndpointServiceResult]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.EndpointServiceResult']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class Error(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'code': {'key': 'code', 'type': 'str'}, 'message': {'key': 'message', 'type': 'str'}, 'target': {'key': 'target', 'type': 'str'}, 'details': {'key': 'details', 'type': '[ErrorDetails]'}, 'inner_error': {'key': 'innerError', 'type': 'str'}}

    def __init__(self, *, code: Optional[str]=None, message: Optional[str]=None, target: Optional[str]=None, details: Optional[List['_models.ErrorDetails']]=None, inner_error: Optional[str]=None, **kwargs):
        """
        :keyword code:
        :paramtype code: str
        :keyword message:
...
class ErrorDetails(msrest.serialization.Model):
    ...
    :vartype message: str
    """
    _attribute_map = {'code': {'key': 'code', 'type': 'str'}, 'target': {'key': 'target', 'type': 'str'}, 'message': {'key': 'message', 'type': 'str'}}

    def __init__(self, *, code: Optional[str]=None, target: Optional[str]=None, message: Optional[str]=None, **kwargs):
        """
        :keyword code:
        :paramtype code: str
        :keyword target:
...
class EvaluatedNetworkSecurityGroup(msrest.serialization.Model):
    ...
    """
    _validation = {'rules_evaluation_result': {'readonly': True}}
    _attribute_map = {'network_security_group_id': {'key': 'networkSecurityGroupId', 'type': 'str'}, 'applied_to': {'key': 'appliedTo', 'type': 'str'}, 'matched_rule': {'key': 'matchedRule', 'type': 'MatchedRule'}, 'rules_evaluation_result': {'key': 'rulesEvaluationResult', 'type': '[NetworkSecurityRulesEvaluationResult]'}}

    def __init__(self, *, network_security_group_id: Optional[str]=None, applied_to: Optional[str]=None, matched_rule: Optional['_models.MatchedRule']=None, **kwargs):
        """
...
class ExpressRouteCircuitArpTable(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'age': {'key': 'age', 'type': 'int'}, 'interface': {'key': 'interface', 'type': 'str'}, 'ip_address': {'key': 'ipAddress', 'type': 'str'}, 'mac_address': {'key': 'macAddress', 'type': 'str'}}

    def __init__(self, *, age: Optional[int]=None, interface: Optional[str]=None, ip_address: Optional[str]=None, mac_address: Optional[str]=None, **kwargs):
        """
...
class ExpressRouteCircuitAuthorization(SubResource):
    ...
    """
    _validation = {'etag': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'authorization_key': {'key': 'properties.authorizationKey', 'type': 'str'}, 'authorization_use_status': {'key': 'properties.authorizationUseStatus', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, authorization_key: Optional[str]=None, authorization_use_status: Optional[Union[str, '_models.AuthorizationUseStatus']]=None, provisioning_state: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: Gets name of the resource that is unique within a resource group. This name can
...
class ExpressRouteCircuitConnection(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'etag': {'readonly': True}, 'circuit_connection_status': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'express_route_circuit_peering': {'key': 'properties.expressRouteCircuitPeering', 'type': 'SubResource'}, 'peer_express_route_circuit_peering': {'key': 'properties.peerExpressRouteCircuitPeering', 'type': 'SubResource'}, 'address_prefix': {'key': 'properties.addressPrefix', 'type': 'str'}, 'authorization_key': {'key': 'properties.authorizationKey', 'type': 'str'}, 'circuit_connection_status': {'key': 'properties.circuitConnectionStatus', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, express_route_circuit_peering: Optional['_models.SubResource']=None, peer_express_route_circuit_peering: Optional['_models.SubResource']=None, address_prefix: Optional[str]=None, authorization_key: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: Gets name of the resource that is unique within a resource group. This name can
...
class ExpressRouteCircuitListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[ExpressRouteCircuit]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.ExpressRouteCircuit']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ExpressRouteCircuitPeeringConfig(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'advertised_public_prefixes': {'key': 'advertisedPublicPrefixes', 'type': '[str]'}, 'advertised_communities': {'key': 'advertisedCommunities', 'type': '[str]'}, 'advertised_public_prefixes_state': {'key': 'advertisedPublicPrefixesState', 'type': 'str'}, 'legacy_mode': {'key': 'legacyMode', 'type': 'int'}, 'customer_asn': {'key': 'customerASN', 'type': 'int'}, 'routing_registry_name': {'key': 'routingRegistryName', 'type': 'str'}}

    def __init__(self, *, advertised_public_prefixes: Optional[List[str]]=None, advertised_communities: Optional[List[str]]=None, advertised_public_prefixes_state: Optional[Union[str, '_models.ExpressRouteCircuitPeeringAdvertisedPublicPrefixState']]=None, legacy_mode: Optional[int]=None, customer_asn: Optional[int]=None, routing_registry_name: Optional[str]=None, **kwargs):
        """
...
class ExpressRouteCircuitPeeringListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[ExpressRouteCircuitPeering]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.ExpressRouteCircuitPeering']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ExpressRouteCircuitRoutesTable(msrest.serialization.Model):
    ...
    :vartype path: str
    """
    _attribute_map = {'network': {'key': 'network', 'type': 'str'}, 'next_hop': {'key': 'nextHop', 'type': 'str'}, 'loc_prf': {'key': 'locPrf', 'type': 'str'}, 'weight': {'key': 'weight', 'type': 'int'}, 'path': {'key': 'path', 'type': 'str'}}

    def __init__(self, *, network: Optional[str]=None, next_hop: Optional[str]=None, loc_prf: Optional[str]=None, weight: Optional[int]=None, path: Optional[str]=None, **kwargs):
        """
...
class ExpressRouteCircuitRoutesTableSummary(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'neighbor': {'key': 'neighbor', 'type': 'str'}, 'v': {'key': 'v', 'type': 'int'}, 'as_property': {'key': 'as', 'type': 'int'}, 'up_down': {'key': 'upDown', 'type': 'str'}, 'state_pfx_rcd': {'key': 'statePfxRcd', 'type': 'str'}}

    def __init__(self, *, neighbor: Optional[str]=None, v: Optional[int]=None, as_property: Optional[int]=None, up_down: Optional[str]=None, state_pfx_rcd: Optional[str]=None, **kwargs):
        """
...
class ExpressRouteCircuitsArpTableListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[ExpressRouteCircuitArpTable]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.ExpressRouteCircuitArpTable']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ExpressRouteCircuitServiceProviderProperties(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'service_provider_name': {'key': 'serviceProviderName', 'type': 'str'}, 'peering_location': {'key': 'peeringLocation', 'type': 'str'}, 'bandwidth_in_mbps': {'key': 'bandwidthInMbps', 'type': 'int'}}

    def __init__(self, *, service_provider_name: Optional[str]=None, peering_location: Optional[str]=None, bandwidth_in_mbps: Optional[int]=None, **kwargs):
        """
...
class ExpressRouteCircuitSku(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'tier': {'key': 'tier', 'type': 'str'}, 'family': {'key': 'family', 'type': 'str'}}

    def __init__(self, *, name: Optional[str]=None, tier: Optional[Union[str, '_models.ExpressRouteCircuitSkuTier']]=None, family: Optional[Union[str, '_models.ExpressRouteCircuitSkuFamily']]=None, **kwargs):
        """
...
class ExpressRouteCircuitsRoutesTableListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[ExpressRouteCircuitRoutesTable]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.ExpressRouteCircuitRoutesTable']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ExpressRouteCircuitsRoutesTableSummaryListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[ExpressRouteCircuitRoutesTableSummary]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.ExpressRouteCircuitRoutesTableSummary']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ExpressRouteCircuitStats(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'primarybytes_in': {'key': 'primarybytesIn', 'type': 'long'}, 'primarybytes_out': {'key': 'primarybytesOut', 'type': 'long'}, 'secondarybytes_in': {'key': 'secondarybytesIn', 'type': 'long'}, 'secondarybytes_out': {'key': 'secondarybytesOut', 'type': 'long'}}

    def __init__(self, *, primarybytes_in: Optional[int]=None, primarybytes_out: Optional[int]=None, secondarybytes_in: Optional[int]=None, secondarybytes_out: Optional[int]=None, **kwargs):
        """
...
class ExpressRouteConnection(SubResource):
    ...
    """
    _validation = {'name': {'required': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}, 'express_route_circuit_peering': {'key': 'properties.expressRouteCircuitPeering', 'type': 'ExpressRouteCircuitPeeringId'}, 'authorization_key': {'key': 'properties.authorizationKey', 'type': 'str'}, 'routing_weight': {'key': 'properties.routingWeight', 'type': 'int'}}

    def __init__(self, *, name: str, id: Optional[str]=None, express_route_circuit_peering: Optional['_models.ExpressRouteCircuitPeeringId']=None, authorization_key: Optional[str]=None, routing_weight: Optional[int]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
...
class ExpressRouteConnectionList(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[ExpressRouteConnection]'}}
...
class ExpressRouteCrossConnection(Resource):
    ...
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'etag': {'readonly': True}, 'primary_azure_port': {'readonly': True}, 'secondary_azure_port': {'readonly': True}, 's_tag': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'etag': {'key': 'etag', 'type': 'str'}, 'primary_azure_port': {'key': 'properties.primaryAzurePort', 'type': 'str'}, 'secondary_azure_port': {'key': 'properties.secondaryAzurePort', 'type': 'str'}, 's_tag': {'key': 'properties.sTag', 'type': 'int'}, 'peering_location': {'key': 'properties.peeringLocation', 'type': 'str'}, 'bandwidth_in_mbps': {'key': 'properties.bandwidthInMbps', 'type': 'int'}, 'express_route_circuit': {'key': 'properties.expressRouteCircuit', 'type': 'ExpressRouteCircuitReference'}, 'service_provider_provisioning_state': {'key': 'properties.serviceProviderProvisioningState', 'type': 'str'}, 'service_provider_notes': {'key': 'properties.serviceProviderNotes', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}, 'peerings': {'key': 'properties.peerings', 'type': '[ExpressRouteCrossConnectionPeering]'}}

    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, peering_location: Optional[str]=None, bandwidth_in_mbps: Optional[int]=None, express_route_circuit: Optional['_models.ExpressRouteCircuitReference']=None, service_provider_provisioning_state: Optional[Union[str, '_models.ServiceProviderProvisioningState']]=None, service_provider_notes: Optional[str]=None, peerings: Optional[List['_models.ExpressRouteCrossConnectionPeering']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class ExpressRouteCrossConnectionListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[ExpressRouteCrossConnection]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class ExpressRouteCrossConnectionPeering(SubResource):
    ...
    :vartype ipv6_peering_config:
     ~azure.mgmt.network.v2018_08_01.models.Ipv6ExpressRouteCircuitPeeringConfig
    """
    _validation = {'etag': {'readonly': True}, 'azure_asn': {'readonly': True}, 'peer_asn': {'maximum': 4294967295, 'minimum': 1}, 'primary_azure_port': {'readonly': True}, 'secondary_azure_port': {'readonly': True}, 'provisioning_state': {'readonly': True}}
...
class ExpressRouteCrossConnectionPeeringList(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[ExpressRouteCrossConnectionPeering]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class ExpressRouteCrossConnectionRoutesTableSummary(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'neighbor': {'key': 'neighbor', 'type': 'str'}, 'asn': {'key': 'asn', 'type': 'int'}, 'up_down': {'key': 'upDown', 'type': 'str'}, 'state_or_prefixes_received': {'key': 'stateOrPrefixesReceived', 'type': 'str'}}

    def __init__(self, *, neighbor: Optional[str]=None, asn: Optional[int]=None, up_down: Optional[str]=None, state_or_prefixes_received: Optional[str]=None, **kwargs):
        """
...
class ExpressRouteCrossConnectionsRoutesTableSummaryListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[ExpressRouteCrossConnectionRoutesTableSummary]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.ExpressRouteCrossConnectionRoutesTableSummary']]=None, **kwargs):
        """
        :keyword value: A list of the routes table.
        :paramtype value:
         list[~azure.mgmt.network.v2018_08_01.models.ExpressRouteCrossConnectionRoutesTableSummary]
...
class ExpressRouteGateway(Resource):
    ...
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'etag': {'readonly': True}, 'express_route_connections': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'etag': {'key': 'etag', 'type': 'str'}, 'auto_scale_configuration': {'key': 'properties.autoScaleConfiguration', 'type': 'ExpressRouteGatewayPropertiesAutoScaleConfiguration'}, 'express_route_connections': {'key': 'properties.expressRouteConnections', 'type': '[ExpressRouteConnection]'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}, 'virtual_hub': {'key': 'properties.virtualHub', 'type': 'VirtualHubId'}}

    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, auto_scale_configuration: Optional['_models.ExpressRouteGatewayPropertiesAutoScaleConfiguration']=None, virtual_hub: Optional['_models.VirtualHubId']=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class ExpressRouteGatewayList(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[ExpressRouteGateway]'}}
...
class ExpressRouteGatewayPropertiesAutoScaleConfiguration(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'bounds': {'key': 'bounds', 'type': 'ExpressRouteGatewayPropertiesAutoScaleConfigurationBounds'}}

    def __init__(self, *, bounds: Optional['_models.ExpressRouteGatewayPropertiesAutoScaleConfigurationBounds']=None, **kwargs):
        """
...
class ExpressRouteGatewayPropertiesAutoScaleConfigurationBounds(msrest.serialization.Model):
    ...
    :vartype max: int
    """
    _attribute_map = {'min': {'key': 'min', 'type': 'int'}, 'max': {'key': 'max', 'type': 'int'}}
...
class ExpressRouteLink(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'etag': {'readonly': True}, 'router_name': {'readonly': True}, 'interface_name': {'readonly': True}, 'patch_panel_id': {'readonly': True}, 'rack_id': {'readonly': True}, 'connector_type': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'router_name': {'key': 'properties.routerName', 'type': 'str'}, 'interface_name': {'key': 'properties.interfaceName', 'type': 'str'}, 'patch_panel_id': {'key': 'properties.patchPanelId', 'type': 'str'}, 'rack_id': {'key': 'properties.rackId', 'type': 'str'}, 'connector_type': {'key': 'properties.connectorType', 'type': 'str'}, 'admin_state': {'key': 'properties.adminState', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, admin_state: Optional[Union[str, '_models.ExpressRouteLinkAdminState']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
...
class ExpressRouteLinkListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[ExpressRouteLink]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.ExpressRouteLink']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ExpressRoutePort(Resource):
    ...
    :vartype resource_guid: str
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'etag': {'readonly': True}, 'provisioned_bandwidth_in_gbps': {'readonly': True}, 'mtu': {'readonly': True}, 'ether_type': {'readonly': True}, 'allocation_date': {'readonly': True}, 'circuits': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'etag': {'key': 'etag', 'type': 'str'}, 'peering_location': {'key': 'properties.peeringLocation', 'type': 'str'}, 'bandwidth_in_gbps': {'key': 'properties.bandwidthInGbps', 'type': 'int'}, 'provisioned_bandwidth_in_gbps': {'key': 'properties.provisionedBandwidthInGbps', 'type': 'float'}, 'mtu': {'key': 'properties.mtu', 'type': 'str'}, 'encapsulation': {'key': 'properties.encapsulation', 'type': 'str'}, 'ether_type': {'key': 'properties.etherType', 'type': 'str'}, 'allocation_date': {'key': 'properties.allocationDate', 'type': 'str'}, 'links': {'key': 'properties.links', 'type': '[ExpressRouteLink]'}, 'circuits': {'key': 'properties.circuits', 'type': '[SubResource]'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}, 'resource_guid': {'key': 'properties.resourceGuid', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, peering_location: Optional[str]=None, bandwidth_in_gbps: Optional[int]=None, encapsulation: Optional[Union[str, '_models.ExpressRoutePortsEncapsulation']]=None, links: Optional[List['_models.ExpressRouteLink']]=None, resource_guid: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class ExpressRoutePortListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[ExpressRoutePort]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.ExpressRoutePort']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ExpressRoutePortsLocation(Resource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'address': {'readonly': True}, 'contact': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    ...
    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, available_bandwidths: Optional[List['_models.ExpressRoutePortsLocationBandwidths']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class ExpressRoutePortsLocationBandwidths(msrest.serialization.Model):
    ...
    """
    _validation = {'offer_name': {'readonly': True}, 'value_in_gbps': {'readonly': True}}
    _attribute_map = {'offer_name': {'key': 'offerName', 'type': 'str'}, 'value_in_gbps': {'key': 'valueInGbps', 'type': 'int'}}
...
class ExpressRoutePortsLocationListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[ExpressRoutePortsLocation]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.ExpressRoutePortsLocation']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ExpressRouteServiceProvider(Resource):
    ...
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'peering_locations': {'key': 'properties.peeringLocations', 'type': '[str]'}, 'bandwidths_offered': {'key': 'properties.bandwidthsOffered', 'type': '[ExpressRouteServiceProviderBandwidthsOffered]'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, peering_locations: Optional[List[str]]=None, bandwidths_offered: Optional[List['_models.ExpressRouteServiceProviderBandwidthsOffered']]=None, provisioning_state: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class ExpressRouteServiceProviderBandwidthsOffered(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'offer_name': {'key': 'offerName', 'type': 'str'}, 'value_in_mbps': {'key': 'valueInMbps', 'type': 'int'}}
...
class ExpressRouteServiceProviderListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[ExpressRouteServiceProvider]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.ExpressRouteServiceProvider']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class FlowLogInformation(msrest.serialization.Model):
    ...
    """
    _validation = {'target_resource_id': {'required': True}, 'storage_id': {'required': True}, 'enabled': {'required': True}}
    _attribute_map = {'target_resource_id': {'key': 'targetResourceId', 'type': 'str'}, 'flow_analytics_configuration': {'key': 'flowAnalyticsConfiguration', 'type': 'TrafficAnalyticsProperties'}, 'storage_id': {'key': 'properties.storageId', 'type': 'str'}, 'enabled': {'key': 'properties.enabled', 'type': 'bool'}, 'retention_policy': {'key': 'properties.retentionPolicy', 'type': 'RetentionPolicyParameters'}}

    def __init__(self, *, target_resource_id: str, storage_id: str, enabled: bool, flow_analytics_configuration: Optional['_models.TrafficAnalyticsProperties']=None, retention_policy: Optional['_models.RetentionPolicyParameters']=None, **kwargs):
        """
...
class FlowLogStatusParameters(msrest.serialization.Model):
    ...
    :vartype target_resource_id: str
    """
    _validation = {'target_resource_id': {'required': True}}
    _attribute_map = {'target_resource_id': {'key': 'targetResourceId', 'type': 'str'}}
...
class FrontendIPConfiguration(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'inbound_nat_rules': {'readonly': True}, 'inbound_nat_pools': {'readonly': True}, 'outbound_rules': {'readonly': True}, 'load_balancing_rules': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'zones': {'key': 'zones', 'type': '[str]'}, 'inbound_nat_rules': {'key': 'properties.inboundNatRules', 'type': '[SubResource]'}, 'inbound_nat_pools': {'key': 'properties.inboundNatPools', 'type': '[SubResource]'}, 'outbound_rules': {'key': 'properties.outboundRules', 'type': '[SubResource]'}, 'load_balancing_rules': {'key': 'properties.loadBalancingRules', 'type': '[SubResource]'}, 'private_ip_address': {'key': 'properties.privateIPAddress', 'type': 'str'}, 'private_ip_allocation_method': {'key': 'properties.privateIPAllocationMethod', 'type': 'str'}, 'subnet': {'key': 'properties.subnet', 'type': 'Subnet'}, 'public_ip_address': {'key': 'properties.publicIPAddress', 'type': 'PublicIPAddress'}, 'public_ip_prefix': {'key': 'properties.publicIPPrefix', 'type': 'SubResource'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, zones: Optional[List[str]]=None, private_ip_address: Optional[str]=None, private_ip_allocation_method: Optional[Union[str, '_models.IPAllocationMethod']]=None, subnet: Optional['_models.Subnet']=None, public_ip_address: Optional['_models.PublicIPAddress']=None, public_ip_prefix: Optional['_models.SubResource']=None, provisioning_state: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
...
class GatewayRoute(msrest.serialization.Model):
    ...
    :vartype weight: int
    """
    _validation = {'local_address': {'readonly': True}, 'network': {'readonly': True}, 'next_hop': {'readonly': True}, 'source_peer': {'readonly': True}, 'origin': {'readonly': True}, 'as_path': {'readonly': True}, 'weight': {'readonly': True}}
    _attribute_map = {'local_address': {'key': 'localAddress', 'type': 'str'}, 'network': {'key': 'network', 'type': 'str'}, 'next_hop': {'key': 'nextHop', 'type': 'str'}, 'source_peer': {'key': 'sourcePeer', 'type': 'str'}, 'origin': {'key': 'origin', 'type': 'str'}, 'as_path': {'key': 'asPath', 'type': 'str'}, 'weight': {'key': 'weight', 'type': 'int'}}
...
class GatewayRouteListResult(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[GatewayRoute]'}}
...
class GetVpnSitesConfigurationRequest(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'vpn_sites': {'key': 'vpnSites', 'type': '[str]'}, 'output_blob_sas_url': {'key': 'outputBlobSasUrl', 'type': 'str'}}
...
class HTTPConfiguration(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'method': {'key': 'method', 'type': 'str'}, 'headers': {'key': 'headers', 'type': '[HTTPHeader]'}, 'valid_status_codes': {'key': 'validStatusCodes', 'type': '[int]'}}

    def __init__(self, *, method: Optional[Union[str, '_models.HTTPMethod']]=None, headers: Optional[List['_models.HTTPHeader']]=None, valid_status_codes: Optional[List[int]]=None, **kwargs):
        """
...
class HubVirtualNetworkConnection(SubResource):
    ...
    """
    _validation = {'etag': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'remote_virtual_network': {'key': 'properties.remoteVirtualNetwork', 'type': 'SubResource'}, 'allow_hub_to_remote_vnet_transit': {'key': 'properties.allowHubToRemoteVnetTransit', 'type': 'bool'}, 'allow_remote_vnet_to_use_hub_vnet_gateways': {'key': 'properties.allowRemoteVnetToUseHubVnetGateways', 'type': 'bool'}, 'enable_internet_security': {'key': 'properties.enableInternetSecurity', 'type': 'bool'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, remote_virtual_network: Optional['_models.SubResource']=None, allow_hub_to_remote_vnet_transit: Optional[bool]=None, allow_remote_vnet_to_use_hub_vnet_gateways: Optional[bool]=None, enable_internet_security: Optional[bool]=None, provisioning_state: Optional[Union[str, '_models.ProvisioningState']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: The name of the resource that is unique within a resource group. This name can
...
class InboundNatRule(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'backend_ip_configuration': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'frontend_ip_configuration': {'key': 'properties.frontendIPConfiguration', 'type': 'SubResource'}, 'backend_ip_configuration': {'key': 'properties.backendIPConfiguration', 'type': 'NetworkInterfaceIPConfiguration'}, 'protocol': {'key': 'properties.protocol', 'type': 'str'}, 'frontend_port': {'key': 'properties.frontendPort', 'type': 'int'}, 'backend_port': {'key': 'properties.backendPort', 'type': 'int'}, 'idle_timeout_in_minutes': {'key': 'properties.idleTimeoutInMinutes', 'type': 'int'}, 'enable_floating_ip': {'key': 'properties.enableFloatingIP', 'type': 'bool'}, 'enable_tcp_reset': {'key': 'properties.enableTcpReset', 'type': 'bool'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}
...
class InboundNatRuleListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[InboundNatRule]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class InterfaceEndpoint(Resource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'network_interfaces': {'readonly': True}, 'owner': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'etag': {'key': 'etag', 'type': 'str'}, 'fqdn': {'key': 'properties.fqdn', 'type': 'str'}, 'endpoint_service': {'key': 'properties.endpointService', 'type': 'EndpointService'}, 'subnet': {'key': 'properties.subnet', 'type': 'Subnet'}, 'network_interfaces': {'key': 'properties.networkInterfaces', 'type': '[NetworkInterface]'}, 'owner': {'key': 'properties.owner', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, etag: Optional[str]=None, fqdn: Optional[str]=None, endpoint_service: Optional['_models.EndpointService']=None, subnet: Optional['_models.Subnet']=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class InterfaceEndpointListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[InterfaceEndpoint]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class IPAddressAvailabilityResult(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'available': {'key': 'available', 'type': 'bool'}, 'available_ip_addresses': {'key': 'availableIPAddresses', 'type': '[str]'}}

    def __init__(self, *, available: Optional[bool]=None, available_ip_addresses: Optional[List[str]]=None, **kwargs):
        """
...
class IPConfiguration(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'private_ip_address': {'key': 'properties.privateIPAddress', 'type': 'str'}, 'private_ip_allocation_method': {'key': 'properties.privateIPAllocationMethod', 'type': 'str'}, 'subnet': {'key': 'properties.subnet', 'type': 'Subnet'}, 'public_ip_address': {'key': 'properties.publicIPAddress', 'type': 'PublicIPAddress'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, private_ip_address: Optional[str]=None, private_ip_allocation_method: Optional[Union[str, '_models.IPAllocationMethod']]=None, subnet: Optional['_models.Subnet']=None, public_ip_address: Optional['_models.PublicIPAddress']=None, provisioning_state: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: The name of the resource that is unique within a resource group. This name can
...
class IPConfigurationProfile(SubResource):
    ...
    """
    _validation = {'type': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'subnet': {'key': 'properties.subnet', 'type': 'Subnet'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, subnet: Optional['_models.Subnet']=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: The name of the resource. This name can be used to access the resource.
...
class IpsecPolicy(msrest.serialization.Model):
    ...
    """
    _validation = {'sa_life_time_seconds': {'required': True}, 'sa_data_size_kilobytes': {'required': True}, 'ipsec_encryption': {'required': True}, 'ipsec_integrity': {'required': True}, 'ike_encryption': {'required': True}, 'ike_integrity': {'required': True}, 'dh_group': {'required': True}, 'pfs_group': {'required': True}}
    _attribute_map = {'sa_life_time_seconds': {'key': 'saLifeTimeSeconds', 'type': 'int'}, 'sa_data_size_kilobytes': {'key': 'saDataSizeKilobytes', 'type': 'int'}, 'ipsec_encryption': {'key': 'ipsecEncryption', 'type': 'str'}, 'ipsec_integrity': {'key': 'ipsecIntegrity', 'type': 'str'}, 'ike_encryption': {'key': 'ikeEncryption', 'type': 'str'}, 'ike_integrity': {'key': 'ikeIntegrity', 'type': 'str'}, 'dh_group': {'key': 'dhGroup', 'type': 'str'}, 'pfs_group': {'key': 'pfsGroup', 'type': 'str'}}

    def __init__(self, *, sa_life_time_seconds: int, sa_data_size_kilobytes: int, ipsec_encryption: Union[str, '_models.IpsecEncryption'], ipsec_integrity: Union[str, '_models.IpsecIntegrity'], ike_encryption: Union[str, '_models.IkeEncryption'], ike_integrity: Union[str, '_models.IkeIntegrity'], dh_group: Union[str, '_models.DhGroup'], pfs_group: Union[str, '_models.PfsGroup'], **kwargs):
        """
...
class IpTag(msrest.serialization.Model):
    ...
    :vartype tag: str
    """
    _attribute_map = {'ip_tag_type': {'key': 'ipTagType', 'type': 'str'}, 'tag': {'key': 'tag', 'type': 'str'}}
...
class Ipv6ExpressRouteCircuitPeeringConfig(msrest.serialization.Model):
    ...
    def __init__(self, *, primary_peer_address_prefix: Optional[str]=None, secondary_peer_address_prefix: Optional[str]=None, microsoft_peering_config: Optional['_models.ExpressRouteCircuitPeeringConfig']=None, route_filter: Optional['_models.RouteFilter']=None, state: Optional[Union[str, '_models.ExpressRouteCircuitPeeringState']]=None, **kwargs):
        """
        :keyword primary_peer_address_prefix: The primary address prefix.
        :paramtype primary_peer_address_prefix: str
        :keyword secondary_peer_address_prefix: The secondary address prefix.
...
class ListHubVirtualNetworkConnectionsResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[HubVirtualNetworkConnection]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.HubVirtualNetworkConnection']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ListP2SVpnGatewaysResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[P2SVpnGateway]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.P2SVpnGateway']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ListP2SVpnServerConfigurationsResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[P2SVpnServerConfiguration]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.P2SVpnServerConfiguration']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ListVirtualHubsResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[VirtualHub]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.VirtualHub']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ListVirtualWANsResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[VirtualWAN]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.VirtualWAN']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ListVpnConnectionsResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[VpnConnection]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.VpnConnection']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ListVpnGatewaysResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[VpnGateway]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.VpnGateway']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ListVpnSitesResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[VpnSite]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class LoadBalancerBackendAddressPoolListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[BackendAddressPool]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class LoadBalancerFrontendIPConfigurationListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[FrontendIPConfiguration]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class LoadBalancerListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[LoadBalancer]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class LoadBalancerLoadBalancingRuleListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[LoadBalancingRule]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class LoadBalancerOutboundRuleListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[OutboundRule]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class LoadBalancerProbeListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[Probe]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class LoadBalancingRule(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'frontend_ip_configuration': {'key': 'properties.frontendIPConfiguration', 'type': 'SubResource'}, 'backend_address_pool': {'key': 'properties.backendAddressPool', 'type': 'SubResource'}, 'probe': {'key': 'properties.probe', 'type': 'SubResource'}, 'protocol': {'key': 'properties.protocol', 'type': 'str'}, 'load_distribution': {'key': 'properties.loadDistribution', 'type': 'str'}, 'frontend_port': {'key': 'properties.frontendPort', 'type': 'int'}, 'backend_port': {'key': 'properties.backendPort', 'type': 'int'}, 'idle_timeout_in_minutes': {'key': 'properties.idleTimeoutInMinutes', 'type': 'int'}, 'enable_floating_ip': {'key': 'properties.enableFloatingIP', 'type': 'bool'}, 'enable_tcp_reset': {'key': 'properties.enableTcpReset', 'type': 'bool'}, 'disable_outbound_snat': {'key': 'properties.disableOutboundSnat', 'type': 'bool'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}
...
class LocalNetworkGateway(Resource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'etag': {'key': 'etag', 'type': 'str'}, 'local_network_address_space': {'key': 'properties.localNetworkAddressSpace', 'type': 'AddressSpace'}, 'gateway_ip_address': {'key': 'properties.gatewayIpAddress', 'type': 'str'}, 'bgp_settings': {'key': 'properties.bgpSettings', 'type': 'BgpSettings'}, 'resource_guid': {'key': 'properties.resourceGuid', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, etag: Optional[str]=None, local_network_address_space: Optional['_models.AddressSpace']=None, gateway_ip_address: Optional[str]=None, bgp_settings: Optional['_models.BgpSettings']=None, resource_guid: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class LocalNetworkGatewayListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[LocalNetworkGateway]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class LogSpecification(msrest.serialization.Model):
    ...
    :vartype blob_duration: str
    """
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'display_name': {'key': 'displayName', 'type': 'str'}, 'blob_duration': {'key': 'blobDuration', 'type': 'str'}}

    def __init__(self, *, name: Optional[str]=None, display_name: Optional[str]=None, blob_duration: Optional[str]=None, **kwargs):
        """
...
class MatchedRule(msrest.serialization.Model):
    ...
    :vartype action: str
    """
    _attribute_map = {'rule_name': {'key': 'ruleName', 'type': 'str'}, 'action': {'key': 'action', 'type': 'str'}}
...
class NetworkConfigurationDiagnosticParameters(msrest.serialization.Model):
    ...
    """
    _validation = {'target_resource_id': {'required': True}, 'profiles': {'required': True}}
    _attribute_map = {'target_resource_id': {'key': 'targetResourceId', 'type': 'str'}, 'verbosity_level': {'key': 'verbosityLevel', 'type': 'str'}, 'profiles': {'key': 'profiles', 'type': '[NetworkConfigurationDiagnosticProfile]'}}

    def __init__(self, *, target_resource_id: str, profiles: List['_models.NetworkConfigurationDiagnosticProfile'], verbosity_level: Optional[Union[str, '_models.VerbosityLevel']]=None, **kwargs):
        """
...
class NetworkConfigurationDiagnosticProfile(msrest.serialization.Model):
    ...
    """
    _validation = {'direction': {'required': True}, 'protocol': {'required': True}, 'source': {'required': True}, 'destination': {'required': True}, 'destination_port': {'required': True}}
    _attribute_map = {'direction': {'key': 'direction', 'type': 'str'}, 'protocol': {'key': 'protocol', 'type': 'str'}, 'source': {'key': 'source', 'type': 'str'}, 'destination': {'key': 'destination', 'type': 'str'}, 'destination_port': {'key': 'destinationPort', 'type': 'str'}}

    def __init__(self, *, direction: Union[str, '_models.Direction'], protocol: str, source: str, destination: str, destination_port: str, **kwargs):
        """
...
class NetworkConfigurationDiagnosticResponse(msrest.serialization.Model):
    ...
    """
    _validation = {'results': {'readonly': True}}
    _attribute_map = {'results': {'key': 'results', 'type': '[NetworkConfigurationDiagnosticResult]'}}
...
class NetworkConfigurationDiagnosticResult(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'profile': {'key': 'profile', 'type': 'NetworkConfigurationDiagnosticProfile'}, 'network_security_group_result': {'key': 'networkSecurityGroupResult', 'type': 'NetworkSecurityGroupResult'}}

    def __init__(self, *, profile: Optional['_models.NetworkConfigurationDiagnosticProfile']=None, network_security_group_result: Optional['_models.NetworkSecurityGroupResult']=None, **kwargs):
        """
...
class NetworkInterface(Resource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'virtual_machine': {'readonly': True}, 'interface_endpoint': {'readonly': True}, 'hosted_workloads': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'etag': {'key': 'etag', 'type': 'str'}, 'virtual_machine': {'key': 'properties.virtualMachine', 'type': 'SubResource'}, 'network_security_group': {'key': 'properties.networkSecurityGroup', 'type': 'NetworkSecurityGroup'}, 'interface_endpoint': {'key': 'properties.interfaceEndpoint', 'type': 'InterfaceEndpoint'}, 'ip_configurations': {'key': 'properties.ipConfigurations', 'type': '[NetworkInterfaceIPConfiguration]'}, 'tap_configurations': {'key': 'properties.tapConfigurations', 'type': '[NetworkInterfaceTapConfiguration]'}, 'dns_settings': {'key': 'properties.dnsSettings', 'type': 'NetworkInterfaceDnsSettings'}, 'mac_address': {'key': 'properties.macAddress', 'type': 'str'}, 'primary': {'key': 'properties.primary', 'type': 'bool'}, 'enable_accelerated_networking': {'key': 'properties.enableAcceleratedNetworking', 'type': 'bool'}, 'enable_ip_forwarding': {'key': 'properties.enableIPForwarding', 'type': 'bool'}, 'hosted_workloads': {'key': 'properties.hostedWorkloads', 'type': '[str]'}, 'resource_guid': {'key': 'properties.resourceGuid', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, etag: Optional[str]=None, network_security_group: Optional['_models.NetworkSecurityGroup']=None, ip_configurations: Optional[List['_models.NetworkInterfaceIPConfiguration']]=None, tap_configurations: Optional[List['_models.NetworkInterfaceTapConfiguration']]=None, dns_settings: Optional['_models.NetworkInterfaceDnsSettings']=None, mac_address: Optional[str]=None, primary: Optional[bool]=None, enable_accelerated_networking: Optional[bool]=None, enable_ip_forwarding: Optional[bool]=None, resource_guid: Optional[str]=None, provisioning_state: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class NetworkInterfaceAssociation(msrest.serialization.Model):
    ...
    """
    _validation = {'id': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'security_rules': {'key': 'securityRules', 'type': '[SecurityRule]'}}
...
class NetworkInterfaceDnsSettings(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'dns_servers': {'key': 'dnsServers', 'type': '[str]'}, 'applied_dns_servers': {'key': 'appliedDnsServers', 'type': '[str]'}, 'internal_dns_name_label': {'key': 'internalDnsNameLabel', 'type': 'str'}, 'internal_fqdn': {'key': 'internalFqdn', 'type': 'str'}, 'internal_domain_name_suffix': {'key': 'internalDomainNameSuffix', 'type': 'str'}}

    def __init__(self, *, dns_servers: Optional[List[str]]=None, applied_dns_servers: Optional[List[str]]=None, internal_dns_name_label: Optional[str]=None, internal_fqdn: Optional[str]=None, internal_domain_name_suffix: Optional[str]=None, **kwargs):
        """
...
class NetworkInterfaceIPConfigurationListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[NetworkInterfaceIPConfiguration]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class NetworkInterfaceListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[NetworkInterface]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class NetworkInterfaceTapConfiguration(SubResource):
    ...
    """
    _validation = {'type': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'virtual_network_tap': {'key': 'properties.virtualNetworkTap', 'type': 'VirtualNetworkTap'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, virtual_network_tap: Optional['_models.VirtualNetworkTap']=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: The name of the resource that is unique within a resource group. This name can
...
class NetworkInterfaceTapConfigurationListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[NetworkInterfaceTapConfiguration]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class NetworkProfile(Resource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'resource_guid': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'etag': {'key': 'etag', 'type': 'str'}, 'container_network_interfaces': {'key': 'properties.containerNetworkInterfaces', 'type': '[ContainerNetworkInterface]'}, 'container_network_interface_configurations': {'key': 'properties.containerNetworkInterfaceConfigurations', 'type': '[ContainerNetworkInterfaceConfiguration]'}, 'resource_guid': {'key': 'properties.resourceGuid', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, etag: Optional[str]=None, container_network_interfaces: Optional[List['_models.ContainerNetworkInterface']]=None, container_network_interface_configurations: Optional[List['_models.ContainerNetworkInterfaceConfiguration']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class NetworkProfileListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[NetworkProfile]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.NetworkProfile']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class NetworkSecurityGroupListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[NetworkSecurityGroup]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.NetworkSecurityGroup']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class NetworkSecurityGroupResult(msrest.serialization.Model):
    ...
    """
    _validation = {'evaluated_network_security_groups': {'readonly': True}}
    _attribute_map = {'security_rule_access_result': {'key': 'securityRuleAccessResult', 'type': 'str'}, 'evaluated_network_security_groups': {'key': 'evaluatedNetworkSecurityGroups', 'type': '[EvaluatedNetworkSecurityGroup]'}}

    def __init__(self, *, security_rule_access_result: Optional[Union[str, '_models.SecurityRuleAccess']]=None, **kwargs):
        """
...
class NetworkSecurityRulesEvaluationResult(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'protocol_matched': {'key': 'protocolMatched', 'type': 'bool'}, 'source_matched': {'key': 'sourceMatched', 'type': 'bool'}, 'source_port_matched': {'key': 'sourcePortMatched', 'type': 'bool'}, 'destination_matched': {'key': 'destinationMatched', 'type': 'bool'}, 'destination_port_matched': {'key': 'destinationPortMatched', 'type': 'bool'}}

    def __init__(self, *, name: Optional[str]=None, protocol_matched: Optional[bool]=None, source_matched: Optional[bool]=None, source_port_matched: Optional[bool]=None, destination_matched: Optional[bool]=None, destination_port_matched: Optional[bool]=None, **kwargs):
        """
...
class NetworkWatcher(Resource):
    ...
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'etag': {'key': 'etag', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, etag: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class NetworkWatcherListResult(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[NetworkWatcher]'}}
...
class NextHopParameters(msrest.serialization.Model):
    ...
    """
    _validation = {'target_resource_id': {'required': True}, 'source_ip_address': {'required': True}, 'destination_ip_address': {'required': True}}
    _attribute_map = {'target_resource_id': {'key': 'targetResourceId', 'type': 'str'}, 'source_ip_address': {'key': 'sourceIPAddress', 'type': 'str'}, 'destination_ip_address': {'key': 'destinationIPAddress', 'type': 'str'}, 'target_nic_resource_id': {'key': 'targetNicResourceId', 'type': 'str'}}

    def __init__(self, *, target_resource_id: str, source_ip_address: str, destination_ip_address: str, target_nic_resource_id: Optional[str]=None, **kwargs):
        """
...
class NextHopResult(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'next_hop_type': {'key': 'nextHopType', 'type': 'str'}, 'next_hop_ip_address': {'key': 'nextHopIpAddress', 'type': 'str'}, 'route_table_id': {'key': 'routeTableId', 'type': 'str'}}

    def __init__(self, *, next_hop_type: Optional[Union[str, '_models.NextHopType']]=None, next_hop_ip_address: Optional[str]=None, route_table_id: Optional[str]=None, **kwargs):
        """
...
class Operation(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'display': {'key': 'display', 'type': 'OperationDisplay'}, 'origin': {'key': 'origin', 'type': 'str'}, 'service_specification': {'key': 'properties.serviceSpecification', 'type': 'OperationPropertiesFormatServiceSpecification'}}

    def __init__(self, *, name: Optional[str]=None, display: Optional['_models.OperationDisplay']=None, origin: Optional[str]=None, service_specification: Optional['_models.OperationPropertiesFormatServiceSpecification']=None, **kwargs):
        """
...
class OperationPropertiesFormatServiceSpecification(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'metric_specifications': {'key': 'metricSpecifications', 'type': '[MetricSpecification]'}, 'log_specifications': {'key': 'logSpecifications', 'type': '[LogSpecification]'}}

    def __init__(self, *, metric_specifications: Optional[List['_models.MetricSpecification']]=None, log_specifications: Optional[List['_models.LogSpecification']]=None, **kwargs):
        """
...
class P2SVpnGateway(Resource):
    ...
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'etag': {'readonly': True}, 'vpn_client_connection_health': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'etag': {'key': 'etag', 'type': 'str'}, 'virtual_hub': {'key': 'properties.virtualHub', 'type': 'SubResource'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}, 'vpn_gateway_scale_unit': {'key': 'properties.vpnGatewayScaleUnit', 'type': 'int'}, 'p2_s_vpn_server_configuration': {'key': 'properties.p2SVpnServerConfiguration', 'type': 'SubResource'}, 'vpn_client_address_pool': {'key': 'properties.vpnClientAddressPool', 'type': 'AddressSpace'}, 'vpn_client_connection_health': {'key': 'properties.vpnClientConnectionHealth', 'type': 'VpnClientConnectionHealth'}}

    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, virtual_hub: Optional['_models.SubResource']=None, provisioning_state: Optional[Union[str, '_models.ProvisioningState']]=None, vpn_gateway_scale_unit: Optional[int]=None, p2_s_vpn_server_configuration: Optional['_models.SubResource']=None, vpn_client_address_pool: Optional['_models.AddressSpace']=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class P2SVpnProfileParameters(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'authentication_method': {'key': 'authenticationMethod', 'type': 'str'}}
...
class P2SVpnServerConfigRadiusClientRootCertificate(SubResource):
    ...
    """
    _validation = {'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'thumbprint': {'key': 'properties.thumbprint', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, thumbprint: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: The name of the resource that is unique within a resource group. This name can
...
class P2SVpnServerConfigRadiusServerRootCertificate(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'public_cert_data': {'required': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'public_cert_data': {'key': 'properties.publicCertData', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, public_cert_data: str, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: The name of the resource that is unique within a resource group. This name can
...
class P2SVpnServerConfiguration(SubResource):
    ...
    """
    _validation = {'etag': {'readonly': True}, 'provisioning_state': {'readonly': True}, 'p2_s_vpn_gateways': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'name_properties_name': {'key': 'properties.name', 'type': 'str'}, 'vpn_protocols': {'key': 'properties.vpnProtocols', 'type': '[str]'}, 'p2_s_vpn_server_config_vpn_client_root_certificates': {'key': 'properties.p2SVpnServerConfigVpnClientRootCertificates', 'type': '[P2SVpnServerConfigVpnClientRootCertificate]'}, 'p2_s_vpn_server_config_vpn_client_revoked_certificates': {'key': 'properties.p2SVpnServerConfigVpnClientRevokedCertificates', 'type': '[P2SVpnServerConfigVpnClientRevokedCertificate]'}, 'p2_s_vpn_server_config_radius_server_root_certificates': {'key': 'properties.p2SVpnServerConfigRadiusServerRootCertificates', 'type': '[P2SVpnServerConfigRadiusServerRootCertificate]'}, 'p2_s_vpn_server_config_radius_client_root_certificates': {'key': 'properties.p2SVpnServerConfigRadiusClientRootCertificates', 'type': '[P2SVpnServerConfigRadiusClientRootCertificate]'}, 'vpn_client_ipsec_policies': {'key': 'properties.vpnClientIpsecPolicies', 'type': '[IpsecPolicy]'}, 'radius_server_address': {'key': 'properties.radiusServerAddress', 'type': 'str'}, 'radius_server_secret': {'key': 'properties.radiusServerSecret', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}, 'p2_s_vpn_gateways': {'key': 'properties.p2SVpnGateways', 'type': '[SubResource]'}, 'etag_properties_etag': {'key': 'properties.etag', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, name_properties_name: Optional[str]=None, vpn_protocols: Optional[List[Union[str, '_models.VpnGatewayTunnelingProtocol']]]=None, p2_s_vpn_server_config_vpn_client_root_certificates: Optional[List['_models.P2SVpnServerConfigVpnClientRootCertificate']]=None, p2_s_vpn_server_config_vpn_client_revoked_certificates: Optional[List['_models.P2SVpnServerConfigVpnClientRevokedCertificate']]=None, p2_s_vpn_server_config_radius_server_root_certificates: Optional[List['_models.P2SVpnServerConfigRadiusServerRootCertificate']]=None, p2_s_vpn_server_config_radius_client_root_certificates: Optional[List['_models.P2SVpnServerConfigRadiusClientRootCertificate']]=None, vpn_client_ipsec_policies: Optional[List['_models.IpsecPolicy']]=None, radius_server_address: Optional[str]=None, radius_server_secret: Optional[str]=None, etag_properties_etag: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: The name of the resource that is unique within a resource group. This name can
...
class PacketCapture(msrest.serialization.Model):
    ...
    """
    _validation = {'target': {'required': True}, 'storage_location': {'required': True}}
    _attribute_map = {'target': {'key': 'properties.target', 'type': 'str'}, 'bytes_to_capture_per_packet': {'key': 'properties.bytesToCapturePerPacket', 'type': 'int'}, 'total_bytes_per_session': {'key': 'properties.totalBytesPerSession', 'type': 'int'}, 'time_limit_in_seconds': {'key': 'properties.timeLimitInSeconds', 'type': 'int'}, 'storage_location': {'key': 'properties.storageLocation', 'type': 'PacketCaptureStorageLocation'}, 'filters': {'key': 'properties.filters', 'type': '[PacketCaptureFilter]'}}

    def __init__(self, *, target: str, storage_location: '_models.PacketCaptureStorageLocation', bytes_to_capture_per_packet: Optional[int]=0, total_bytes_per_session: Optional[int]=1073741824, time_limit_in_seconds: Optional[int]=18000, filters: Optional[List['_models.PacketCaptureFilter']]=None, **kwargs):
        """
...
class PacketCaptureFilter(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'protocol': {'key': 'protocol', 'type': 'str'}, 'local_ip_address': {'key': 'localIPAddress', 'type': 'str'}, 'remote_ip_address': {'key': 'remoteIPAddress', 'type': 'str'}, 'local_port': {'key': 'localPort', 'type': 'str'}, 'remote_port': {'key': 'remotePort', 'type': 'str'}}

    def __init__(self, *, protocol: Optional[Union[str, '_models.PcProtocol']]='Any', local_ip_address: Optional[str]=None, remote_ip_address: Optional[str]=None, local_port: Optional[str]=None, remote_port: Optional[str]=None, **kwargs):
        """
...
class PacketCaptureListResult(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[PacketCaptureResult]'}}
...
class PacketCaptureQueryStatusResult(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'id': {'key': 'id', 'type': 'str'}, 'capture_start_time': {'key': 'captureStartTime', 'type': 'iso-8601'}, 'packet_capture_status': {'key': 'packetCaptureStatus', 'type': 'str'}, 'stop_reason': {'key': 'stopReason', 'type': 'str'}, 'packet_capture_error': {'key': 'packetCaptureError', 'type': '[str]'}}

    def __init__(self, *, name: Optional[str]=None, id: Optional[str]=None, capture_start_time: Optional[datetime.datetime]=None, packet_capture_status: Optional[Union[str, '_models.PcStatus']]=None, stop_reason: Optional[str]=None, packet_capture_error: Optional[List[Union[str, '_models.PcError']]]=None, **kwargs):
        """
...
class PacketCaptureResult(msrest.serialization.Model):
    ...
    :vartype provisioning_state: str or ~azure.mgmt.network.v2018_08_01.models.ProvisioningState
    """
    _validation = {'name': {'readonly': True}, 'id': {'readonly': True}}
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'id': {'key': 'id', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'target': {'key': 'properties.target', 'type': 'str'}, 'bytes_to_capture_per_packet': {'key': 'properties.bytesToCapturePerPacket', 'type': 'int'}, 'total_bytes_per_session': {'key': 'properties.totalBytesPerSession', 'type': 'int'}, 'time_limit_in_seconds': {'key': 'properties.timeLimitInSeconds', 'type': 'int'}, 'storage_location': {'key': 'properties.storageLocation', 'type': 'PacketCaptureStorageLocation'}, 'filters': {'key': 'properties.filters', 'type': '[PacketCaptureFilter]'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, etag: Optional[str]='A unique read-only string that changes whenever the resource is updated.', target: Optional[str]=None, bytes_to_capture_per_packet: Optional[int]=0, total_bytes_per_session: Optional[int]=1073741824, time_limit_in_seconds: Optional[int]=18000, storage_location: Optional['_models.PacketCaptureStorageLocation']=None, filters: Optional[List['_models.PacketCaptureFilter']]=None, provisioning_state: Optional[Union[str, '_models.ProvisioningState']]=None, **kwargs):
        """
        :keyword etag:
        :paramtype etag: str
...
class PacketCaptureResultProperties(PacketCaptureParameters):
    ...
    def __init__(self, *, target: str, storage_location: '_models.PacketCaptureStorageLocation', bytes_to_capture_per_packet: Optional[int]=0, total_bytes_per_session: Optional[int]=1073741824, time_limit_in_seconds: Optional[int]=18000, filters: Optional[List['_models.PacketCaptureFilter']]=None, provisioning_state: Optional[Union[str, '_models.ProvisioningState']]=None, **kwargs):
        """
        :keyword target: Required. The ID of the targeted resource, only VM is currently supported.
        :paramtype target: str
        :keyword bytes_to_capture_per_packet: Number of bytes captured per packet, the remaining bytes
...
class PacketCaptureStorageLocation(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'storage_id': {'key': 'storageId', 'type': 'str'}, 'storage_path': {'key': 'storagePath', 'type': 'str'}, 'file_path': {'key': 'filePath', 'type': 'str'}}

    def __init__(self, *, storage_id: Optional[str]=None, storage_path: Optional[str]=None, file_path: Optional[str]=None, **kwargs):
        """
...
class PatchRouteFilter(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'name': {'readonly': True}, 'etag': {'readonly': True}, 'type': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'rules': {'key': 'properties.rules', 'type': '[RouteFilterRule]'}, 'peerings': {'key': 'properties.peerings', 'type': '[ExpressRouteCircuitPeering]'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, tags: Optional[Dict[str, str]]=None, rules: Optional[List['_models.RouteFilterRule']]=None, peerings: Optional[List['_models.ExpressRouteCircuitPeering']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword tags: A set of tags. Resource tags.
...
class PatchRouteFilterRule(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'name': {'readonly': True}, 'etag': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'access': {'key': 'properties.access', 'type': 'str'}, 'route_filter_rule_type': {'key': 'properties.routeFilterRuleType', 'type': 'str'}, 'communities': {'key': 'properties.communities', 'type': '[str]'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, access: Optional[Union[str, '_models.Access']]=None, route_filter_rule_type: Optional[Union[str, '_models.RouteFilterRuleType']]=None, communities: Optional[List[str]]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
...
class Probe(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'load_balancing_rules': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'load_balancing_rules': {'key': 'properties.loadBalancingRules', 'type': '[SubResource]'}, 'protocol': {'key': 'properties.protocol', 'type': 'str'}, 'port': {'key': 'properties.port', 'type': 'int'}, 'interval_in_seconds': {'key': 'properties.intervalInSeconds', 'type': 'int'}, 'number_of_probes': {'key': 'properties.numberOfProbes', 'type': 'int'}, 'request_path': {'key': 'properties.requestPath', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, protocol: Optional[Union[str, '_models.ProbeProtocol']]=None, port: Optional[int]=None, interval_in_seconds: Optional[int]=None, number_of_probes: Optional[int]=None, request_path: Optional[str]=None, provisioning_state: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: Gets name of the resource that is unique within a resource group. This name can
...
class ProtocolConfiguration(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'http_configuration': {'key': 'HTTPConfiguration', 'type': 'HTTPConfiguration'}}
...
class PublicIPAddress(Resource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'ip_configuration': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'sku': {'key': 'sku', 'type': 'PublicIPAddressSku'}, 'etag': {'key': 'etag', 'type': 'str'}, 'zones': {'key': 'zones', 'type': '[str]'}, 'public_ip_allocation_method': {'key': 'properties.publicIPAllocationMethod', 'type': 'str'}, 'public_ip_address_version': {'key': 'properties.publicIPAddressVersion', 'type': 'str'}, 'ip_configuration': {'key': 'properties.ipConfiguration', 'type': 'IPConfiguration'}, 'dns_settings': {'key': 'properties.dnsSettings', 'type': 'PublicIPAddressDnsSettings'}, 'ip_tags': {'key': 'properties.ipTags', 'type': '[IpTag]'}, 'ip_address': {'key': 'properties.ipAddress', 'type': 'str'}, 'public_ip_prefix': {'key': 'properties.publicIPPrefix', 'type': 'SubResource'}, 'idle_timeout_in_minutes': {'key': 'properties.idleTimeoutInMinutes', 'type': 'int'}, 'resource_guid': {'key': 'properties.resourceGuid', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, sku: Optional['_models.PublicIPAddressSku']=None, etag: Optional[str]=None, zones: Optional[List[str]]=None, public_ip_allocation_method: Optional[Union[str, '_models.IPAllocationMethod']]=None, public_ip_address_version: Optional[Union[str, '_models.IPVersion']]=None, dns_settings: Optional['_models.PublicIPAddressDnsSettings']=None, ip_tags: Optional[List['_models.IpTag']]=None, ip_address: Optional[str]=None, public_ip_prefix: Optional['_models.SubResource']=None, idle_timeout_in_minutes: Optional[int]=None, resource_guid: Optional[str]=None, provisioning_state: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class PublicIPAddressDnsSettings(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'domain_name_label': {'key': 'domainNameLabel', 'type': 'str'}, 'fqdn': {'key': 'fqdn', 'type': 'str'}, 'reverse_fqdn': {'key': 'reverseFqdn', 'type': 'str'}}

    def __init__(self, *, domain_name_label: Optional[str]=None, fqdn: Optional[str]=None, reverse_fqdn: Optional[str]=None, **kwargs):
        """
...
class PublicIPAddressListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[PublicIPAddress]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.PublicIPAddress']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class PublicIPPrefixListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[PublicIPPrefix]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.PublicIPPrefix']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ResourceNavigationLink(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'etag': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'linked_resource_type': {'key': 'properties.linkedResourceType', 'type': 'str'}, 'link': {'key': 'properties.link', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, linked_resource_type: Optional[str]=None, link: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: Name of the resource that is unique within a resource group. This name can be
...
class RetentionPolicyParameters(msrest.serialization.Model):
    ...
    :vartype enabled: bool
    """
    _attribute_map = {'days': {'key': 'days', 'type': 'int'}, 'enabled': {'key': 'enabled', 'type': 'bool'}}
...
class Route(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'address_prefix': {'key': 'properties.addressPrefix', 'type': 'str'}, 'next_hop_type': {'key': 'properties.nextHopType', 'type': 'str'}, 'next_hop_ip_address': {'key': 'properties.nextHopIpAddress', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, address_prefix: Optional[str]=None, next_hop_type: Optional[Union[str, '_models.RouteNextHopType']]=None, next_hop_ip_address: Optional[str]=None, provisioning_state: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: The name of the resource that is unique within a resource group. This name can
...
class RouteFilter(Resource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'etag': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'etag': {'key': 'etag', 'type': 'str'}, 'rules': {'key': 'properties.rules', 'type': '[RouteFilterRule]'}, 'peerings': {'key': 'properties.peerings', 'type': '[ExpressRouteCircuitPeering]'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, rules: Optional[List['_models.RouteFilterRule']]=None, peerings: Optional[List['_models.ExpressRouteCircuitPeering']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class RouteFilterListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[RouteFilter]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.RouteFilter']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class RouteFilterRule(SubResource):
    ...
    """
    _validation = {'etag': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'access': {'key': 'properties.access', 'type': 'str'}, 'route_filter_rule_type': {'key': 'properties.routeFilterRuleType', 'type': 'str'}, 'communities': {'key': 'properties.communities', 'type': '[str]'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, location: Optional[str]=None, access: Optional[Union[str, '_models.Access']]=None, route_filter_rule_type: Optional[Union[str, '_models.RouteFilterRuleType']]=None, communities: Optional[List[str]]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: The name of the resource that is unique within a resource group. This name can
...
class RouteFilterRuleListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[RouteFilterRule]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.RouteFilterRule']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class RouteListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[Route]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class RouteTable(Resource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'subnets': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'etag': {'key': 'etag', 'type': 'str'}, 'routes': {'key': 'properties.routes', 'type': '[Route]'}, 'subnets': {'key': 'properties.subnets', 'type': '[Subnet]'}, 'disable_bgp_route_propagation': {'key': 'properties.disableBgpRoutePropagation', 'type': 'bool'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, etag: Optional[str]=None, routes: Optional[List['_models.Route']]=None, disable_bgp_route_propagation: Optional[bool]=None, provisioning_state: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class RouteTableListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[RouteTable]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.RouteTable']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class SecurityGroupNetworkInterface(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'security_rule_associations': {'key': 'securityRuleAssociations', 'type': 'SecurityRuleAssociations'}}

    def __init__(self, *, id: Optional[str]=None, security_rule_associations: Optional['_models.SecurityRuleAssociations']=None, **kwargs):
        """
...
class SecurityGroupViewResult(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'network_interfaces': {'key': 'networkInterfaces', 'type': '[SecurityGroupNetworkInterface]'}}
...
class SecurityRuleListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[SecurityRule]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.SecurityRule']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ServiceEndpointPolicy(Resource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'subnets': {'readonly': True}, 'resource_guid': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    ...
    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, etag: Optional[str]=None, service_endpoint_policy_definitions: Optional[List['_models.ServiceEndpointPolicyDefinition']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class ServiceEndpointPolicyDefinition(SubResource):
    ...
    """
    _validation = {'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'description': {'key': 'properties.description', 'type': 'str'}, 'service': {'key': 'properties.service', 'type': 'str'}, 'service_resources': {'key': 'properties.serviceResources', 'type': '[str]'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, description: Optional[str]=None, service: Optional[str]=None, service_resources: Optional[List[str]]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: The name of the resource that is unique within a resource group. This name can
...
class ServiceEndpointPolicyDefinitionListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[ServiceEndpointPolicyDefinition]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.ServiceEndpointPolicyDefinition']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class ServiceEndpointPolicyListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[ServiceEndpointPolicy]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class ServiceEndpointPropertiesFormat(msrest.serialization.Model):
    ...
    :vartype provisioning_state: str
    """
    _attribute_map = {'service': {'key': 'service', 'type': 'str'}, 'locations': {'key': 'locations', 'type': '[str]'}, 'provisioning_state': {'key': 'provisioningState', 'type': 'str'}}

    def __init__(self, *, service: Optional[str]=None, locations: Optional[List[str]]=None, provisioning_state: Optional[str]=None, **kwargs):
        """
...
class Subnet(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _validation = {'interface_endpoints': {'readonly': True}, 'ip_configurations': {'readonly': True}, 'ip_configuration_profiles': {'readonly': True}, 'purpose': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'address_prefix': {'key': 'properties.addressPrefix', 'type': 'str'}, 'address_prefixes': {'key': 'properties.addressPrefixes', 'type': '[str]'}, 'network_security_group': {'key': 'properties.networkSecurityGroup', 'type': 'NetworkSecurityGroup'}, 'route_table': {'key': 'properties.routeTable', 'type': 'RouteTable'}, 'service_endpoints': {'key': 'properties.serviceEndpoints', 'type': '[ServiceEndpointPropertiesFormat]'}, 'service_endpoint_policies': {'key': 'properties.serviceEndpointPolicies', 'type': '[ServiceEndpointPolicy]'}, 'interface_endpoints': {'key': 'properties.interfaceEndpoints', 'type': '[InterfaceEndpoint]'}, 'ip_configurations': {'key': 'properties.ipConfigurations', 'type': '[IPConfiguration]'}, 'ip_configuration_profiles': {'key': 'properties.ipConfigurationProfiles', 'type': '[IPConfigurationProfile]'}, 'resource_navigation_links': {'key': 'properties.resourceNavigationLinks', 'type': '[ResourceNavigationLink]'}, 'service_association_links': {'key': 'properties.serviceAssociationLinks', 'type': '[ServiceAssociationLink]'}, 'delegations': {'key': 'properties.delegations', 'type': '[Delegation]'}, 'purpose': {'key': 'properties.purpose', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, address_prefix: Optional[str]=None, address_prefixes: Optional[List[str]]=None, network_security_group: Optional['_models.NetworkSecurityGroup']=None, route_table: Optional['_models.RouteTable']=None, service_endpoints: Optional[List['_models.ServiceEndpointPropertiesFormat']]=None, service_endpoint_policies: Optional[List['_models.ServiceEndpointPolicy']]=None, resource_navigation_links: Optional[List['_models.ResourceNavigationLink']]=None, service_association_links: Optional[List['_models.ServiceAssociationLink']]=None, delegations: Optional[List['_models.Delegation']]=None, provisioning_state: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: The name of the resource that is unique within a resource group. This name can
...
class SubnetListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[Subnet]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class Topology(msrest.serialization.Model):
    ...
    """
    _validation = {'id': {'readonly': True}, 'created_date_time': {'readonly': True}, 'last_modified': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'created_date_time': {'key': 'createdDateTime', 'type': 'iso-8601'}, 'last_modified': {'key': 'lastModified', 'type': 'iso-8601'}, 'resources': {'key': 'resources', 'type': '[TopologyResource]'}}
...
class TopologyAssociation(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'resource_id': {'key': 'resourceId', 'type': 'str'}, 'association_type': {'key': 'associationType', 'type': 'str'}}

    def __init__(self, *, name: Optional[str]=None, resource_id: Optional[str]=None, association_type: Optional[Union[str, '_models.AssociationType']]=None, **kwargs):
        """
...
class TopologyParameters(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'target_resource_group_name': {'key': 'targetResourceGroupName', 'type': 'str'}, 'target_virtual_network': {'key': 'targetVirtualNetwork', 'type': 'SubResource'}, 'target_subnet': {'key': 'targetSubnet', 'type': 'SubResource'}}

    def __init__(self, *, target_resource_group_name: Optional[str]=None, target_virtual_network: Optional['_models.SubResource']=None, target_subnet: Optional['_models.SubResource']=None, **kwargs):
        """
...
class TopologyResource(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'id': {'key': 'id', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'associations': {'key': 'associations', 'type': '[TopologyAssociation]'}}

    def __init__(self, *, name: Optional[str]=None, id: Optional[str]=None, location: Optional[str]=None, associations: Optional[List['_models.TopologyAssociation']]=None, **kwargs):
        """
...
class TrafficAnalyticsConfigurationProperties(msrest.serialization.Model):
    ...
    """
    _validation = {'enabled': {'required': True}, 'workspace_id': {'required': True}, 'workspace_region': {'required': True}, 'workspace_resource_id': {'required': True}}
    _attribute_map = {'enabled': {'key': 'enabled', 'type': 'bool'}, 'workspace_id': {'key': 'workspaceId', 'type': 'str'}, 'workspace_region': {'key': 'workspaceRegion', 'type': 'str'}, 'workspace_resource_id': {'key': 'workspaceResourceId', 'type': 'str'}}

    def __init__(self, *, enabled: bool, workspace_id: str, workspace_region: str, workspace_resource_id: str, **kwargs):
        """
...
class TrafficAnalyticsProperties(msrest.serialization.Model):
    ...
    """
    _validation = {'network_watcher_flow_analytics_configuration': {'required': True}}
    _attribute_map = {'network_watcher_flow_analytics_configuration': {'key': 'networkWatcherFlowAnalyticsConfiguration', 'type': 'TrafficAnalyticsConfigurationProperties'}}

    def __init__(self, *, network_watcher_flow_analytics_configuration: '_models.TrafficAnalyticsConfigurationProperties', **kwargs):
        """
...
class TroubleshootingDetails(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'reason_type': {'key': 'reasonType', 'type': 'str'}, 'summary': {'key': 'summary', 'type': 'str'}, 'detail': {'key': 'detail', 'type': 'str'}, 'recommended_actions': {'key': 'recommendedActions', 'type': '[TroubleshootingRecommendedActions]'}}

    def __init__(self, *, id: Optional[str]=None, reason_type: Optional[str]=None, summary: Optional[str]=None, detail: Optional[str]=None, recommended_actions: Optional[List['_models.TroubleshootingRecommendedActions']]=None, **kwargs):
        """
...
class TroubleshootingParameters(msrest.serialization.Model):
    ...
    :vartype storage_path: str
    """
    _validation = {'target_resource_id': {'required': True}, 'storage_id': {'required': True}, 'storage_path': {'required': True}}
    _attribute_map = {'target_resource_id': {'key': 'targetResourceId', 'type': 'str'}, 'storage_id': {'key': 'properties.storageId', 'type': 'str'}, 'storage_path': {'key': 'properties.storagePath', 'type': 'str'}}
...
class TroubleshootingRecommendedActions(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'action_id': {'key': 'actionId', 'type': 'str'}, 'action_text': {'key': 'actionText', 'type': 'str'}, 'action_uri': {'key': 'actionUri', 'type': 'str'}, 'action_uri_text': {'key': 'actionUriText', 'type': 'str'}}

    def __init__(self, *, action_id: Optional[str]=None, action_text: Optional[str]=None, action_uri: Optional[str]=None, action_uri_text: Optional[str]=None, **kwargs):
        """
...
class TroubleshootingResult(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'start_time': {'key': 'startTime', 'type': 'iso-8601'}, 'end_time': {'key': 'endTime', 'type': 'iso-8601'}, 'code': {'key': 'code', 'type': 'str'}, 'results': {'key': 'results', 'type': '[TroubleshootingDetails]'}}

    def __init__(self, *, start_time: Optional[datetime.datetime]=None, end_time: Optional[datetime.datetime]=None, code: Optional[str]=None, results: Optional[List['_models.TroubleshootingDetails']]=None, **kwargs):
        """
...
class TunnelConnectionHealth(msrest.serialization.Model):
    ...
    """
    _validation = {'tunnel': {'readonly': True}, 'connection_status': {'readonly': True}, 'ingress_bytes_transferred': {'readonly': True}, 'egress_bytes_transferred': {'readonly': True}, 'last_connection_established_utc_time': {'readonly': True}}
    _attribute_map = {'tunnel': {'key': 'tunnel', 'type': 'str'}, 'connection_status': {'key': 'connectionStatus', 'type': 'str'}, 'ingress_bytes_transferred': {'key': 'ingressBytesTransferred', 'type': 'long'}, 'egress_bytes_transferred': {'key': 'egressBytesTransferred', 'type': 'long'}, 'last_connection_established_utc_time': {'key': 'lastConnectionEstablishedUtcTime', 'type': 'str'}}
...
class Usage(msrest.serialization.Model):
    ...
    """
    _validation = {'id': {'readonly': True}, 'unit': {'required': True}, 'current_value': {'required': True}, 'limit': {'required': True}, 'name': {'required': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'unit': {'key': 'unit', 'type': 'str'}, 'current_value': {'key': 'currentValue', 'type': 'long'}, 'limit': {'key': 'limit', 'type': 'long'}, 'name': {'key': 'name', 'type': 'UsageName'}}

    def __init__(self, *, unit: Union[str, '_models.UsageUnit'], current_value: int, limit: int, name: '_models.UsageName', **kwargs):
        """
...
class UsagesListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[Usage]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class VerificationIPFlowParameters(msrest.serialization.Model):
    ...
    :vartype target_nic_resource_id: str
    """
    _validation = {'target_resource_id': {'required': True}, 'direction': {'required': True}, 'protocol': {'required': True}, 'local_port': {'required': True}, 'remote_port': {'required': True}, 'local_ip_address': {'required': True}, 'remote_ip_address': {'required': True}}
    _attribute_map = {'target_resource_id': {'key': 'targetResourceId', 'type': 'str'}, 'direction': {'key': 'direction', 'type': 'str'}, 'protocol': {'key': 'protocol', 'type': 'str'}, 'local_port': {'key': 'localPort', 'type': 'str'}, 'remote_port': {'key': 'remotePort', 'type': 'str'}, 'local_ip_address': {'key': 'localIPAddress', 'type': 'str'}, 'remote_ip_address': {'key': 'remoteIPAddress', 'type': 'str'}, 'target_nic_resource_id': {'key': 'targetNicResourceId', 'type': 'str'}}

    def __init__(self, *, target_resource_id: str, direction: Union[str, '_models.Direction'], protocol: Union[str, '_models.IpFlowProtocol'], local_port: str, remote_port: str, local_ip_address: str, remote_ip_address: str, target_nic_resource_id: Optional[str]=None, **kwargs):
        """
...
class VerificationIPFlowResult(msrest.serialization.Model):
    ...
    :vartype rule_name: str
    """
    _attribute_map = {'access': {'key': 'access', 'type': 'str'}, 'rule_name': {'key': 'ruleName', 'type': 'str'}}

    def __init__(self, *, access: Optional[Union[str, '_models.Access']]=None, rule_name: Optional[str]=None, **kwargs):
        """
...
class VirtualHub(Resource):
    ...
    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, virtual_wan: Optional['_models.SubResource']=None, vpn_gateway: Optional['_models.SubResource']=None, p2_s_vpn_gateway: Optional['_models.SubResource']=None, express_route_gateway: Optional['_models.SubResource']=None, virtual_network_connections: Optional[List['_models.HubVirtualNetworkConnection']]=None, address_prefix: Optional[str]=None, route_table: Optional['_models.VirtualHubRouteTable']=None, provisioning_state: Optional[Union[str, '_models.ProvisioningState']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class VirtualHubRoute(msrest.serialization.Model):
    ...
    :vartype next_hop_ip_address: str
    """
    _attribute_map = {'address_prefixes': {'key': 'addressPrefixes', 'type': '[str]'}, 'next_hop_ip_address': {'key': 'nextHopIpAddress', 'type': 'str'}}

    def __init__(self, *, address_prefixes: Optional[List[str]]=None, next_hop_ip_address: Optional[str]=None, **kwargs):
        """
...
class VirtualHubRouteTable(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'routes': {'key': 'routes', 'type': '[VirtualHubRoute]'}}
...
class VirtualNetwork(Resource):
    ...
    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, etag: Optional[str]=None, address_space: Optional['_models.AddressSpace']=None, dhcp_options: Optional['_models.DhcpOptions']=None, subnets: Optional[List['_models.Subnet']]=None, virtual_network_peerings: Optional[List['_models.VirtualNetworkPeering']]=None, resource_guid: Optional[str]=None, provisioning_state: Optional[str]=None, enable_ddos_protection: Optional[bool]=False, enable_vm_protection: Optional[bool]=False, ddos_protection_plan: Optional['_models.SubResource']=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class VirtualNetworkGateway(Resource):
    ...
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'etag': {'key': 'etag', 'type': 'str'}, 'ip_configurations': {'key': 'properties.ipConfigurations', 'type': '[VirtualNetworkGatewayIPConfiguration]'}, 'gateway_type': {'key': 'properties.gatewayType', 'type': 'str'}, 'vpn_type': {'key': 'properties.vpnType', 'type': 'str'}, 'enable_bgp': {'key': 'properties.enableBgp', 'type': 'bool'}, 'active': {'key': 'properties.activeActive', 'type': 'bool'}, 'gateway_default_site': {'key': 'properties.gatewayDefaultSite', 'type': 'SubResource'}, 'sku': {'key': 'properties.sku', 'type': 'VirtualNetworkGatewaySku'}, 'vpn_client_configuration': {'key': 'properties.vpnClientConfiguration', 'type': 'VpnClientConfiguration'}, 'bgp_settings': {'key': 'properties.bgpSettings', 'type': 'BgpSettings'}, 'resource_guid': {'key': 'properties.resourceGuid', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, etag: Optional[str]=None, ip_configurations: Optional[List['_models.VirtualNetworkGatewayIPConfiguration']]=None, gateway_type: Optional[Union[str, '_models.VirtualNetworkGatewayType']]=None, vpn_type: Optional[Union[str, '_models.VpnType']]=None, enable_bgp: Optional[bool]=None, active: Optional[bool]=None, gateway_default_site: Optional['_models.SubResource']=None, sku: Optional['_models.VirtualNetworkGatewaySku']=None, vpn_client_configuration: Optional['_models.VpnClientConfiguration']=None, bgp_settings: Optional['_models.BgpSettings']=None, resource_guid: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class VirtualNetworkGatewayConnectionListEntity(Resource):
    ...
    def __init__(self, *, virtual_network_gateway1: '_models.VirtualNetworkConnectionGatewayReference', connection_type: Union[str, '_models.VirtualNetworkGatewayConnectionType'], id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, etag: Optional[str]=None, authorization_key: Optional[str]=None, virtual_network_gateway2: Optional['_models.VirtualNetworkConnectionGatewayReference']=None, local_network_gateway2: Optional['_models.VirtualNetworkConnectionGatewayReference']=None, connection_protocol: Optional[Union[str, '_models.VirtualNetworkGatewayConnectionProtocol']]=None, routing_weight: Optional[int]=None, shared_key: Optional[str]=None, peer: Optional['_models.SubResource']=None, enable_bgp: Optional[bool]=None, use_policy_based_traffic_selectors: Optional[bool]=None, ipsec_policies: Optional[List['_models.IpsecPolicy']]=None, resource_guid: Optional[str]=None, express_route_gateway_bypass: Optional[bool]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class VirtualNetworkGatewayConnectionListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[VirtualNetworkGatewayConnection]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class VirtualNetworkGatewayIPConfiguration(SubResource):
    ...
    """
    _validation = {'provisioning_state': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'private_ip_allocation_method': {'key': 'properties.privateIPAllocationMethod', 'type': 'str'}, 'subnet': {'key': 'properties.subnet', 'type': 'SubResource'}, 'public_ip_address': {'key': 'properties.publicIPAddress', 'type': 'SubResource'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, private_ip_allocation_method: Optional[Union[str, '_models.IPAllocationMethod']]=None, subnet: Optional['_models.SubResource']=None, public_ip_address: Optional['_models.SubResource']=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: The name of the resource that is unique within a resource group. This name can
...
class VirtualNetworkGatewayListConnectionsResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[VirtualNetworkGatewayConnectionListEntity]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class VirtualNetworkGatewayListResult(msrest.serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[VirtualNetworkGateway]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class VirtualNetworkGatewaySku(msrest.serialization.Model):
    ...
    def __init__(self, *, name: Optional[Union[str, '_models.VirtualNetworkGatewaySkuName']]=None, tier: Optional[Union[str, '_models.VirtualNetworkGatewaySkuTier']]=None, capacity: Optional[int]=None, **kwargs):
        """
...
class VirtualNetworkListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[VirtualNetwork]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.VirtualNetwork']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class VirtualNetworkListUsageResult(msrest.serialization.Model):
    ...
    _attribute_map = {'value': {'key': 'value', 'type': '[VirtualNetworkUsage]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class VirtualNetworkPeering(SubResource):
    ...
    :vartype provisioning_state: str
    """
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'allow_virtual_network_access': {'key': 'properties.allowVirtualNetworkAccess', 'type': 'bool'}, 'allow_forwarded_traffic': {'key': 'properties.allowForwardedTraffic', 'type': 'bool'}, 'allow_gateway_transit': {'key': 'properties.allowGatewayTransit', 'type': 'bool'}, 'use_remote_gateways': {'key': 'properties.useRemoteGateways', 'type': 'bool'}, 'remote_virtual_network': {'key': 'properties.remoteVirtualNetwork', 'type': 'SubResource'}, 'remote_address_space': {'key': 'properties.remoteAddressSpace', 'type': 'AddressSpace'}, 'peering_state': {'key': 'properties.peeringState', 'type': 'str'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, etag: Optional[str]=None, allow_virtual_network_access: Optional[bool]=None, allow_forwarded_traffic: Optional[bool]=None, allow_gateway_transit: Optional[bool]=None, use_remote_gateways: Optional[bool]=None, remote_virtual_network: Optional['_models.SubResource']=None, remote_address_space: Optional['_models.AddressSpace']=None, peering_state: Optional[Union[str, '_models.VirtualNetworkPeeringState']]=None, provisioning_state: Optional[str]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: The name of the resource that is unique within a resource group. This name can
...
class VirtualNetworkPeeringListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[VirtualNetworkPeering]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.VirtualNetworkPeering']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class VirtualNetworkTap(Resource):
    ...
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'network_interface_tap_configurations': {'readonly': True}, 'resource_guid': {'readonly': True}, 'provisioning_state': {'readonly': True}}
    ...
    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, etag: Optional[str]=None, destination_network_interface_ip_configuration: Optional['_models.NetworkInterfaceIPConfiguration']=None, destination_load_balancer_front_end_ip_configuration: Optional['_models.FrontendIPConfiguration']=None, destination_port: Optional[int]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class VirtualNetworkTapListResult(msrest.serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[VirtualNetworkTap]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}

    def __init__(self, *, value: Optional[List['_models.VirtualNetworkTap']]=None, next_link: Optional[str]=None, **kwargs):
        """
...
class VirtualNetworkUsage(msrest.serialization.Model):
    ...
    :vartype unit: str
    """
    _validation = {'current_value': {'readonly': True}, 'id': {'readonly': True}, 'limit': {'readonly': True}, 'name': {'readonly': True}, 'unit': {'readonly': True}}
    _attribute_map = {'current_value': {'key': 'currentValue', 'type': 'float'}, 'id': {'key': 'id', 'type': 'str'}, 'limit': {'key': 'limit', 'type': 'float'}, 'name': {'key': 'name', 'type': 'VirtualNetworkUsageName'}, 'unit': {'key': 'unit', 'type': 'str'}}
...
class VirtualNetworkUsageName(msrest.serialization.Model):
    ...
    :vartype value: str
    """
    _validation = {'localized_value': {'readonly': True}, 'value': {'readonly': True}}
    _attribute_map = {'localized_value': {'key': 'localizedValue', 'type': 'str'}, 'value': {'key': 'value', 'type': 'str'}}
...
class VirtualWAN(Resource):
    ...
    :vartype provisioning_state: str or ~azure.mgmt.network.v2018_08_01.models.ProvisioningState
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'etag': {'readonly': True}, 'virtual_hubs': {'readonly': True}, 'vpn_sites': {'readonly': True}, 'office365_local_breakout_category': {'readonly': True}}
    ...
    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, disable_vpn_encryption: Optional[bool]=None, security_provider_name: Optional[str]=None, allow_branch_to_branch_traffic: Optional[bool]=None, allow_vnet_to_vnet_traffic: Optional[bool]=None, p2_s_vpn_server_configurations: Optional[List['_models.P2SVpnServerConfiguration']]=None, provisioning_state: Optional[Union[str, '_models.ProvisioningState']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class VirtualWanSecurityProvider(msrest.serialization.Model):
    ...
    """
    _validation = {'type': {'readonly': True}}
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'url': {'key': 'url', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}}
...
class VirtualWanSecurityProviders(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'supported_providers': {'key': 'supportedProviders', 'type': '[VirtualWanSecurityProvider]'}}
...
class VpnClientConnectionHealth(msrest.serialization.Model):
    ...
    """
    _validation = {'total_ingress_bytes_transferred': {'readonly': True}, 'total_egress_bytes_transferred': {'readonly': True}}
    _attribute_map = {'total_ingress_bytes_transferred': {'key': 'totalIngressBytesTransferred', 'type': 'long'}, 'total_egress_bytes_transferred': {'key': 'totalEgressBytesTransferred', 'type': 'long'}, 'vpn_client_connections_count': {'key': 'vpnClientConnectionsCount', 'type': 'int'}, 'allocated_ip_addresses': {'key': 'allocatedIpAddresses', 'type': '[str]'}}

    def __init__(self, *, vpn_client_connections_count: Optional[int]=None, allocated_ip_addresses: Optional[List[str]]=None, **kwargs):
        """
...
class VpnClientParameters(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'processor_architecture': {'key': 'processorArchitecture', 'type': 'str'}, 'authentication_method': {'key': 'authenticationMethod', 'type': 'str'}, 'radius_server_auth_certificate': {'key': 'radiusServerAuthCertificate', 'type': 'str'}, 'client_root_certificates': {'key': 'clientRootCertificates', 'type': '[str]'}}

    def __init__(self, *, processor_architecture: Optional[Union[str, '_models.ProcessorArchitecture']]=None, authentication_method: Optional[Union[str, '_models.AuthenticationMethod']]=None, radius_server_auth_certificate: Optional[str]=None, client_root_certificates: Optional[List[str]]=None, **kwargs):
        """
...
class VpnConnection(SubResource):
    ...
    :vartype provisioning_state: str or ~azure.mgmt.network.v2018_08_01.models.ProvisioningState
    """
    _validation = {'etag': {'readonly': True}, 'connection_status': {'readonly': True}, 'ingress_bytes_transferred': {'readonly': True}, 'egress_bytes_transferred': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'etag': {'key': 'etag', 'type': 'str'}, 'remote_vpn_site': {'key': 'properties.remoteVpnSite', 'type': 'SubResource'}, 'routing_weight': {'key': 'properties.routingWeight', 'type': 'int'}, 'connection_status': {'key': 'properties.connectionStatus', 'type': 'str'}, 'vpn_connection_protocol_type': {'key': 'properties.vpnConnectionProtocolType', 'type': 'str'}, 'ingress_bytes_transferred': {'key': 'properties.ingressBytesTransferred', 'type': 'long'}, 'egress_bytes_transferred': {'key': 'properties.egressBytesTransferred', 'type': 'long'}, 'connection_bandwidth': {'key': 'properties.connectionBandwidth', 'type': 'int'}, 'shared_key': {'key': 'properties.sharedKey', 'type': 'str'}, 'enable_bgp': {'key': 'properties.enableBgp', 'type': 'bool'}, 'ipsec_policies': {'key': 'properties.ipsecPolicies', 'type': '[IpsecPolicy]'}, 'enable_rate_limiting': {'key': 'properties.enableRateLimiting', 'type': 'bool'}, 'enable_internet_security': {'key': 'properties.enableInternetSecurity', 'type': 'bool'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}}

    def __init__(self, *, id: Optional[str]=None, name: Optional[str]=None, remote_vpn_site: Optional['_models.SubResource']=None, routing_weight: Optional[int]=None, vpn_connection_protocol_type: Optional[Union[str, '_models.VirtualNetworkGatewayConnectionProtocol']]=None, connection_bandwidth: Optional[int]=None, shared_key: Optional[str]=None, enable_bgp: Optional[bool]=None, ipsec_policies: Optional[List['_models.IpsecPolicy']]=None, enable_rate_limiting: Optional[bool]=None, enable_internet_security: Optional[bool]=None, provisioning_state: Optional[Union[str, '_models.ProvisioningState']]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword name: The name of the resource that is unique within a resource group. This name can
...
class VpnDeviceScriptParameters(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'vendor': {'key': 'vendor', 'type': 'str'}, 'device_family': {'key': 'deviceFamily', 'type': 'str'}, 'firmware_version': {'key': 'firmwareVersion', 'type': 'str'}}

    def __init__(self, *, vendor: Optional[str]=None, device_family: Optional[str]=None, firmware_version: Optional[str]=None, **kwargs):
        """
...
class VpnGateway(Resource):
    ...
    """
    _validation = {'name': {'readonly': True}, 'type': {'readonly': True}, 'etag': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'etag': {'key': 'etag', 'type': 'str'}, 'virtual_hub': {'key': 'properties.virtualHub', 'type': 'SubResource'}, 'connections': {'key': 'properties.connections', 'type': '[VpnConnection]'}, 'bgp_settings': {'key': 'properties.bgpSettings', 'type': 'BgpSettings'}, 'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'}, 'vpn_gateway_scale_unit': {'key': 'properties.vpnGatewayScaleUnit', 'type': 'int'}}

    def __init__(self, *, id: Optional[str]=None, location: Optional[str]=None, tags: Optional[Dict[str, str]]=None, virtual_hub: Optional['_models.SubResource']=None, connections: Optional[List['_models.VpnConnection']]=None, bgp_settings: Optional['_models.BgpSettings']=None, provisioning_state: Optional[Union[str, '_models.ProvisioningState']]=None, vpn_gateway_scale_unit: Optional[int]=None, **kwargs):
        """
        :keyword id: Resource ID.
        :paramtype id: str
        :keyword location: Resource location.
...
class VpnProfileResponse(msrest.serialization.Model):
    ...
    """
    _attribute_map = {'profile_url': {'key': 'profileUrl', 'type': 'str'}}
...
class VpnSiteId(msrest.serialization.Model):
    ...
    """
    _validation = {'vpn_site': {'readonly': True}}
    _attribute_map = {'vpn_site': {'key': 'vpnSite', 'type': 'str'}}
