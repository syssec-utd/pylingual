...
import re
import sys
from testit_api_client.model_utils import ApiTypeError, ModelComposed, ModelNormal, ModelSimple, cached_property, change_keys_js_to_python, convert_js_args_to_python_args, date, datetime, file_type, none_type, validate_get_composed_info, OpenApiModel
...
class LinkModel(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        lazy_import()
        return {'url': (str,), 'id': (str,), 'title': (str, none_type), 'description': (str, none_type), 'type': (LinkType,), 'has_info': (bool,)}

    @cached_property
    def discriminator():
        return None
    attribute_map = {'url': 'url', 'id': 'id', 'title': 'title', 'description': 'description', 'type': 'type', 'has_info': 'hasInfo'}
    read_only_vars = {}
    _composed_schemas = {}
