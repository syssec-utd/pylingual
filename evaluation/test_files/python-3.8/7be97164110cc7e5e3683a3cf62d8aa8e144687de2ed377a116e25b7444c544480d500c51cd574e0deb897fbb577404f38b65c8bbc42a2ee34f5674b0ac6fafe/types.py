...
dtype_str_map = {'string': DataType.VARCHAR, 'floating': DataType.FLOAT, 'integer': DataType.INT64, 'mixed-integer': DataType.INT64, 'mixed-integer-float': DataType.FLOAT, 'boolean': DataType.BOOL, 'mixed': DataType.UNKNOWN, 'bytes': DataType.UNKNOWN}
numpy_dtype_str_map = {'bool_': DataType.BOOL, 'bool': DataType.BOOL, 'int': DataType.INT64, 'int_': DataType.INT64, 'intc': DataType.INT64, 'intp': DataType.INT64, 'int8': DataType.INT8, 'int16': DataType.INT16, 'int32': DataType.INT32, 'int64': DataType.INT64, 'uint8': DataType.INT8, 'uint16': DataType.INT16, 'uint32': DataType.INT32, 'uint64': DataType.INT64, 'float': DataType.FLOAT, 'float_': DataType.FLOAT, 'float16': DataType.FLOAT, 'float32': DataType.FLOAT, 'float64': DataType.DOUBLE, 'string': DataType.VARCHAR, 'str': DataType.VARCHAR}
