...
class CookieTest(WebTestCase):
    ...
    def get_handlers(self):
        ...
        return [('/set', SetCookieHandler), ('/get', GetCookieHandler), ('/set_domain', SetCookieDomainHandler), ('/special_char', SetCookieSpecialCharHandler), ('/set_overwrite', SetCookieOverwriteHandler), ('/set_max_age', SetCookieMaxAgeHandler), ('/set_expires_days', SetCookieExpiresDaysHandler), ('/set_falsy_flags', SetCookieFalsyFlags)]
...
class RequestEncodingTest(WebTestCase):
    ...
    def test_group_encoding(self):
        self.assertEqual(self.fetch_json('/group/%C3%A9?arg=%C3%A9'), {u'path': u'/group/%C3%A9', u'path_args': [u'é'], u'args': {u'arg': [u'é']}})
...
class WSGISafeWebTest(WebTestCase):
    ...
    def test_decode_argument(self):
        ...
        for req_url in urls:
            ...
            response.rethrow()
            data = json_decode(response.body)
            self.assertEqual(data, {u'path': [u'unicode', u'é'], u'query': [u'unicode', u'é']})
        response = self.fetch('/decode_arg/%C3%A9?foo=%C3%A9')
        response.rethrow()
        data = json_decode(response.body)
        self.assertEqual(data, {u'path': [u'bytes', u'c3a9'], u'query': [u'bytes', u'c3a9']})
    ...
    def test_decode_argument_plus(self):
        ...
        for req_url in urls:
            ...
            response.rethrow()
            data = json_decode(response.body)
            self.assertEqual(data, {u'path': [u'unicode', u'1 + 1'], u'query': [u'unicode', u'1 + 1']})
    ...
    def test_reverse_url(self):
        ...
        self.assertEqual(self.app.reverse_url('decode_arg', u'é'), '/decode_arg/%C3%A9')
...
class NamedURLSpecGroupsTest(WebTestCase):
    ...
    def get_handlers(self):
        ...
        class EchoHandler(RequestHandler):
            ...
            def get(self, path):
                self.write(path)
        return [('/str/(?P<path>.*)', EchoHandler), (u'/unicode/(?P<path>.*)', EchoHandler)]
