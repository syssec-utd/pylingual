...
class TimeDistributed(ZooKerasLayer):
    ...
    def __init__(self, layer, input_shape=None, **kwargs):
        super(TimeDistributed, self).__init__(None, layer, list(input_shape) if input_shape else None, **kwargs)
...
class Bidirectional(ZooKerasLayer):
    ...
    def __init__(self, layer, merge_mode='concat', input_shape=None, **kwargs):
        super(Bidirectional, self).__init__(None, layer, merge_mode, list(input_shape) if input_shape else None, **kwargs)
...
class KerasLayerWrapper(ZooKerasLayer):
    ...
    def __init__(self, torch_layer, input_shape=None, **kwargs):
        super(KerasLayerWrapper, self).__init__(None, torch_layer, list(input_shape) if input_shape else None, **kwargs)