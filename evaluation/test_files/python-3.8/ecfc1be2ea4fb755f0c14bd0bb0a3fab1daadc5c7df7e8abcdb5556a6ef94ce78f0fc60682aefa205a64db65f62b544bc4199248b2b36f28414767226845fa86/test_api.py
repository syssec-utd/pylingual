...
class TestNiosApi(unittest.TestCase):
    ...
    def test_get_provider_spec(self):
        provider_options = ['host', 'username', 'password', 'cert', 'key', 'validate_certs', 'silent_ssl_warnings', 'http_request_timeout', 'http_pool_connections', 'http_pool_maxsize', 'max_retries', 'wapi_version', 'max_results']
    ...
    def test_wapi_no_change(self):
        self.module.params = {'provider': None, 'state': 'present', 'name': 'default', 'comment': 'test comment', 'extattrs': None}
        test_object = [{'comment': 'test comment', '_ref': 'networkview/ZG5zLm5ldHdvcmtfdmlldyQw:default/true', 'name': 'default', 'extattrs': {}}]
    ...
    def test_wapi_change(self):
        self.module.params = {'provider': None, 'state': 'present', 'name': 'default', 'comment': 'updated comment', 'extattrs': None}
        test_object = [{'comment': 'test comment', '_ref': 'networkview/ZG5zLm5ldHdvcmtfdmlldyQw:default/true', 'name': 'default', 'extattrs': {}}]
        test_spec = {'name': {'ib_req': True}, 'comment': {}, 'extattrs': {}}
        wapi = self._get_wapi(test_object)
        res = wapi.run('testobject', test_spec)
    ...
    def test_wapi_change_false(self):
        self.module.params = {'provider': None, 'state': 'present', 'name': 'default', 'comment': 'updated comment', 'extattrs': None, 'fqdn': 'foo'}
        test_object = [{'comment': 'test comment', '_ref': 'networkview/ZG5zLm5ldHdvcmtfdmlldyQw:default/true', 'name': 'default', 'extattrs': {}}]
        test_spec = {'name': {'ib_req': True}, 'fqdn': {'ib_req': True, 'update': False}, 'comment': {}, 'extattrs': {}}
        wapi = self._get_wapi(test_object)
        res = wapi.run('testobject', test_spec)
        self.assertTrue(res['changed'])
        wapi.update_object.called_once_with(test_object)
    ...
    def test_wapi_extattrs_change(self):
        self.module.params = {'provider': None, 'state': 'present', 'name': 'default', 'comment': 'test comment', 'extattrs': {'Site': 'update'}}
        ref = 'networkview/ZG5zLm5ldHdvcmtfdmlldyQw:default/true'
        test_object = [{'comment': 'test comment', '_ref': ref, 'name': 'default', 'extattrs': {'Site': {'value': 'test'}}}]
        test_spec = {'name': {'ib_req': True}, 'comment': {}, 'extattrs': {}}
    ...
    def test_wapi_extattrs_nochange(self):
        self.module.params = {'provider': None, 'state': 'present', 'name': 'default', 'comment': 'test comment', 'extattrs': {'Site': 'test'}}
        test_object = [{'comment': 'test comment', '_ref': 'networkview/ZG5zLm5ldHdvcmtfdmlldyQw:default/true', 'name': 'default', 'extattrs': {'Site': {'value': 'test'}}}]
        test_spec = {'name': {'ib_req': True}, 'comment': {}, 'extattrs': {}}
        wapi = self._get_wapi(test_object)
        res = wapi.run('testobject', test_spec)
        self.assertFalse(res['changed'])
    ...
    def test_wapi_create(self):
        self.module.params = {'provider': None, 'state': 'present', 'name': 'ansible', 'comment': None, 'extattrs': None}
        test_object = None
        test_spec = {'name': {'ib_req': True}, 'comment': {}, 'extattrs': {}}
        wapi = self._get_wapi(test_object)
        res = wapi.run('testobject', test_spec)
    ...
    def test_wapi_delete(self):
        self.module.params = {'provider': None, 'state': 'absent', 'name': 'ansible', 'comment': None, 'extattrs': None}
        ref = 'networkview/ZG5zLm5ldHdvcmtfdmlldyQw:ansible/false'
        test_object = [{'comment': 'test comment', '_ref': ref, 'name': 'ansible', 'extattrs': {'Site': {'value': 'test'}}}]
        test_spec = {'name': {'ib_req': True}, 'comment': {}, 'extattrs': {}}
        wapi = self._get_wapi(test_object)
        res = wapi.run('testobject', test_spec)
        self.assertTrue(res['changed'])
    ...
    def test_wapi_strip_network_view(self):
        self.module.params = {'provider': None, 'state': 'present', 'name': 'ansible', 'comment': 'updated comment', 'extattrs': None, 'network_view': 'default'}
        ...
        test_spec = {'name': {'ib_req': True}, 'network_view': {'ib_req': True}, 'comment': {}, 'extattrs': {}}
