...
class FxForwardTenorCurveDataAllOf(object):
    ...
    openapi_types = {'base_date': 'datetime', 'dom_ccy': 'str', 'fgn_ccy': 'str', 'tenors': 'list[str]', 'rates': 'list[float]', 'lineage': 'str', 'market_data_type': 'str'}
    attribute_map = {'base_date': 'baseDate', 'dom_ccy': 'domCcy', 'fgn_ccy': 'fgnCcy', 'tenors': 'tenors', 'rates': 'rates', 'lineage': 'lineage', 'market_data_type': 'marketDataType'}
    required_map = {'base_date': 'required', 'dom_ccy': 'required', 'fgn_ccy': 'required', 'tenors': 'required', 'rates': 'required', 'lineage': 'optional', 'market_data_type': 'required'}

    def __init__(self, base_date=None, dom_ccy=None, fgn_ccy=None, tenors=None, rates=None, lineage=None, market_data_type=None, local_vars_configuration=None):
    ...
    def base_date(self, base_date):
        ...
        :type base_date: datetime
        """
        if self.local_vars_configuration.client_side_validation and base_date is None:
    ...
    def fgn_ccy(self, fgn_ccy):
        ...
        :type fgn_ccy: str
        """
        if self.local_vars_configuration.client_side_validation and fgn_ccy is None:
            raise ValueError('Invalid value for `fgn_ccy`, must not be `None`')
    ...
    def tenors(self, tenors):
        ...
        :type tenors: list[str]
        """
        if self.local_vars_configuration.client_side_validation and tenors is None:
            raise ValueError('Invalid value for `tenors`, must not be `None`')
        self._tenors = tenors
    ...
    def rates(self, rates):
        ...
        :type rates: list[float]
        """
        if self.local_vars_configuration.client_side_validation and rates is None:
    ...
    def lineage(self, lineage):
        ...
        :type lineage: str
        """
        if self.local_vars_configuration.client_side_validation and lineage is not None and (len(lineage) > 1024):
            raise ValueError('Invalid value for `lineage`, length must be less than or equal to `1024`')
        if self.local_vars_configuration.client_side_validation and lineage is not None and (len(lineage) < 0):
            raise ValueError('Invalid value for `lineage`, length must be greater than or equal to `0`')
    ...
    def market_data_type(self, market_data_type):
        ...
        :type market_data_type: str
        """
        if self.local_vars_configuration.client_side_validation and market_data_type is None:
            raise ValueError('Invalid value for `market_data_type`, must not be `None`')
        allowed_values = ['DiscountFactorCurveData', 'EquityVolSurfaceData', 'FxVolSurfaceData', 'IrVolCubeData', 'OpaqueMarketData', 'YieldCurveData', 'FxForwardCurveData', 'FxForwardPipsCurveData', 'FxForwardTenorCurveData', 'FxForwardTenorPipsCurveData', 'FxForwardCurveByQuoteReference', 'CreditSpreadCurveData']
        if self.local_vars_configuration.client_side_validation and market_data_type not in allowed_values:
            raise ValueError('Invalid value for `market_data_type` ({0}), must be one of {1}'.format(market_data_type, allowed_values))
