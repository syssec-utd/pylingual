...
def fbx(override_context: typing.Union[typing.Dict, 'bpy.types.Context']=None, execution_context: typing.Union[str, int]=None, undo: bool=None, *, filepath: str='', check_existing: bool=True, filter_glob: str='*.fbx', use_selection: bool=False, use_visible: bool=False, use_active_collection: bool=False, global_scale: float=1.0, apply_unit_scale: bool=True, apply_scale_options: typing.Union[str, int]='FBX_SCALE_NONE', use_space_transform: bool=True, bake_space_transform: bool=False, object_types: typing.Union[typing.Set[str], typing.Set[int]]={'ARMATURE', 'CAMERA', 'EMPTY', 'LIGHT', 'MESH', 'OTHER'}, use_mesh_modifiers: bool=True, use_mesh_modifiers_render: bool=True, mesh_smooth_type: typing.Union[str, int]='OFF', colors_type: typing.Union[str, int]='SRGB', use_subsurf: bool=False, use_mesh_edges: bool=False, use_tspace: bool=False, use_triangles: bool=False, use_custom_props: bool=False, add_leaf_bones: bool=True, primary_bone_axis: typing.Union[str, int]='Y', secondary_bone_axis: typing.Union[str, int]='X', use_armature_deform_only: bool=False, armature_nodetype: typing.Union[str, int]='NULL', bake_anim: bool=True, bake_anim_use_all_bones: bool=True, bake_anim_use_nla_strips: bool=True, bake_anim_use_all_actions: bool=True, bake_anim_force_startend_keying: bool=True, bake_anim_step: float=1.0, bake_anim_simplify_factor: float=1.0, path_mode: typing.Union[str, int]='AUTO', embed_textures: bool=False, batch_mode: typing.Union[str, int]='OFF', use_batch_own_dir: bool=True, use_metadata: bool=True, axis_forward: typing.Union[str, int]='-Z', axis_up: typing.Union[str, int]='Y'):
    """ Write a FBX file
...
def obj(override_context: typing.Union[typing.Dict, 'bpy.types.Context']=None, execution_context: typing.Union[str, int]=None, undo: bool=None, *, filepath: str='', check_existing: bool=True, filter_glob: str='*.obj;*.mtl', use_selection: bool=False, use_animation: bool=False, use_mesh_modifiers: bool=True, use_edges: bool=True, use_smooth_groups: bool=False, use_smooth_groups_bitflags: bool=False, use_normals: bool=True, use_uvs: bool=True, use_materials: bool=True, use_triangles: bool=False, use_nurbs: bool=False, use_vertex_groups: bool=False, use_blen_objects: bool=True, group_by_object: bool=False, group_by_material: bool=False, keep_vertex_order: bool=False, global_scale: float=1.0, path_mode: typing.Union[str, int]='AUTO', axis_forward: typing.Union[str, int]='-Z', axis_up: typing.Union[str, int]='Y'):
