...
def macro_australia_retail_rate_monthly() -> pd.DataFrame:
    ...
    params = {'reportName': 'RPT_ECONOMICVALUE_AUSTRALIA', 'columns': 'ALL', 'filter': '(INDICATOR_ID="EMG00152903")', 'pageNumber': '1', 'pageSize': '2000', 'sortColumns': 'REPORT_DATE', 'sortTypes': '-1', 'source': 'WEB', 'client': 'WEB', 'p': '1', 'pageNo': '1', 'pageNum': '1', '_': '1669047266881'}
    r = requests.get(url, params=params)
    data_json = r.json()
    temp_df = pd.DataFrame(data_json['result']['data'])
    temp_df.columns = ['-', '-', '-', '时间', '-', '发布日期', '现值', '前值']
    temp_df = temp_df[['时间', '前值', '现值', '发布日期']]
...
def macro_australia_trade() -> pd.DataFrame:
    ...
    """
    url = 'https://datacenter-web.eastmoney.com/api/data/v1/get'
    params = {'reportName': 'RPT_ECONOMICVALUE_AUSTRALIA', 'columns': 'ALL', 'filter': '(INDICATOR_ID="EMG00152793")', 'pageNumber': '1', 'pageSize': '2000', 'sortColumns': 'REPORT_DATE', 'sortTypes': '-1', 'source': 'WEB', 'client': 'WEB', 'p': '1', 'pageNo': '1', 'pageNum': '1', '_': '1669047266881'}
    r = requests.get(url, params=params)
    data_json = r.json()
    temp_df = pd.DataFrame(data_json['result']['data'])
    temp_df.columns = ['-', '-', '-', '时间', '-', '发布日期', '现值', '前值']
...
def macro_australia_unemployment_rate() -> pd.DataFrame:
    ...
    """
    url = 'https://datacenter-web.eastmoney.com/api/data/v1/get'
    params = {'reportName': 'RPT_ECONOMICVALUE_AUSTRALIA', 'columns': 'ALL', 'filter': '(INDICATOR_ID="EMG00101141")', 'pageNumber': '1', 'pageSize': '2000', 'sortColumns': 'REPORT_DATE', 'sortTypes': '-1', 'source': 'WEB', 'client': 'WEB', 'p': '1', 'pageNo': '1', 'pageNum': '1', '_': '1669047266881'}
    r = requests.get(url, params=params)
    data_json = r.json()
    temp_df = pd.DataFrame(data_json['result']['data'])
    temp_df.columns = ['-', '-', '-', '时间', '-', '发布日期', '现值', '前值']
...
def macro_australia_ppi_quarterly() -> pd.DataFrame:
    ...
    """
    url = 'https://datacenter-web.eastmoney.com/api/data/v1/get'
    params = {'reportName': 'RPT_ECONOMICVALUE_AUSTRALIA', 'columns': 'ALL', 'filter': '(INDICATOR_ID="EMG00152722")', 'pageNumber': '1', 'pageSize': '2000', 'sortColumns': 'REPORT_DATE', 'sortTypes': '-1', 'source': 'WEB', 'client': 'WEB', 'p': '1', 'pageNo': '1', 'pageNum': '1', '_': '1669047266881'}
    r = requests.get(url, params=params)
    data_json = r.json()
    temp_df = pd.DataFrame(data_json['result']['data'])
    temp_df.columns = ['-', '-', '-', '时间', '-', '发布日期', '现值', '前值']
...
def macro_australia_cpi_quarterly() -> pd.DataFrame:
    ...
    """
    url = 'https://datacenter-web.eastmoney.com/api/data/v1/get'
    params = {'reportName': 'RPT_ECONOMICVALUE_AUSTRALIA', 'columns': 'ALL', 'filter': '(INDICATOR_ID="EMG00101104")', 'pageNumber': '1', 'pageSize': '2000', 'sortColumns': 'REPORT_DATE', 'sortTypes': '-1', 'source': 'WEB', 'client': 'WEB', 'p': '1', 'pageNo': '1', 'pageNum': '1', '_': '1669047266881'}
    r = requests.get(url, params=params)
    data_json = r.json()
    temp_df = pd.DataFrame(data_json['result']['data'])
    temp_df.columns = ['-', '-', '-', '时间', '-', '发布日期', '现值', '前值']
...
def macro_australia_cpi_yearly() -> pd.DataFrame:
    ...
    """
    url = 'https://datacenter-web.eastmoney.com/api/data/v1/get'
    params = {'reportName': 'RPT_ECONOMICVALUE_AUSTRALIA', 'columns': 'ALL', 'filter': '(INDICATOR_ID="EMG00101093")', 'pageNumber': '1', 'pageSize': '2000', 'sortColumns': 'REPORT_DATE', 'sortTypes': '-1', 'source': 'WEB', 'client': 'WEB', 'p': '1', 'pageNo': '1', 'pageNum': '1', '_': '1669047266881'}
    r = requests.get(url, params=params)
    data_json = r.json()
    temp_df = pd.DataFrame(data_json['result']['data'])
    temp_df.columns = ['-', '-', '-', '时间', '-', '发布日期', '现值', '前值']
...
def macro_australia_bank_rate() -> pd.DataFrame:
    ...
    """
    url = 'https://datacenter-web.eastmoney.com/api/data/v1/get'
    params = {'reportName': 'RPT_ECONOMICVALUE_AUSTRALIA', 'columns': 'ALL', 'filter': '(INDICATOR_ID="EMG00342255")', 'pageNumber': '1', 'pageSize': '2000', 'sortColumns': 'REPORT_DATE', 'sortTypes': '-1', 'source': 'WEB', 'client': 'WEB', 'p': '1', 'pageNo': '1', 'pageNum': '1', '_': '1669047266881'}
    r = requests.get(url, params=params)
    data_json = r.json()
    temp_df = pd.DataFrame(data_json['result']['data'])
    temp_df.columns = ['-', '-', '-', '时间', '-', '发布日期', '现值', '前值']
