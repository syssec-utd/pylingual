...
class CallbackBasic(object):
    ...
    def __init__(self) -> None:
        ...
        """
        self.swagger_types = {'state': 'str', 'initial_state': 'str', 'id': 'str', 'segments': 'list[Segment]', 'direction': 'str', 'held': 'bool', 'disconnect_type': 'str', 'start_hold_time': 'datetime', 'dialer_preview': 'DialerPreview', 'voicemail': 'Voicemail', 'callback_numbers': 'list[str]', 'callback_user_name': 'str', 'script_id': 'str', 'external_campaign': 'bool', 'skip_enabled': 'bool', 'timeout_seconds': 'int', 'start_alerting_time': 'datetime', 'connected_time': 'datetime', 'disconnected_time': 'datetime', 'callback_scheduled_time': 'datetime', 'automated_callback_config_id': 'str', 'provider': 'str', 'peer_id': 'str', 'wrapup': 'Wrapup', 'after_call_work': 'AfterCallWork', 'after_call_work_required': 'bool', 'caller_id': 'str', 'caller_id_name': 'str'}
        self.attribute_map = {'state': 'state', 'initial_state': 'initialState', 'id': 'id', 'segments': 'segments', 'direction': 'direction', 'held': 'held', 'disconnect_type': 'disconnectType', 'start_hold_time': 'startHoldTime', 'dialer_preview': 'dialerPreview', 'voicemail': 'voicemail', 'callback_numbers': 'callbackNumbers', 'callback_user_name': 'callbackUserName', 'script_id': 'scriptId', 'external_campaign': 'externalCampaign', 'skip_enabled': 'skipEnabled', 'timeout_seconds': 'timeoutSeconds', 'start_alerting_time': 'startAlertingTime', 'connected_time': 'connectedTime', 'disconnected_time': 'disconnectedTime', 'callback_scheduled_time': 'callbackScheduledTime', 'automated_callback_config_id': 'automatedCallbackConfigId', 'provider': 'provider', 'peer_id': 'peerId', 'wrapup': 'wrapup', 'after_call_work': 'afterCallWork', 'after_call_work_required': 'afterCallWorkRequired', 'caller_id': 'callerId', 'caller_id_name': 'callerIdName'}
        self._state = None
    ...
    @property
    def dialer_preview(self) -> 'DialerPreview':
        """
    ...
    def dialer_preview(self, dialer_preview: 'DialerPreview') -> None:
        """
    ...
    def caller_id(self, caller_id: str) -> None:
        """
        Sets the caller_id of this CallbackBasic.
        The phone number displayed to recipients of the phone call. The value should conform to the E164 format.

        :param caller_id: The caller_id of this CallbackBasic.
        :type: str
        """
    ...
    def caller_id_name(self) -> str:
        """
        Gets the caller_id_name of this CallbackBasic.
        The name displayed to recipients of the phone call.

        :return: The caller_id_name of this CallbackBasic.
        :rtype: str
        """
    ...
    def caller_id_name(self, caller_id_name: str) -> None:
        """
        Sets the caller_id_name of this CallbackBasic.
        The name displayed to recipients of the phone call.

        :param caller_id_name: The caller_id_name of this CallbackBasic.
        :type: str
        """
