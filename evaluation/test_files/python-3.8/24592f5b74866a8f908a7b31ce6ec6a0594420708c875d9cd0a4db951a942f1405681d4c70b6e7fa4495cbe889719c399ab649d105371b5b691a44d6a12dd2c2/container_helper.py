...
def get_gpu_device_requests(gpu_args):
    ...
    """
    import docker
    _gpus = {'count': 0, 'capabilities': ['gpu'], 'device': [], 'driver': ''}
    ...
    device_requests = [docker.types.DeviceRequest(count=_gpus['count'], driver=_gpus['driver'], device_ids=_gpus['device'], capabilities=[_gpus['capabilities']])]
