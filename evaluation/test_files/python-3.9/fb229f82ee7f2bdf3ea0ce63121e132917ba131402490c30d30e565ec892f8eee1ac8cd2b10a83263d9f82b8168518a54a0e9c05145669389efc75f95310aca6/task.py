...
class Operation:
    ...
    def __init__(self, module_name: str, inputs: Sequence[Union[str, Tuple[str, str]]], name: Optional[str]=None) -> None:
        self.name = name or module_name
        self.module_name = module_name
        self.inputs = inputs

    def __repr__(self) -> str:
        return f'Operation(name={self.name}, module_name={self.module_name}, inputs={self.inputs})'
...
class Task:
    ...
    def __init__(self, name: str, module_pool: nn.ModuleDict, op_sequence: Sequence[Operation], scorer: Scorer=Scorer(metrics=['accuracy']), loss_func: Optional[Callable[..., torch.Tensor]]=None, output_func: Optional[Callable[..., torch.Tensor]]=None) -> None:
        self.name = name
