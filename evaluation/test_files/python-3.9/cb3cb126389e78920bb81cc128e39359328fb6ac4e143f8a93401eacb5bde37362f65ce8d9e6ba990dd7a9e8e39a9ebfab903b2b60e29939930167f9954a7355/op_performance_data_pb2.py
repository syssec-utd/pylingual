...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n8tensorflow/core/grappler/costs/op_performance_data.proto\x12\ntensorflow\x1a&tensorflow/core/framework/tensor.proto\x1a,tensorflow/core/framework/tensor_shape.proto\x1a%tensorflow/core/framework/types.proto\x1a*tensorflow/core/framework/attr_value.proto\x1a0tensorflow/core/protobuf/device_properties.proto"+\n\x0bSessionInfo\x12\x1c\n\x14intra_op_parallelism\x18\x01 \x01(\x03"\xdb\x03\n\x06OpInfo\x12\n\n\x02op\x18\x01 \x01(\t\x12*\n\x04attr\x18\x02 \x03(\x0b2\x1c.tensorflow.OpInfo.AttrEntry\x123\n\x06inputs\x18\x03 \x03(\x0b2#.tensorflow.OpInfo.TensorProperties\x124\n\x07outputs\x18\x05 \x03(\x0b2#.tensorflow.OpInfo.TensorProperties\x12,\n\x06device\x18\x04 \x01(\x0b2\x1c.tensorflow.DeviceProperties\x12-\n\x0csession_info\x18\x06 \x01(\x0b2\x17.tensorflow.SessionInfo\x1aB\n\tAttrEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12$\n\x05value\x18\x02 \x01(\x0b2\x15.tensorflow.AttrValue:\x028\x01\x1a\x8c\x01\n\x10TensorProperties\x12#\n\x05dtype\x18\x01 \x01(\x0e2\x14.tensorflow.DataType\x12+\n\x05shape\x18\x02 \x01(\x0b2\x1c.tensorflow.TensorShapeProto\x12&\n\x05value\x18\x03 \x01(\x0b2\x17.tensorflow.TensorProto"/\n\x12NormalDistribution\x12\n\n\x02mu\x18\x01 \x01(\x01\x12\r\n\x05sigma\x18\x02 \x01(\x01"2\n\x15LogNormalDistribution\x12\n\n\x02mu\x18\x01 \x01(\x01\x12\r\n\x05sigma\x18\x02 \x01(\x01"\xf3\x04\n\rOpPerformance\x12\x1e\n\x02op\x18\x01 \x01(\x0b2\x12.tensorflow.OpInfo\x121\n\x0csession_info\x18\x0c \x01(\x0b2\x17.tensorflow.SessionInfoB\x02\x18\x01\x12\x0c\n\x04node\x18\x05 \x01(\t\x12\x1d\n\x15temporary_memory_size\x18\x02 \x01(\x03\x12\x14\n\x0ccompute_cost\x18\x03 \x01(\x03\x12\x14\n\x0ccompute_time\x18\x06 \x01(\x03\x12\x13\n\x0bmemory_time\x18\x07 \x01(\x03\x12\x1a\n\x12compute_efficiency\x18\x04 \x01(\x01\x12\x19\n\x11memory_efficiency\x18\x08 \x01(\x01\x12?\n\x15execution_time_normal\x18\n \x01(\x0b2\x1e.tensorflow.NormalDistributionH\x00\x12F\n\x19execution_time_log_normal\x18\x0b \x01(\x0b2!.tensorflow.LogNormalDistributionH\x00\x125\n\top_memory\x18\t \x01(\x0b2".tensorflow.OpPerformance.OpMemory\x1a\x97\x01\n\x08OpMemory\x12\x15\n\routput_memory\x18\x01 \x03(\x03\x12\x13\n\x0btemp_memory\x18\x02 \x01(\x03\x12\x19\n\x11persistent_memory\x18\x04 \x01(\x03\x12\x1e\n\x12device_temp_memory\x18\x03 \x01(\x03B\x02\x18\x01\x12$\n\x18device_persistent_memory\x18\x05 \x01(\x03B\x02\x18\x01B\x10\n\x0eexecution_time"F\n\x11OpPerformanceList\x121\n\x0eop_performance\x18\x01 \x03(\x0b2\x19.tensorflow.OpPerformanceB\x03\xf8\x01\x01b\x06proto3')
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    DESCRIPTOR._serialized_options = b'\xf8\x01\x01'
    _OPINFO_ATTRENTRY._options = None
    _OPINFO_ATTRENTRY._serialized_options = b'8\x01'
    _OPPERFORMANCE_OPMEMORY.fields_by_name['device_temp_memory']._options = None
    _OPPERFORMANCE_OPMEMORY.fields_by_name['device_temp_memory']._serialized_options = b'\x18\x01'
    _OPPERFORMANCE_OPMEMORY.fields_by_name['device_persistent_memory']._options = None
    _OPPERFORMANCE_OPMEMORY.fields_by_name['device_persistent_memory']._serialized_options = b'\x18\x01'
    _OPPERFORMANCE.fields_by_name['session_info']._options = None
    _OPPERFORMANCE.fields_by_name['session_info']._serialized_options = b'\x18\x01'
