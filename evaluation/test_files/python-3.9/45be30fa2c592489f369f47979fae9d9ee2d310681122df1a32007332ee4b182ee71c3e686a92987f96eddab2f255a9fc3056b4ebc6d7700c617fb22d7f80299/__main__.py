...
def set_password(args):
    ...
    cfg.update('jupyter_notebook_config', {'NotebookApp': {'password': password_hash}})
    if not args.quiet:
...
def main(argv):
    ...
    parser_password.add_argument('password', help='password to set, if not given, a password will be queried for (NOTE: this may not be safe)', nargs='?')
