...
class StateCls:
    ...
    def set(self, arg_0: bool, powerMeter=repcap.PowerMeter.Default) -> None:
		...
		Snippet: driver.applications.k50Spurious.sense.pmeter.trigger.state.set(arg_0 = False, powerMeter = repcap.PowerMeter.Default) 
    ...
    def get(self, powerMeter=repcap.PowerMeter.Default) -> bool:
		...
		Snippet: value: bool = driver.applications.k50Spurious.sense.pmeter.trigger.state.get(powerMeter = repcap.PowerMeter.Default) 
