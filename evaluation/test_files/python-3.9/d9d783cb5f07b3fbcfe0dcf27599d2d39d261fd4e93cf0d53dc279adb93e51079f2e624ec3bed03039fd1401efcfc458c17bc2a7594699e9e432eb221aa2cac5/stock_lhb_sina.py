...
def stock_lhb_detail_daily_sina(trade_date: str='20200730', symbol: str='当日无价格涨跌幅限制的A股，出现异常波动停牌的股票') -> pd.DataFrame:
    """
    龙虎榜-每日详情
...
if __name__ == '__main__':
    indicator_name_list = stock_lhb_detail_daily_sina(trade_date='20221118', symbol='返回当前交易日所有可查询的指标')
    print(indicator_name_list)
    stock_lhb_detail_daily_sina_df = stock_lhb_detail_daily_sina(trade_date='20221118', symbol='换手率达20%的证券')
