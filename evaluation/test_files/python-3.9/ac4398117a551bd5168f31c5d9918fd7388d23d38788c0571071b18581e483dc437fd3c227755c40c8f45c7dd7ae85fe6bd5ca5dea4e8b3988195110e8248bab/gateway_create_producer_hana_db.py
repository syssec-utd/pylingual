...
class GatewayCreateProducerHanaDb(object):
    ...
    openapi_types = {'delete_protection': 'str', 'hana_dbname': 'str', 'hanadb_create_statements': 'str', 'hanadb_host': 'str', 'hanadb_password': 'str', 'hanadb_port': 'str', 'hanadb_revocation_statements': 'str', 'hanadb_username': 'str', 'json': 'bool', 'name': 'str', 'producer_encryption_key_name': 'str', 'secure_access_bastion_issuer': 'str', 'secure_access_db_schema': 'str', 'secure_access_enable': 'str', 'secure_access_host': 'list[str]', 'secure_access_web': 'bool', 'tags': 'list[str]', 'target_name': 'str', 'token': 'str', 'uid_token': 'str', 'user_ttl': 'str'}
    attribute_map = {'delete_protection': 'delete_protection', 'hana_dbname': 'hana-dbname', 'hanadb_create_statements': 'hanadb-create-statements', 'hanadb_host': 'hanadb-host', 'hanadb_password': 'hanadb-password', 'hanadb_port': 'hanadb-port', 'hanadb_revocation_statements': 'hanadb-revocation-statements', 'hanadb_username': 'hanadb-username', 'json': 'json', 'name': 'name', 'producer_encryption_key_name': 'producer-encryption-key-name', 'secure_access_bastion_issuer': 'secure-access-bastion-issuer', 'secure_access_db_schema': 'secure-access-db-schema', 'secure_access_enable': 'secure-access-enable', 'secure_access_host': 'secure-access-host', 'secure_access_web': 'secure-access-web', 'tags': 'tags', 'target_name': 'target-name', 'token': 'token', 'uid_token': 'uid-token', 'user_ttl': 'user-ttl'}

    def __init__(self, delete_protection=None, hana_dbname=None, hanadb_create_statements=None, hanadb_host='127.0.0.1', hanadb_password=None, hanadb_port='443', hanadb_revocation_statements=None, hanadb_username=None, json=False, name=None, producer_encryption_key_name=None, secure_access_bastion_issuer=None, secure_access_db_schema=None, secure_access_enable=None, secure_access_host=None, secure_access_web=False, tags=None, target_name=None, token=None, uid_token=None, user_ttl='60m', local_vars_configuration=None):
        """GatewayCreateProducerHanaDb - a model defined in OpenAPI"""
