...
class VideoSSLModel(VideoClassificationModel):
    ...
    hidden_norm_activation: common.NormActivation = common.NormActivation(use_sync_bn=False, norm_momentum=0.997, norm_epsilon=1e-05)
...
class VideoSSLPretrainTask(VideoClassificationTask):
    ...
    validation_data: DataConfig = DataConfig(is_training=False, drop_remainder=False)
    losses: SSLLosses = SSLLosses()
