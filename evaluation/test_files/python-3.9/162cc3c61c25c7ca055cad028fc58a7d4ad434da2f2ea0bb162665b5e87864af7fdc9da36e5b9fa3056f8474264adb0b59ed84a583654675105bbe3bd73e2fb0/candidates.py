...
class _InstallRequirementBackedCandidate(Candidate):
    ...
    def __repr__(self) -> str:
        return '{class_name}({link!r})'.format(class_name=self.__class__.__name__, link=str(self._link))
...
class AlreadyInstalledCandidate(Candidate):
    ...
    def __repr__(self) -> str:
        return '{class_name}({distribution!r})'.format(class_name=self.__class__.__name__, distribution=self.dist)
