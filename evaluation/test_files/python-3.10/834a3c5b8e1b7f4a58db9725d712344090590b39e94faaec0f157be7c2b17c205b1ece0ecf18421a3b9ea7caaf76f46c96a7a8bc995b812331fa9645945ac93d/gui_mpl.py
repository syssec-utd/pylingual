...
class MainWindow(Tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.thePlot = Ttk.LabelFrame(self.thePlotFrame, text=' Field Plot ', width=800, height=200)
        self.theStatusBar = Ttk.Frame(self.master, height=20, borderwidth=0)
        self.theStatus = Ttk.Label(self.theStatusBar, text='Idle')
        self.theProgressbar = Ttk.Progressbar(self.theStatusBar, value=50, maximum=100, length=200)
        ...
        self.fig1.subplots_adjust(left=0.08, right=0.99, bottom=0.17, top=0.99)
        ...
        self.fig2.subplots_adjust(left=0.15, right=0.95, bottom=0.17, top=0.99)
        ...
        self.ax2.cs = self.ax2.add_patch(patches.Rectangle((0.0, 0.0), 0.0, 0.0, hatch='xx', fill=False, alpha=0.7, facecolor='none', edgecolor='Magenta', linestyle='dashed'))
        self.ax2.set_xlim(auto=True)
        self.ax2.set_ylim(auto=True)
        self.theButtonRead = Ttk.Button(self.thePanel, text='Read', width=10, command=lambda : {})
        self.theButtonConnect = Ttk.Button(self.thePanel, text='Connect', width=10, command=lambda : self.theProgressbar.grid())
        self.theButtonSetCS = Ttk.Button(self.theCS, text='Set', width=5, command=lambda : {})
        self.theButtonScan = Ttk.Button(self.theScan, text='Make Plot', width=12, command=lambda : {})
        self.theButtonSaveAsImage = Ttk.Button(self.theBatchSave, text='Image', width=10, command=lambda : {})
        self.theButtonSaveAsText = Ttk.Button(self.theBatchSave, text='Text', width=10, command=lambda : {})
        self.theButtonCopy = Ttk.Button(self.theBatchSave, text='Copy', width=10, command=lambda : {})
        self.theButtonCopyWavelet = Ttk.Button(self.theBatchSave, text='Copy', width=10, command=lambda : {})
        self.theButtonBrowse = Ttk.Button(self.theDir, text='Browse', width=10, command=lambda : {})
    ...
    def __init__(self, master=None):
        ...
        self.GaussImg = Tk.PhotoImage(file=os.path.join(modpath, 'gauss.gif'))
        ...
        MainStyle = Ttk.Style()
        MainStyle.theme_create('Dark', parent='clam', settings={'.': {'configure': {'background': _dark_bg, 'foreground': _dark_fg_1, 'lightcolor': _dark_bg, 'darkcolor': _dark_bg, 'bordercolor': _dark_border_1}, 'map': {'background': [('disabled', _dark_bg_1), ('selected', _dark_border_1)], 'foreground': [('disabled', _dark_fg), ('selected', _dark_fg), ('active', _dark_fg)]}}, 'TNotebook': {'configure': {'tabmargins': [1, 5, 1, 0]}}, 'TNotebook.Tab': {'configure': {'background': _dark_bg_1, 'foreground': _dark_fg_1, 'padding': [5, 2]}, 'map': {'background': [('selected', _dark_bg), ('active', _dark_bg_1)], 'foreground': [('selected', _dark_fg)], 'expand': [('selected', [1, 1, 1, 0])]}}, 'TButton': {'configure': {'background': _dark_bg_1, 'foreground': _dark_fg, 'anchor': Tk.CENTER, 'borderwidth': 1, 'heighlightthickness': 20}, 'map': {'background': [('disabled', _dark_bg_1), ('pressed', '!focus', _dark_bg), ('active', _dark_bg)], 'foreground': [('disabled', _dark_fg), ('pressed', _dark_fg_1), ('active', _dark_fg)], 'highlightcolor': [('focus', _dark_bg_1), ('!focus', _dark_bg)], 'relief': [('pressed', 'groove'), ('!pressed', 'ridge')]}}, 'TLabel': {'configure': {'background': _dark_bg, 'foreground': _dark_border_1}}, 'TLabelframe': {'configure': {'background': _dark_bg, 'foreground': _dark_fg, 'borderwidth': 1, 'relief': 'ridge'}}, 'TLabelframe.Label': {'configure': {'background': _dark_bg, 'foreground': _dark_fg, 'lightcolor': _dark_bg, 'darkcolor': _dark_bg}}, 'Horizontal.TProgressbar': {'configure': {'background': _dark_border_1, 'troughcolor': _dark_bg}}, 'TSizegrip': {'configure': {'background': _dark_bg}}, 'TSeparator': {'configure': {'background': _dark_bg}}, 'TEntry': {'configure': {'background': _dark_bg, 'foreground': _dark_fg, 'fieldbackground': _dark_bg, 'selectbackground': _dark_border_1, 'insertcolor': _dark_border_1, 'insertwidth': 2}}, 'TCheckbutton': {'configure': {'background': _dark_bg_1, 'foreground': _dark_border_1, 'highlightcolor': _dark_bg, 'selectcolor': _dark_bg, 'activebackground': _dark_border_1, 'activeforeground': _dark_bg}, 'map': {'background': [('disabled', _dark_bg_1), ('selected', _dark_border_1), ('pressed', '!focus', _dark_bg), ('active', _dark_bg)], 'foreground': [('disabled', _dark_fg), ('selected', _dark_bg), ('pressed', _dark_fg_1), ('active', _dark_fg)], 'highlightcolor': [('focus', _dark_bg_1), ('!focus', _dark_bg)], 'relief': [('active', 'groove'), ('pressed', 'sunken')]}}, 'TCombobox': {'configure': {'background': _dark_bg, 'foreground': _dark_fg, 'fieldbackground': _dark_bg, 'selectbackground': _dark_border_1, 'arrowcolor': _dark_border_1, 'insertcolor': _dark_border_1, 'insertwidth': 2}, 'map': {'background': [('disabled', _dark_bg_1), ('selected', _dark_border_1)], 'foreground': [('disabled', _dark_fg), ('selected', _dark_fg), ('active', _dark_bg), ('focus', _dark_fg)], 'relief': [('active', 'groove'), ('pressed', 'sunken')]}}, 'Treeview': {'configure': {'background': _dark_bg, 'foreground': _dark_fg, 'fieldbackground': _dark_bg, 'relief': 'flat'}, 'map': {'background': [('disabled', _dark_bg_1), ('selected', _dark_border_1)], 'foreground': [('disabled', _dark_fg), ('selected', _dark_fg), ('active', _dark_fg), ('focus', 'red')], 'relief': [('active', 'groove'), ('pressed', 'sunken')]}}, 'Treeview.Item': {'configure': {'focuscolor': _dark_border_1}}, 'Treeview.Heading': {'configure': {'background': _dark_bg_1, 'foreground': _dark_fg, 'focusforeground': 'red'}}})
