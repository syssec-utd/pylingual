...
import re
import sys
from apivideo.model_utils import ApiTypeError, ModelComposed, ModelNormal, ModelSimple, cached_property, change_keys_js_to_python, convert_js_args_to_python_args, date, datetime, file_type, none_type, validate_get_composed_info
...
class LiveStreamSessionSession(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {'session_id': (str,), 'loaded_at': (datetime,), 'ended_at': (datetime,)}

    @cached_property
    def discriminator():
        return None
    attribute_map = {'session_id': 'sessionId', 'loaded_at': 'loadedAt', 'ended_at': 'endedAt'}
    _composed_schemas = {}
