...
class ErrorDetail(object):
    ...
    openapi_types = {'id': 'str', 'type': 'str', 'detail': 'str', 'error_details': 'list[dict(str, str)]'}
    attribute_map = {'id': 'id', 'type': 'type', 'detail': 'detail', 'error_details': 'errorDetails'}
    required_map = {'id': 'optional', 'type': 'optional', 'detail': 'optional', 'error_details': 'optional'}

    def __init__(self, id=None, type=None, detail=None, error_details=None, local_vars_configuration=None):
