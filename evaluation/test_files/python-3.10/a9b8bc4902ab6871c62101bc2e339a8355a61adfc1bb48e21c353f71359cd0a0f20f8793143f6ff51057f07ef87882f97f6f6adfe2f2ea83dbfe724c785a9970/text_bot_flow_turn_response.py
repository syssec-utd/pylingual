...
class TextBotFlowTurnResponse(object):
    ...
    def __init__(self) -> None:
        ...
        """
        self.swagger_types = {'id': 'str', 'previous_turn': 'TextBotTurnReference', 'prompts': 'TextBotOutputPrompts', 'next_action_type': 'str', 'next_action_disconnect': 'TextBotDisconnectAction', 'next_action_wait_for_input': 'TextBotWaitForInputAction', 'next_action_exit': 'TextBotExitAction'}
        self.attribute_map = {'id': 'id', 'previous_turn': 'previousTurn', 'prompts': 'prompts', 'next_action_type': 'nextActionType', 'next_action_disconnect': 'nextActionDisconnect', 'next_action_wait_for_input': 'nextActionWaitForInput', 'next_action_exit': 'nextActionExit'}
        self._id = None
