...
class PathCreate(object):
    ...
    swagger_types = {'description': 'str', 'start_point': 'Point', 'end_point': 'Point', 'color': 'str', 'points': 'list[Point]'}
    attribute_map = {'description': 'description', 'start_point': 'start_point', 'end_point': 'end_point', 'color': 'color', 'points': 'points'}

    def __init__(self, description=None, start_point=None, end_point=None, color=None, points=None):
        """PathCreate - a model defined in Swagger"""
