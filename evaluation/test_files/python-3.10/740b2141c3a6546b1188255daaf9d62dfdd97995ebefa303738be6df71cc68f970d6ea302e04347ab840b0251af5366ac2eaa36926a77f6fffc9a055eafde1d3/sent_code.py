...
class SentCode(Object):
    ...
    def __init__(self, *, type: str, phone_code_hash: str, next_type: str=None, timeout: int=None):
        super().__init__()
        self.type = type
    ...
    def _parse(sent_code: raw.types.auth.SentCode) -> 'SentCode':
        ...
        return SentCode(type=type, phone_code_hash=sent_code.phone_code_hash, next_type=next_type, timeout=sent_code.timeout)