...
def test_model():
    ...
    assert rv.status_code == 200
    rv = client.post('/admin/geomodel/new/', data={'name': 'test1', 'point': '{"type": "Point", "coordinates": [125.8, 10.0]}', 'line': '{"type": "LineString", "coordinates": [[50.2345, 94.2], [50.21, 94.87]]}', 'polygon': '{"type": "Polygon", "coordinates": [[[100.0, 0.0], [101.0, 0.0], [101.0, 1.0], [100.0, 1.0], [100.0, 0.0]]]}', 'multi': '{"type": "MultiPoint", "coordinates": [[100.0, 0.0], [101.0, 1.0]]}'})
    ...
    assert list(to_shape(model.polygon).exterior.coords) == [(100.0, 0.0), (101.0, 0.0), (101.0, 1.0), (100.0, 1.0), (100.0, 0.0)]
    ...
    assert '{"type":"MultiPoint","coordinates":[[100,0],[101,1]]}</textarea>' in data or '{&#34;type&#34;:&#34;MultiPoint&#34;,&#34;coordinates&#34;:[[100,0],[101,1]]}' in data
...
def test_none():
    ...
    assert rv.status_code == 200
    data = rv.data.decode('utf-8')
    assert ' name="point"></textarea>' in data or ' name="point">\n</textarea>' in data or ' name="point">\r\n</textarea>' in data