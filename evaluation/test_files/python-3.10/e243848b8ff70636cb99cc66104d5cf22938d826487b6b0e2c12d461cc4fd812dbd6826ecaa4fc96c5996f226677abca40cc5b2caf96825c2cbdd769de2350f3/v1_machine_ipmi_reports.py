...
class V1MachineIpmiReports(object):
    ...
    swagger_types = {'partitionid': 'str', 'reports': 'dict(str, V1MachineIpmiReport)'}
    attribute_map = {'partitionid': 'partitionid', 'reports': 'reports'}

    def __init__(self, partitionid=None, reports=None):
        """V1MachineIpmiReports - a model defined in Swagger"""
