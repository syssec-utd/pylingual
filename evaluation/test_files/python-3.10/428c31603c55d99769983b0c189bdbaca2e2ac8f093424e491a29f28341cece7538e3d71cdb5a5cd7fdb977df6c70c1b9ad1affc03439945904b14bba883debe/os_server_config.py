...
class OsServerConfig(ModelComposed):
    ...
    """
    allowed_values = {('class_id',): {'OS.SERVERCONFIG': 'os.ServerConfig'}, ('object_type',): {'OS.SERVERCONFIG': 'os.ServerConfig'}}
    validations = {}
    ...
    def openapi_types():
        ...
        """
        lazy_import()
        return {'class_id': (str,), 'object_type': (str,), 'additional_parameters': ([OsPlaceHolder], none_type), 'answers': (OsAnswers,), 'error_msgs': ([str], none_type), 'install_target': (str,), 'operating_system_parameters': (OsOperatingSystemParameters,), 'processed_install_target': (OsInstallTarget,), 'serial_number': (str,)}
    ...
    def discriminator():
        ...
        if not val:
            return None
        return {'class_id': val}
    attribute_map = {'class_id': 'ClassId', 'object_type': 'ObjectType', 'additional_parameters': 'AdditionalParameters', 'answers': 'Answers', 'error_msgs': 'ErrorMsgs', 'install_target': 'InstallTarget', 'operating_system_parameters': 'OperatingSystemParameters', 'processed_install_target': 'ProcessedInstallTarget', 'serial_number': 'SerialNumber'}
    read_only_vars = {'install_target', 'serial_number'}
    ...
    def _composed_schemas():
        lazy_import()
        return {'anyOf': [], 'allOf': [MoBaseComplexType, OsServerConfigAllOf], 'oneOf': []}