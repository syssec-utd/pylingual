...
class Message:
    ...
    """
    __slots__ = ['sender', 'time', '_forwarded', '_no_default_action', '_stop_propagation', '_handler_name', '_prevent']
    ...
    def __init__(self, sender: MessageTarget) -> None:
        ...
        self._handler_name = f'on_{self.namespace}_{name}' if self.namespace else f'on_{name}'
    ...
    def __init_subclass__(cls, bubble: bool | None=True, verbose: bool=False, no_dispatch: bool | None=False, namespace: str | None=None) -> None:
