...
class UsersController(object):
    ...
    def attach_to(self, app):
        ...
        def authenticate(http_basic_credentials):
            ...
            user_service = UserService(app.authenticator, app.credentials_manager)
            token = user_service.authenticate(http_basic_credentials.user, http_basic_credentials.password)
