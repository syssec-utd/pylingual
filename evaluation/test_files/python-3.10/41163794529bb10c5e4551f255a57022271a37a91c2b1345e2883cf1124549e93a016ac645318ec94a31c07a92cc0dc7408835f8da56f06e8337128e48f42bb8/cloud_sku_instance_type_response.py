...
class CloudSkuInstanceTypeResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {'cloud.SkuInstanceType.List': CloudSkuInstanceTypeList, 'mo.AggregateTransform': MoAggregateTransform, 'mo.DocumentCount': MoDocumentCount, 'mo.TagSummary': MoTagSummary}
        if not val:
            return None
    ...
    def _composed_schemas():
        lazy_import()
        return {'anyOf': [], 'allOf': [], 'oneOf': [CloudSkuInstanceTypeList, MoAggregateTransform, MoDocumentCount, MoTagSummary]}