...
class V2beta2CrossVersionObjectReference(object):
    ...
    def __init__(self, api_version=None, kind=None, name=None, local_vars_configuration=None):
    ...
    def kind(self, kind):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and kind is None:
