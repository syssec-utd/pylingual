...
class DataSchema(object):
    ...
    def __init__(self) -> None:
        ...
        """
        self.swagger_types = {'id': 'str', 'name': 'str', 'version': 'int', 'applies_to': 'list[str]', 'enabled': 'bool', 'created_by': 'DomainEntityRef', 'date_created': 'datetime', 'json_schema': 'JsonSchemaDocument', 'self_uri': 'str'}
        self.attribute_map = {'id': 'id', 'name': 'name', 'version': 'version', 'applies_to': 'appliesTo', 'enabled': 'enabled', 'created_by': 'createdBy', 'date_created': 'dateCreated', 'json_schema': 'jsonSchema', 'self_uri': 'selfUri'}
        self._id = None
        self._name = None
        self._version = None
    ...
    @json_schema.setter
    def json_schema(self, json_schema: 'JsonSchemaDocument') -> None:
        """
