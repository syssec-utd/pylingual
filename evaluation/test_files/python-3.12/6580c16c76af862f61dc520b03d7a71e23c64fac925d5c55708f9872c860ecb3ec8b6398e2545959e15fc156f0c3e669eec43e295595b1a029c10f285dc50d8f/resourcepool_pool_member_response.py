...
class ResourcepoolPoolMemberResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {'mo.AggregateTransform': MoAggregateTransform, 'mo.DocumentCount': MoDocumentCount, 'mo.TagSummary': MoTagSummary, 'resourcepool.PoolMember.List': ResourcepoolPoolMemberList}
        if not val:
            return None
    ...
    def _composed_schemas():
        lazy_import()
        return {'anyOf': [], 'allOf': [], 'oneOf': [MoAggregateTransform, MoDocumentCount, MoTagSummary, ResourcepoolPoolMemberList]}