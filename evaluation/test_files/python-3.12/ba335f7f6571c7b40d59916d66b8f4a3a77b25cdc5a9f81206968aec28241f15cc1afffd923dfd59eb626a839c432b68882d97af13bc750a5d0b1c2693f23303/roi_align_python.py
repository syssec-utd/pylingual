...
def roi_align_common(a_np, b_np, rois_np, channel, pooled_size_h, pooled_size_w, spatial_scale, sample_ratio, avg_mode, max_mode, height, width, layout):
                ...
                for pw in range(pooled_size_w):
                    ...
                    for iy in range(roi_bin_grid_h):
                        for ix in range(roi_bin_grid_w):
                            ...
                            if avg_mode:
                                total += _bilinear(a_np, batch_index, c, y, x, height, width, layout) / count
                            if max_mode:
                                total = max(total, _bilinear(a_np, batch_index, c, y, x, height, width, layout))
                    if layout == 'NCHW':
...
def roi_align_nchw_python(a_np, rois_np, pooled_size, spatial_scale, sample_ratio, mode=b'avg'):
    ...
    return roi_align_common(a_np, b_np, rois_np, channel, pooled_size_h, pooled_size_w, spatial_scale, sample_ratio, avg_mode, max_mode, height, width, 'NCHW')
...
def roi_align_nhwc_python(a_np, rois_np, pooled_size, spatial_scale, sample_ratio, mode=b'avg'):
    ...
    return roi_align_common(a_np, b_np, rois_np, channel, pooled_size_h, pooled_size_w, spatial_scale, sample_ratio, avg_mode, max_mode, height, width, 'NHWC')