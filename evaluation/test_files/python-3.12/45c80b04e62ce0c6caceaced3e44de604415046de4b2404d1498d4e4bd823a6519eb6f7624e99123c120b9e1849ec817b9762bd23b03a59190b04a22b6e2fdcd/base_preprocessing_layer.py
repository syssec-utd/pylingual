...
keras_kpl_gauge = tf.__internal__.monitoring.BoolGauge('/tensorflow/api/keras/layers/preprocessing', 'keras preprocessing layers usage', 'method')
...
class PreprocessingLayer(Layer, metaclass=abc.ABCMeta):
    ...
    **Don't use this class directly: it's an abstract base class!** You may
    ...
    def _configure_steps_per_execution(self, steps_per_execution):
        self._steps_per_execution = tf.Variable(steps_per_execution, dtype='int64', aggregation=tf.VariableAggregation.ONLY_FIRST_REPLICA)
