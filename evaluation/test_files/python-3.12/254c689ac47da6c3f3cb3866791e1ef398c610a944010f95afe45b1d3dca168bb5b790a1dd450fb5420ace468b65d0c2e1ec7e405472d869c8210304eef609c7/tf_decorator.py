...
def fullargspec_to_signature(fullargspec: inspect.FullArgSpec) -> inspect.Signature:
    ...
    parameters = []
    arg_kind = inspect.Parameter.POSITIONAL_ONLY if fullargspec.kwonlyargs else inspect.Parameter.POSITIONAL_OR_KEYWORD
    for arg in fullargspec.args:
        parameters.append(inspect.Parameter(arg, arg_kind, default=defaults.get(arg, inspect.Parameter.empty)))
