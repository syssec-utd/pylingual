...
import pandas as pd
from pandas import DataFrame, Index, MultiIndex, NaT, Series, Timestamp, date_range, read_csv, to_datetime
...
class TestDataFrameToCSV:
    ...
    def test_to_csv_mixed(self):
        ...
        df_int = DataFrame(np.random.randn(100, 5).astype('int64'), dtype='int64', columns=create_cols('int'))
