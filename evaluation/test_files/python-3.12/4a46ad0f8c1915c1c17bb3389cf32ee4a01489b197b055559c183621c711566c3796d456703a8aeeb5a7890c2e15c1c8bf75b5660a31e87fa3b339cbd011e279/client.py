...
from airflow.providers.google.ads._vendor.googleads.v12.services.types import asset_group_listing_group_filter_service
...
class AssetGroupListingGroupFilterServiceClientMeta(type):
    ...
    def get_transport_class(cls, label: str=None) -> Type[AssetGroupListingGroupFilterServiceTransport]:
...
class AssetGroupListingGroupFilterServiceClient(metaclass=AssetGroupListingGroupFilterServiceClientMeta):
    ...
    def parse_asset_group_path(path: str) -> Dict[str, str]:
        ...
        m = re.match('^customers/(?P<customer_id>.+?)/assetGroups/(?P<asset_group_id>.+?)$', path)
    ...
    def parse_asset_group_listing_group_filter_path(path: str) -> Dict[str, str]:
        ...
        m = re.match('^customers/(?P<customer_id>.+?)/assetGroupListingGroupFilters/(?P<asset_group_id>.+?)~(?P<listing_group_filter_id>.+?)$', path)
        return m.groupdict() if m else {}
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Union[str, AssetGroupListingGroupFilterServiceTransport, None]=None, client_options: Optional[client_options_lib.ClientOptions]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
    ...
    def mutate_asset_group_listing_group_filters(self, request: Union[asset_group_listing_group_filter_service.MutateAssetGroupListingGroupFiltersRequest, dict]=None, *, customer_id: str=None, operations: Sequence[asset_group_listing_group_filter_service.AssetGroupListingGroupFilterOperation]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: float=None, metadata: Sequence[Tuple[str, str]]=()) -> asset_group_listing_group_filter_service.MutateAssetGroupListingGroupFiltersResponse:
        ...
        return response
try:
    DEFAULT_CLIENT_INFO = gapic_v1.client_info.ClientInfo(gapic_version=pkg_resources.get_distribution('google-ads').version)
