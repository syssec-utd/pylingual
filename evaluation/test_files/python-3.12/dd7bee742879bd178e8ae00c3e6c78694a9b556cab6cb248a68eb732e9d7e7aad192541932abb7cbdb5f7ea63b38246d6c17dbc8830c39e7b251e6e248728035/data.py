...
class DataRequest(Request):
    ...
    def __init__(self, request: Optional[RequestSourceType]=None):
        self.buffer = None
        self._pb_body = None
        try:
    ...
    def is_decompressed(self) -> bool:
        ...
        """
        return type(self._pb_body) in [jina_pb2.DataRequestProto, jina_pb2.DataRequestProtoWoData]
    ...
    @property
    def proto_wo_data(self) -> Union['jina_pb2.DataRequestProtoWoData', 'jina_pb2.DataRequestProto']:
        """
    ...
    @property
    def proto(self) -> Union['jina_pb2.DataRequestProto', 'jina_pb2.DataRequestProtoWoData']:
        """
    ...
    @property
    def proto_with_data(self) -> 'jina_pb2.DataRequestProto':
        """
    ...
    def to_dict(self) -> Dict:
        ...
        d = MessageToDict(self.proto, preserving_proto_field_name=True, use_integers_for_enums=True)
        d['data'] = da.to_dict()
        return d
