...
class TestIssuedDocumentsApi(unittest.TestCase):
    ...
    def test_create_issued_document(self):
        resp = {'status': 200, 'data': b'{"data": {"id": 1, "type": "invoice", "number": 1, "numeration": "/A", "date": "2022-01-01", "year": 1, "subject": "subject_example", "visible_subject": "visible_subject_example", "rc_center": "rc_center_example", "notes": "notes_example", "rivalsa": 0.0, "cassa": 0.0, "cassa_taxable": 0.0, "amount_cassa_taxable": 3.14, "cassa2": 0.0, "cassa2_taxable": 0.0, "amount_cassa2_taxable": 3.14, "global_cassa_taxable": 0.0, "amount_global_cassa_taxable": 3.14}}', 'reason': 'OK'}
        mock_resp = RESTResponse(functions.Dict2Class(resp))
        mock_resp.getheader = unittest.mock.MagicMock(return_value=None)
        mock_resp.getheaders = unittest.mock.MagicMock(return_value=None)
        self.api.api_client.rest_client.post_request = unittest.mock.MagicMock(return_value=mock_resp)
    ...
    def test_delete_issued_document(self):
        ...
        mock_resp.getheader = unittest.mock.MagicMock(return_value=None)
        mock_resp.getheaders = unittest.mock.MagicMock(return_value=None)
        self.api.api_client.rest_client.delete_request = unittest.mock.MagicMock(return_value=mock_resp)
    ...
    def test_get_email_data(self):
        resp = {'status': 200, 'data': b'{"data": {"recipient_email": "info@mail.com", "cc_email": "default@mail.com", "subject": "important", "body": "you won 13 billion indian rupies", "document_exists": false, "delivery_note_exists": false, "attachment_exists": false, "accompanying_invoice_exists": false, "default_attach_pdf": false, "default_sender_email": {"id": 1, "email": "ex.email@provider.co"}, "sender_emails_list": [{"id": 1, "email": "ex.email@provider.co"}]}}', 'reason': 'OK'}
        mock_resp = RESTResponse(functions.Dict2Class(resp))
        mock_resp.getheader = unittest.mock.MagicMock(return_value=None)
        mock_resp.getheaders = unittest.mock.MagicMock(return_value=None)
        self.api.api_client.rest_client.get_request = unittest.mock.MagicMock(return_value=mock_resp)
    ...
    def test_get_existing_issued_document_totals(self):
        resp = {'status': 200, 'data': b'{"data": {"amount_net": 10.0, "amount_rivalsa": 0.0, "amount_net_with_rivalsa": 10.0, "amount_cassa": 3.14, "taxable_amount": 0.0, "amount_vat": 22.0, "amount_gross": 12.2, "amount_due": 12.2, "payments_sum": 12.2}}', 'reason': 'OK'}
        mock_resp = RESTResponse(functions.Dict2Class(resp))
        mock_resp.getheader = unittest.mock.MagicMock(return_value=None)
        mock_resp.getheaders = unittest.mock.MagicMock(return_value=None)
        self.api.api_client.rest_client.post_request = unittest.mock.MagicMock(return_value=mock_resp)
    ...
    def test_get_issued_document_pre_create_info(self):
        resp = {'status': 200, 'data': b'{"data": {"default_values": {"rivalsa": 10.0}, "extra_data_default_values": {"ts_communication": true, "ts_tipo_spesa": "string", "ts_flag_tipo_spesa": 0, "ts_pagamento_tracciato": true}, "items_default_values": {"vat": {"id": 1, "value": 22.0, "description": "Non imponibile art. 123", "notes": "IVA non imponibile ai sensi dell articolo 123, comma 2", "e_invoice": true, "ei_type": "2", "ei_description": "ei_description_example", "is_disabled": true}}, "countries_list": ["italy"]}}', 'reason': 'OK'}
        mock_resp = RESTResponse(functions.Dict2Class(resp))
        mock_resp.getheader = unittest.mock.MagicMock(return_value=None)
        mock_resp.getheaders = unittest.mock.MagicMock(return_value=None)
        self.api.api_client.rest_client.get_request = unittest.mock.MagicMock(return_value=mock_resp)
    ...
    def test_modify_issued_document(self):
        ...
        mock_resp.getheader = unittest.mock.MagicMock(return_value=None)
        mock_resp.getheaders = unittest.mock.MagicMock(return_value=None)
        self.api.api_client.rest_client.put_request = unittest.mock.MagicMock(return_value=mock_resp)
    ...
    def test_upload_issued_document_attachment(self):
        resp = {'status': 200, 'data': b'{"data": {"attachment_token": "aisdfvbgablsi9876r8o3qw36"}}', 'reason': 'OK'}
        mock_resp = RESTResponse(functions.Dict2Class(resp))
        mock_resp.getheader = unittest.mock.MagicMock(return_value=None)
        mock_resp.getheaders = unittest.mock.MagicMock(return_value=None)
        self.api.api_client.rest_client.post_request = unittest.mock.MagicMock(return_value=mock_resp)
    ...
    def test_transform_issued_document(self):
        resp = {'status': 200, 'data': b'{"data": {"id": 1, "type": "invoice", "entity": {"id": 54321, "name": "Mary Red S.r.L.", "vat_number": "IT05432181211", "tax_code": "IT05432181211", "address_street": "Corso impero, 66", "address_postal_code": "20900", "address_city": "Milano", "address_province": "MI", "address_extra": "", "country": "Italia", "certified_email": "mary@pec.red.com", "ei_code": "ABCXCR1"}, "number": 1, "numeration": "/A", "date": "2022-01-01", "year": 1, "subject": "subject_example", "visible_subject": "visible_subject_example", "rc_center": "rc_center_example", "notes": "notes_example", "rivalsa": 0.0, "cassa": 0.0, "cassa_taxable": 0.0, "amount_cassa_taxable": 3.14, "cassa2": 0.0, "cassa2_taxable": 0.0, "amount_cassa2_taxable": 3.14, "global_cassa_taxable": 0.0, "amount_global_cassa_taxable": 3.14}, "options": {"create_from": ["12345"], "keep_copy": true}}', 'reason': 'OK'}
        mock_resp = RESTResponse(functions.Dict2Class(resp))
        mock_resp.getheader = unittest.mock.MagicMock(return_value=None)
        mock_resp.getheaders = unittest.mock.MagicMock(return_value=None)
        self.api.api_client.rest_client.get_request = unittest.mock.MagicMock(return_value=mock_resp)
        expected = TransformIssuedDocumentResponse(data=IssuedDocument(id=1, type=IssuedDocumentType('invoice'), entity=Entity(id=54321, name='Mary Red S.r.L.', vat_number='IT05432181211', tax_code='IT05432181211', address_street='Corso impero, 66', address_postal_code='20900', address_city='Milano', address_province='MI', address_extra='', country='Italia', certified_email='mary@pec.red.com', ei_code='ABCXCR1'), number=1, numeration='/A', date=datetime.datetime.strptime('2022-01-01', '%Y-%m-%d').date(), year=1, subject='subject_example', visible_subject='visible_subject_example', rc_center='rc_center_example', notes='notes_example', rivalsa=0.0, cassa=0.0, cassa_taxable=0.0, amount_cassa_taxable=3.14, cassa2=0.0, cassa2_taxable=0.0, amount_cassa2_taxable=3.14, global_cassa_taxable=0.0, amount_global_cassa_taxable=3.14), options=IssuedDocumentOptions(create_from=['12345'], keep_copy=True))
        actual = self.api.transform_issued_document(2, 12345, 'proforma')
        assert actual == expected

    def test_join_issued_documents(self):
        resp = {'status': 200, 'data': b'{"data": {"id": 1, "type": "invoice", "entity": {"id": 54321, "name": "Mary Red S.r.L.", "vat_number": "IT05432181211", "tax_code": "IT05432181211", "address_street": "Corso impero, 66", "address_postal_code": "20900", "address_city": "Milano", "address_province": "MI", "address_extra": "", "country": "Italia", "certified_email": "mary@pec.red.com", "ei_code": "ABCXCR1"}, "number": 1, "numeration": "/A", "date": "2022-01-01", "year": 1, "subject": "subject_example", "visible_subject": "visible_subject_example", "rc_center": "rc_center_example", "notes": "notes_example", "rivalsa": 0.0, "cassa": 0.0, "cassa_taxable": 0.0, "amount_cassa_taxable": 3.14, "cassa2": 0.0, "cassa2_taxable": 0.0, "amount_cassa2_taxable": 3.14, "global_cassa_taxable": 0.0, "amount_global_cassa_taxable": 3.14}, "options": {"create_from": ["12345", "54321"]}}', 'reason': 'OK'}
        mock_resp = RESTResponse(functions.Dict2Class(resp))
        mock_resp.getheader = unittest.mock.MagicMock(return_value=None)
        mock_resp.getheaders = unittest.mock.MagicMock(return_value=None)
        self.api.api_client.rest_client.get_request = unittest.mock.MagicMock(return_value=mock_resp)
        expected = JoinIssuedDocumentsResponse(data=IssuedDocument(id=1, type=IssuedDocumentType('invoice'), entity=Entity(id=54321, name='Mary Red S.r.L.', vat_number='IT05432181211', tax_code='IT05432181211', address_street='Corso impero, 66', address_postal_code='20900', address_city='Milano', address_province='MI', address_extra='', country='Italia', certified_email='mary@pec.red.com', ei_code='ABCXCR1'), number=1, numeration='/A', date=datetime.datetime.strptime('2022-01-01', '%Y-%m-%d').date(), year=1, subject='subject_example', visible_subject='visible_subject_example', rc_center='rc_center_example', notes='notes_example', rivalsa=0.0, cassa=0.0, cassa_taxable=0.0, amount_cassa_taxable=3.14, cassa2=0.0, cassa2_taxable=0.0, amount_cassa2_taxable=3.14, global_cassa_taxable=0.0, amount_global_cassa_taxable=3.14), options=IssuedDocumentOptions(create_from=['12345', '54321']))
