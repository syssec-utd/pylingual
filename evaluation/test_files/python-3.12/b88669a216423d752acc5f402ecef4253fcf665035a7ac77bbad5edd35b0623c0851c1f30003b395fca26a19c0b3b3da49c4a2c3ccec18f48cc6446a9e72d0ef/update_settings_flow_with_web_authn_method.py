...
import re
import sys
from ory_client.model_utils import ApiTypeError, ModelComposed, ModelNormal, ModelSimple, cached_property, change_keys_js_to_python, convert_js_args_to_python_args, date, datetime, file_type, none_type, validate_get_composed_info, OpenApiModel
...
class UpdateSettingsFlowWithWebAuthnMethod(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {'method': (str,), 'csrf_token': (str,), 'webauthn_register': (str,), 'webauthn_register_displayname': (str,), 'webauthn_remove': (str,)}

    @cached_property
    def discriminator():
        return None
    attribute_map = {'method': 'method', 'csrf_token': 'csrf_token', 'webauthn_register': 'webauthn_register', 'webauthn_register_displayname': 'webauthn_register_displayname', 'webauthn_remove': 'webauthn_remove'}
    read_only_vars = {}
    _composed_schemas = {}

    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, method, *args, **kwargs):
