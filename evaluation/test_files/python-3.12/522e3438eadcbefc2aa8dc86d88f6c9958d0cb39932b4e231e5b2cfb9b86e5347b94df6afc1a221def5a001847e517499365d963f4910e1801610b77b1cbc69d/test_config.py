...
class TestConfig(unittest.TestCase):
    ...
    def test_standby_cluster_parameters(self):
        dynamic_configuration = {'standby_cluster': {'create_replica_methods': ['wal_e', 'basebackup'], 'host': 'localhost', 'port': 5432}}
    ...
    def test_configuration_directory(self):
        ...
        with patch.object(builtins, 'open', MagicMock(side_effect=open_mock)):
            ...
            self.assertEqual(config._local_configuration, {'test': False, 'test2': {'child-1': 'somestring', 'child-2': 10}, 'test3': True, 'test4': [{'ab': 5}], 'new-attr': True})
