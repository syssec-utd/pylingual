...
class IscsiLunSnapshotCreationParams(object):
    ...
    openapi_types = {'iscsi_target_id': 'str', 'name': 'str', 'iscsi_lun_id': 'str'}
    attribute_map = {'iscsi_target_id': 'iscsi_target_id', 'name': 'name', 'iscsi_lun_id': 'iscsi_lun_id'}

    def __init__(self, **kwargs):
        """IscsiLunSnapshotCreationParams - a model defined in OpenAPI"""
    ...
    def iscsi_target_id(self, iscsi_target_id):
        ...
        """
        if self.local_vars_configuration.client_side_validation and iscsi_target_id is None:
            raise ValueError('Invalid value for `iscsi_target_id`, must not be `None`')
    ...
    def iscsi_lun_id(self, iscsi_lun_id):
        ...
        """
        if self.local_vars_configuration.client_side_validation and iscsi_lun_id is None:
            raise ValueError('Invalid value for `iscsi_lun_id`, must not be `None`')
