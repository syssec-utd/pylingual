...
from typing import TYPE_CHECKING, Any, Dict, Iterable, List, Optional, Set, Tuple, TypedDict, Union
if TYPE_CHECKING:
    from playwright.sync_api import Browser, CDPSession, Page, sync_playwright
black_listed_elements: Set[str] = {'html', 'head', 'title', 'meta', 'iframe', 'body', 'script', 'style', 'path', 'svg', 'br', '::marker'}
...
class Crawler:
    ...
    def __init__(self) -> None:
        try:
            ...
            raise ValueError('Could not import playwright python package. Please it install it with `pip install playwright`.')
