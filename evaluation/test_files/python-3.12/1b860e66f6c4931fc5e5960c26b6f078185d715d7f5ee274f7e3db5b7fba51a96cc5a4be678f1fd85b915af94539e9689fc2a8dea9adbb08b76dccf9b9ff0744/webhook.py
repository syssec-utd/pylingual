...
class WebhookInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload: Dict[str, Any], service_sid: str, sid: Optional[str]=None):
        ...
        self.webhook_method: Optional['WebhookInstance.Methods'] = payload.get('webhook_method')
    ...
    def _proxy(self) -> 'WebhookContext':
        ...
        if self._context is None:
            self._context = WebhookContext(self._version, service_sid=self._solution['service_sid'], sid=self._solution['sid'])
    ...
    def update(self, friendly_name: Union[str, object]=values.unset, event_types: Union[List[str], object]=values.unset, webhook_url: Union[str, object]=values.unset, status: Union['WebhookInstance.Status', object]=values.unset, version: Union['WebhookInstance.Version', object]=values.unset) -> 'WebhookInstance':
        """
        ...
        """
        return self._proxy.update(friendly_name=friendly_name, event_types=event_types, webhook_url=webhook_url, status=status, version=version)

    async def update_async(self, friendly_name: Union[str, object]=values.unset, event_types: Union[List[str], object]=values.unset, webhook_url: Union[str, object]=values.unset, status: Union['WebhookInstance.Status', object]=values.unset, version: Union['WebhookInstance.Version', object]=values.unset) -> 'WebhookInstance':
        """
        ...
        :returns: The updated WebhookInstance
        """
        return await self._proxy.update_async(friendly_name=friendly_name, event_types=event_types, webhook_url=webhook_url, status=status, version=version)
...
class WebhookContext(InstanceContext):
    ...
    def update(self, friendly_name: Union[str, object]=values.unset, event_types: Union[List[str], object]=values.unset, webhook_url: Union[str, object]=values.unset, status: Union['WebhookInstance.Status', object]=values.unset, version: Union['WebhookInstance.Version', object]=values.unset) -> WebhookInstance:
        ...
        :returns: The updated WebhookInstance
        """
        data = values.of({'FriendlyName': friendly_name, 'EventTypes': serialize.map(event_types, lambda e: e), 'WebhookUrl': webhook_url, 'Status': status, 'Version': version})
...
class WebhookList(ListResource):
    ...
    def create(self, friendly_name: str, event_types: List[str], webhook_url: str, status: Union['WebhookInstance.Status', object]=values.unset, version: Union['WebhookInstance.Version', object]=values.unset) -> WebhookInstance:
        """
    ...
    async def create_async(self, friendly_name: str, event_types: List[str], webhook_url: str, status: Union['WebhookInstance.Status', object]=values.unset, version: Union['WebhookInstance.Version', object]=values.unset) -> WebhookInstance:
        """
    ...
    def stream(self, limit: Optional[int]=None, page_size: Optional[int]=None) -> Iterator[WebhookInstance]:
        """
    ...
    async def stream_async(self, limit: Optional[int]=None, page_size: Optional[int]=None) -> AsyncIterator[WebhookInstance]:
        """
    ...
    def list(self, limit: Optional[int]=None, page_size: Optional[int]=None) -> List[WebhookInstance]:
        """
    ...
    async def list_async(self, limit: Optional[int]=None, page_size: Optional[int]=None) -> List[WebhookInstance]:
        """
        ...
        :returns: list that will contain up to limit results
        """
        return [record async for record in await self.stream_async(limit=limit, page_size=page_size)]

    def page(self, page_token: Union[str, object]=values.unset, page_number: Union[int, object]=values.unset, page_size: Union[int, object]=values.unset) -> WebhookPage:
        """
    ...
    async def page_async(self, page_token: Union[str, object]=values.unset, page_number: Union[int, object]=values.unset, page_size: Union[int, object]=values.unset) -> WebhookPage:
        """
