...
class ICreateErrorInfo(IUnknown):
    ...
    _methods_ = [COMMETHOD([], HRESULT, 'SetGUID', (['in'], POINTER(GUID), 'rguid')), COMMETHOD([], HRESULT, 'SetSource', (['in'], LPCOLESTR, 'szSource')), COMMETHOD([], HRESULT, 'SetDescription', (['in'], LPCOLESTR, 'szDescription')), COMMETHOD([], HRESULT, 'SetHelpFile', (['in'], LPCOLESTR, 'szHelpFile')), COMMETHOD([], HRESULT, 'SetHelpContext', (['in'], DWORD, 'dwHelpContext'))]

class IErrorInfo(IUnknown):
    _iid_ = GUID('{1CF2B120-547D-101B-8E65-08002B2BD119}')
    _methods_ = [COMMETHOD([], HRESULT, 'GetGUID', (['out'], POINTER(GUID), 'pGUID')), COMMETHOD([], HRESULT, 'GetSource', (['out'], POINTER(BSTR), 'pBstrSource')), COMMETHOD([], HRESULT, 'GetDescription', (['out'], POINTER(BSTR), 'pBstrDescription')), COMMETHOD([], HRESULT, 'GetHelpFile', (['out'], POINTER(BSTR), 'pBstrHelpFile')), COMMETHOD([], HRESULT, 'GetHelpContext', (['out'], POINTER(DWORD), 'pdwHelpContext'))]

class ISupportErrorInfo(IUnknown):
    _iid_ = GUID('{DF0B3D60-548F-101B-8E65-08002B2BD119}')
    _methods_ = [COMMETHOD([], HRESULT, 'InterfaceSupportsErrorInfo', (['in'], POINTER(GUID), 'riid'))]
...
def ReportException(hresult, iid, clsid=None, helpfile=None, helpcontext=None, stacklevel=None):
    ...
    if stacklevel is not None:
        ...
        text = '%s: %s' % (typ, value)
    return ReportError(text, iid, clsid=clsid, helpfile=helpfile, helpcontext=helpcontext, hresult=hresult)
