...
class CharFieldTests(TestCase):
    ...
    def test_missing_max_length(self):
        ...
        field = Model._meta.get_field('field')
        self.assertEqual(field.check(), [Error("CharFields must define a 'max_length' attribute.", obj=field, id='fields.E120')])
    ...
    def test_non_iterable_choices(self):
        ...
        field = Model._meta.get_field('field')
        self.assertEqual(field.check(), [Error("'choices' must be an iterable (e.g., a list or tuple).", obj=field, id='fields.E004')])
    ...
    def test_non_iterable_choices_two_letters(self):
        ...
        field = Model._meta.get_field('field')
        self.assertEqual(field.check(), [Error("'choices' must be an iterable containing (actual value, human readable name) tuples.", obj=field, id='fields.E005')])
