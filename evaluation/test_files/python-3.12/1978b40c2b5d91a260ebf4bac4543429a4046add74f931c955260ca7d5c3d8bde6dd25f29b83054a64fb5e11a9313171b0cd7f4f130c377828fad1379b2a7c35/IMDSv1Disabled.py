...
class IMDSv1Disabled(BaseResourceCheck):
    ...
    def scan_resource_conf(self, conf):
        ...
        if 'http_tokens' in metadata_options and metadata_options['http_tokens'] == ['required'] or ('http_endpoint' in metadata_options and metadata_options['http_endpoint'] == ['disabled']):
