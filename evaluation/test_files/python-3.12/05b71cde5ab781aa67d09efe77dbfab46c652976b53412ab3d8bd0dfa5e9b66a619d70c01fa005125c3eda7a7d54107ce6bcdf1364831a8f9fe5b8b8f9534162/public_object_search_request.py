...
class PublicObjectSearchRequest(object):
    ...
    def __init__(self, filter_groups=None, sorts=None, query=None, properties=None, limit=None, after=None, local_vars_configuration=None):
        """PublicObjectSearchRequest - a model defined in OpenAPI"""
    ...
    def filter_groups(self, filter_groups):
        ...
        """
        if self.local_vars_configuration.client_side_validation and filter_groups is None:
    ...
    def sorts(self, sorts):
        ...
        :type sorts: list[str]
        """
        if self.local_vars_configuration.client_side_validation and sorts is None:
            raise ValueError('Invalid value for `sorts`, must not be `None`')
        self._sorts = sorts
    ...
    def limit(self, limit):
        ...
        :type limit: int
        """
        if self.local_vars_configuration.client_side_validation and limit is None:
