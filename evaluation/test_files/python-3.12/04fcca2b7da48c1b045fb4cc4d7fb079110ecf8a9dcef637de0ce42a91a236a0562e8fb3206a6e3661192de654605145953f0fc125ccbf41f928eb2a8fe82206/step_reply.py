...
class StepReply(object):
    ...
    swagger_types = {'step_type': 'StepType', 'step_id': 'str', 'exit_code': 'int', 'output': 'str', 'error': 'str'}
    attribute_map = {'step_type': 'step_type', 'step_id': 'step_id', 'exit_code': 'exit_code', 'output': 'output', 'error': 'error'}

    def __init__(self, step_type=None, step_id=None, exit_code=None, output=None, error=None):
        """StepReply - a model defined in Swagger"""
