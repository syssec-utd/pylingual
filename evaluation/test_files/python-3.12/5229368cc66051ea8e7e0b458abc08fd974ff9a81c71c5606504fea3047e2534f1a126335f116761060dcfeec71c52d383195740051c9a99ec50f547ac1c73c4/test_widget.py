...
@pytest.mark.parametrize('set_val, get_val, style_str', [[True, True, 'visible'], [False, False, 'hidden'], ['hidden', False, 'hidden'], ['visible', True, 'visible']])
...
class GetByIdApp(App):
    ...
    def compose(self) -> ComposeResult:
        ...
        yield Widget(child1, child2, id='parent')
