...
import pickle
import re
from typing import TYPE_CHECKING, Any, Callable, Hashable, Literal, Mapping, Sequence, Type, cast, final, overload
import warnings
import weakref
import numpy as np
...
from pandas._typing import ArrayLike, Axis, CompressionOptions, Dtype, DtypeArg, DtypeObj, FilePath, IndexKeyFunc, IndexLabel, JSONSerializable, Level, Manager, NDFrameT, RandomState, Renamer, StorageOptions, T, TimedeltaConvertibleTypes, TimestampConvertibleTypes, ValueKeyFunc, WriteBuffer, npt
from pandas.compat._optional import import_optional_dependency
from pandas.compat.numpy import function as nv
from pandas.errors import AbstractMethodError, InvalidIndexError
from pandas.util._decorators import doc, rewrite_axis_style_signature
from pandas.util._exceptions import find_stack_level
from pandas.util._validators import validate_ascending, validate_bool_kwarg, validate_fillna_kwargs, validate_inclusive
...
from pandas.core.indexes.api import DatetimeIndex, Index, MultiIndex, PeriodIndex, RangeIndex, default_index, ensure_index
...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def __init__(self, data: Manager, copy: bool_t=False, attrs: Mapping[Hashable, Any] | None=None):
    ...
    def _init_mgr(cls, mgr: Manager, axes, dtype: Dtype | None=None, copy: bool_t=False) -> Manager:
        ...
        if dtype is not None:
            if isinstance(mgr, BlockManager) and len(mgr.blocks) == 1 and is_dtype_equal(mgr.blocks[0].values.dtype, dtype):
                pass
            else:
    ...
    def _AXIS_NUMBERS(self) -> dict[str, int]:
        """.. deprecated:: 1.1.0"""
        warnings.warn('_AXIS_NUMBERS has been deprecated.', FutureWarning, stacklevel=find_stack_level())
        return {'index': 0}
    ...
    def _rename(self: NDFrameT, mapper: Renamer | None=None, *, index: Renamer | None=None, columns: Renamer | None=None, axis: Axis | None=None, copy: bool_t=True, inplace: bool_t=False, level: Level | None=None, errors: str='ignore') -> NDFrameT | None:
        """
    ...
    def to_excel(self, excel_writer, sheet_name: str='Sheet1', na_rep: str='', float_format: str | None=None, columns=None, header=True, index=True, index_label=None, startrow=0, startcol=0, engine=None, merge_cells=True, encoding=None, inf_rep='inf', verbose=True, freeze_panes=None, storage_options: StorageOptions=None) -> None:
        """
    ...
    @final
    def to_sql(self, name: str, con, schema=None, if_exists: str='fail', index: bool_t=True, index_label=None, chunksize=None, dtype: DtypeArg | None=None, method=None) -> int | None:
        """
    ...
    def to_pickle(self, path, compression: CompressionOptions='infer', protocol: int=pickle.HIGHEST_PROTOCOL, storage_options: StorageOptions=None) -> None:
        """
    ...
    def to_latex(self, buf=None, columns=None, col_space=None, header=True, index=True, na_rep='NaN', formatters=None, float_format=None, sparsify=None, index_names=True, bold_rows=False, column_format=None, longtable=None, escape=None, encoding=None, decimal='.', multicolumn=None, multicolumn_format=None, multirow=None, caption=None, label=None, position=None):
        ...
        \\end{{tabular}}
        """
        msg = 'In future versions `DataFrame.to_latex` is expected to utilise the base implementation of `Styler.to_latex` for formatting and rendering. The arguments signature may therefore change. It is recommended instead to use `DataFrame.style.to_latex` which also contains additional functionality.'
    ...
    def take(self: NDFrameT, indices, axis=0, is_copy: bool_t | None=None, **kwargs) -> NDFrameT:
        ...
        **kwargs
        ...
        if is_copy is not None:
            warnings.warn("is_copy is deprecated and will be removed in a future version. 'take' always returns a copy, so there is no need to specify this.", FutureWarning, stacklevel=find_stack_level())
    ...
    def xs(self, key, axis=0, level=None, drop_level: bool_t=True):
        ...
        if isinstance(key, list):
            warnings.warn('Passing lists as key for xs is deprecated and will be removed in a future version. Pass key as a tuple instead.', FutureWarning, stacklevel=find_stack_level())
        if level is not None:
    ...
    @final
    def reindex_like(self: NDFrameT, other, method: str | None=None, copy: bool_t=True, limit=None, tolerance=None) -> NDFrameT:
        """
    ...
    @final
    def _drop_axis(self: NDFrameT, labels, axis, level=None, errors: str='raise', consolidate: bool_t=True, only_slice: bool_t=False) -> NDFrameT:
        """
        ...
        new_mgr = self._mgr.reindex_indexer(new_axis, indexer, axis=bm_axis, allow_dups=True, consolidate=consolidate, only_slice=only_slice)
    ...
    def sort_values(self, axis=0, ascending=True, inplace: bool_t=False, kind: str='quicksort', na_position: str='last', ignore_index: bool_t=False, key: ValueKeyFunc=None):
        """
    ...
    def sort_index(self, axis=0, level=None, ascending: bool_t | int | Sequence[bool_t | int]=True, inplace: bool_t=False, kind: str='quicksort', na_position: str='last', sort_remaining: bool_t=True, ignore_index: bool_t=False, key: IndexKeyFunc=None):
        inplace = validate_bool_kwarg(inplace, 'inplace')
        axis = self._get_axis_number(axis)
    ...
    @final
    def _reindex_with_indexers(self: NDFrameT, reindexers, fill_value=None, copy: bool_t=False, allow_dups: bool_t=False) -> NDFrameT:
    ...
    @final
    def sample(self: NDFrameT, n: int | None=None, frac: float | None=None, replace: bool_t=False, weights=None, random_state: RandomState | None=None, axis: Axis | None=None, ignore_index: bool_t=False) -> NDFrameT:
        """
    ...
    def astype(self: NDFrameT, dtype, copy: bool_t=True, errors: str='raise') -> NDFrameT:
        """
    ...
    @final
    def _convert(self: NDFrameT, datetime: bool_t=False, numeric: bool_t=False, timedelta: bool_t=False) -> NDFrameT:
        """
    ...
    @final
    def convert_dtypes(self: NDFrameT, infer_objects: bool_t=True, convert_string: bool_t=True, convert_integer: bool_t=True, convert_boolean: bool_t=True, convert_floating: bool_t=True) -> NDFrameT:
        """
    ...
    def fillna(self: NDFrameT, value=None, method=None, axis=None, inplace: bool_t=False, limit=None, downcast=None) -> NDFrameT | None:
        """
    ...
    @doc(klass=_shared_doc_kwargs['klass'])
    def ffill(self: NDFrameT, axis: None | Axis=None, inplace: bool_t=False, limit: None | int=None, downcast=None) -> NDFrameT | None:
        """
    ...
    @doc(klass=_shared_doc_kwargs['klass'])
    def bfill(self: NDFrameT, axis: None | Axis=None, inplace: bool_t=False, limit: None | int=None, downcast=None) -> NDFrameT | None:
        """
    ...
    def replace(self, to_replace=None, value=lib.no_default, inplace: bool_t=False, limit: int | None=None, regex=False, method=lib.no_default):
    ...
    def interpolate(self: NDFrameT, method: str='linear', axis: Axis=0, limit: int | None=None, inplace: bool_t=False, limit_direction: str | None=None, limit_area: str | None=None, downcast: str | None=None, **kwargs) -> NDFrameT | None:
        """
    ...
    def clip(self: NDFrameT, lower=None, upper=None, axis: Axis | None=None, inplace: bool_t=False, *args, **kwargs) -> NDFrameT | None:
        """
    ...
    @doc(**_shared_doc_kwargs)
    def asfreq(self: NDFrameT, freq, method=None, how: str | None=None, normalize: bool_t=False, fill_value=None) -> NDFrameT:
        """
    ...
    @final
    def between_time(self: NDFrameT, start_time, end_time, include_start: bool_t | lib.NoDefault=lib.no_default, include_end: bool_t | lib.NoDefault=lib.no_default, inclusive: str | None=None, axis=None) -> NDFrameT:
        """
        ...
        if old_include_arg_used and inclusive is not None:
            raise ValueError('Deprecated arguments `include_start` and `include_end` cannot be passed if `inclusive` has been given.')
        elif old_include_arg_used:
            warnings.warn('`include_start` and `include_end` are deprecated in favour of `inclusive`.', FutureWarning, stacklevel=find_stack_level())
            ...
            inc_dict = {(True, True): 'both', (True, False): 'left', (False, True): 'right', (False, False): 'neither'}
    ...
    @doc(**_shared_doc_kwargs)
    def resample(self, rule, axis=0, closed: str | None=None, label: str | None=None, convention: str='start', kind: str | None=None, loffset=None, base: int | None=None, on=None, level=None, origin: str | TimestampConvertibleTypes='start_day', offset: TimedeltaConvertibleTypes | None=None) -> Resampler:
        """
    ...
    @final
    def rank(self: NDFrameT, axis=0, method: str='average', numeric_only: bool_t | None | lib.NoDefault=lib.no_default, na_option: str='keep', ascending: bool_t=True, pct: bool_t=False) -> NDFrameT:
        """
        ...
        * pct_rank: when setting ``pct = True``, the ranking is expressed as
        ...
        if numeric_only is None:
            warnings.warn(f"'numeric_only=None' in {type(self).__name__}.rank is deprecated and will raise in a future version. Pass either 'True' or 'False'. 'False' will be the default.", FutureWarning, stacklevel=find_stack_level())
            warned = True
        ...
        def ranker(data):
            ...
            if isinstance(values, ExtensionArray):
                ranks = values._rank(axis=axis, method=method, ascending=ascending, na_option=na_option, pct=pct)
            else:
                ranks = algos.rank(values, axis=axis, method=method, ascending=ascending, na_option=na_option, pct=pct)
        ...
        if numeric_only is None:
            try:
                ...
                numeric_only = True
                if not warned:
                    warnings.warn(f'Dropping of nuisance columns in {type(self).__name__}.rank is deprecated; in a future version this will raise TypeError. Select only valid columns before calling rank.', FutureWarning, stacklevel=find_stack_level())
        if numeric_only:
    ...
    def compare(self, other, align_axis: Axis=1, keep_shape: bool_t=False, keep_equal: bool_t=False):
        from pandas.core.reshape.concat import concat
    ...
    @final
    def _where(self, cond, other=lib.no_default, inplace=False, axis=None, level=None, errors='raise'):
        """
        ...
        if isinstance(other, NDFrame):
            if other.ndim <= self.ndim:
                _, other = self.align(other, join='left', axis=axis, level=level, fill_value=None, copy=False)
    ...
    def where(self, cond, other=np.nan, inplace=False, axis=None, level=None, errors='raise', try_cast=lib.no_default):
        ...
        if try_cast is not lib.no_default:
            warnings.warn('try_cast keyword is deprecated and will be removed in a future version.', FutureWarning, stacklevel=find_stack_level())
    ...
    @doc(klass=_shared_doc_kwargs['klass'])
    def shift(self: NDFrameT, periods=1, freq=None, axis=0, fill_value=None) -> NDFrameT:
        """
    ...
    def tshift(self: NDFrameT, periods: int=1, freq=None, axis: Axis=0) -> NDFrameT:
        ...
        """
        warnings.warn('tshift is deprecated and will be removed in a future version. Please use shift instead.', FutureWarning, stacklevel=find_stack_level())
        if freq is None:
            freq = 'infer'
    ...
    @final
    def tz_localize(self: NDFrameT, tz, axis=0, level=None, copy: bool_t=True, ambiguous='raise', nonexistent: str='raise') -> NDFrameT:
        """
    ...
    @final
    def describe(self: NDFrameT, percentiles=None, include=None, exclude=None, datetime_is_numeric=False) -> NDFrameT:
        """
        ...
        max            NaN      3.0
        """
        return describe_ndframe(obj=self, include=include, exclude=exclude, datetime_is_numeric=datetime_is_numeric, percentiles=percentiles)
    ...
    @final
    def _logical_func(self, name: str, func, axis: Axis=0, bool_only: bool_t | None=None, skipna: bool_t=True, level: Level | None=None, **kwargs) -> Series | bool_t:
        nv.validate_logical_func((), kwargs, fname=name)
        validate_bool_kwarg(skipna, 'skipna', none_allowed=False)
        if level is not None:
            warnings.warn('Using the level keyword in DataFrame and Series aggregations is deprecated and will be removed in a future version. Use groupby instead. df.any(level=1) should use df.groupby(level=1).any()', FutureWarning, stacklevel=find_stack_level())
        ...
        if self.ndim > 1 and axis == 1 and (len(self._mgr.arrays) > 1) and all((x.ndim == 2 for x in self._mgr.arrays)) and (bool_only is not None) and (not kwargs):
            obj = self
            if bool_only:
    ...
    def any(self, axis: Axis=0, bool_only: bool_t | None=None, skipna: bool_t=True, level: Level | None=None, **kwargs) -> Series | bool_t:
        return self._logical_func('any', nanops.nanany, axis, bool_only, skipna, level, **kwargs)

    def all(self, axis: Axis=0, bool_only: bool_t | None=None, skipna: bool_t=True, level: Level | None=None, **kwargs) -> Series | bool_t:
    ...
    @final
    def _stat_function_ddof(self, name: str, func, axis: Axis | None=None, skipna: bool_t=True, level: Level | None=None, ddof: int=1, numeric_only: bool_t | None=None, **kwargs) -> Series | float:
        nv.validate_stat_ddof_func((), kwargs, fname=name)
        validate_bool_kwarg(skipna, 'skipna', none_allowed=False)
        if axis is None:
            axis = self._stat_axis_number
        if level is not None:
            warnings.warn('Using the level keyword in DataFrame and Series aggregations is deprecated and will be removed in a future version. Use groupby instead. df.var(level=1) should use df.groupby(level=1).var().', FutureWarning, stacklevel=find_stack_level())
    ...
    def sem(self, axis: Axis | None=None, skipna: bool_t=True, level: Level | None=None, ddof: int=1, numeric_only: bool_t | None=None, **kwargs) -> Series | float:
        return self._stat_function_ddof('sem', nanops.nansem, axis, skipna, level, ddof, numeric_only, **kwargs)

    def var(self, axis: Axis | None=None, skipna: bool_t=True, level: Level | None=None, ddof: int=1, numeric_only: bool_t | None=None, **kwargs) -> Series | float:
        return self._stat_function_ddof('var', nanops.nanvar, axis, skipna, level, ddof, numeric_only, **kwargs)

    def std(self, axis: Axis | None=None, skipna: bool_t=True, level: Level | None=None, ddof: int=1, numeric_only: bool_t | None=None, **kwargs) -> Series | float:
        return self._stat_function_ddof('std', nanops.nanstd, axis, skipna, level, ddof, numeric_only, **kwargs)

    @final
    def _stat_function(self, name: str, func, axis: Axis | None | lib.NoDefault=None, skipna: bool_t=True, level: Level | None=None, numeric_only: bool_t | None=None, **kwargs):
        if name == 'median':
        ...
        if axis is None and level is None and (self.ndim > 1):
            warnings.warn(f"In a future version, DataFrame.{name}(axis=None) will return a scalar {name} over the entire DataFrame. To retain the old behavior, use 'frame.{name}(axis=0)' or just 'frame.{name}()'", FutureWarning, stacklevel=find_stack_level())
        ...
        axis = cast(Axis, axis)
        if level is not None:
            warnings.warn('Using the level keyword in DataFrame and Series aggregations is deprecated and will be removed in a future version. Use groupby instead. df.median(level=1) should use df.groupby(level=1).median().', FutureWarning, stacklevel=find_stack_level())
            return self._agg_by_level(name, axis=axis, level=level, skipna=skipna, numeric_only=numeric_only)
        return self._reduce(func, name=name, axis=axis, skipna=skipna, numeric_only=numeric_only)

    def min(self, axis: Axis | None | lib.NoDefault=lib.no_default, skipna: bool_t=True, level: Level | None=None, numeric_only: bool_t | None=None, **kwargs):
        return self._stat_function('min', nanops.nanmin, axis, skipna, level, numeric_only, **kwargs)

    def max(self, axis: Axis | None | lib.NoDefault=lib.no_default, skipna: bool_t=True, level: Level | None=None, numeric_only: bool_t | None=None, **kwargs):
        return self._stat_function('max', nanops.nanmax, axis, skipna, level, numeric_only, **kwargs)

    def mean(self, axis: Axis | None | lib.NoDefault=lib.no_default, skipna: bool_t=True, level: Level | None=None, numeric_only: bool_t | None=None, **kwargs) -> Series | float:
        return self._stat_function('mean', nanops.nanmean, axis, skipna, level, numeric_only, **kwargs)

    def median(self, axis: Axis | None | lib.NoDefault=lib.no_default, skipna: bool_t=True, level: Level | None=None, numeric_only: bool_t | None=None, **kwargs) -> Series | float:
        return self._stat_function('median', nanops.nanmedian, axis, skipna, level, numeric_only, **kwargs)

    def skew(self, axis: Axis | None | lib.NoDefault=lib.no_default, skipna: bool_t=True, level: Level | None=None, numeric_only: bool_t | None=None, **kwargs) -> Series | float:
        return self._stat_function('skew', nanops.nanskew, axis, skipna, level, numeric_only, **kwargs)

    def kurt(self, axis: Axis | None | lib.NoDefault=lib.no_default, skipna: bool_t=True, level: Level | None=None, numeric_only: bool_t | None=None, **kwargs) -> Series | float:
        return self._stat_function('kurt', nanops.nankurt, axis, skipna, level, numeric_only, **kwargs)
    kurtosis = kurt

    @final
    def _min_count_stat_function(self, name: str, func, axis: Axis | None=None, skipna: bool_t=True, level: Level | None=None, numeric_only: bool_t | None=None, min_count: int=0, **kwargs):
        if name == 'sum':
        ...
        if axis is None:
            axis = self._stat_axis_number
        if level is not None:
            warnings.warn('Using the level keyword in DataFrame and Series aggregations is deprecated and will be removed in a future version. Use groupby instead. df.sum(level=1) should use df.groupby(level=1).sum().', FutureWarning, stacklevel=find_stack_level())
            return self._agg_by_level(name, axis=axis, level=level, skipna=skipna, min_count=min_count, numeric_only=numeric_only)
        return self._reduce(func, name=name, axis=axis, skipna=skipna, numeric_only=numeric_only, min_count=min_count)

    def sum(self, axis: Axis | None=None, skipna: bool_t=True, level: Level | None=None, numeric_only: bool_t | None=None, min_count=0, **kwargs):
        return self._min_count_stat_function('sum', nanops.nansum, axis, skipna, level, numeric_only, min_count, **kwargs)

    def prod(self, axis: Axis | None=None, skipna: bool_t=True, level: Level | None=None, numeric_only: bool_t | None=None, min_count: int=0, **kwargs):
    ...
    def mad(self, axis: Axis | None=None, skipna: bool_t=True, level: Level | None=None) -> Series | float:
        ...
        if not is_bool(skipna):
            warnings.warn('Passing None for skipna is deprecated and will raise in a futureversion. Pass True instead. Only boolean values will be allowed in the future.', FutureWarning, stacklevel=find_stack_level())
            skipna = True
        if axis is None:
            axis = self._stat_axis_number
        if level is not None:
            warnings.warn('Using the level keyword in DataFrame and Series aggregations is deprecated and will be removed in a future version. Use groupby instead. df.mad(level=1) should use df.groupby(level=1).mad()', FutureWarning, stacklevel=find_stack_level())
    ...
    def _add_numeric_operations(cls):
        ...
        @doc(NDFrame.mad.__doc__, desc='Return the mean absolute deviation of the values over the requested axis.', name1=name1, name2=name2, axis_descr=axis_descr, see_also='', examples='')
        def mad(self, axis=None, skipna=True, level=None):
            return NDFrame.mad(self, axis, skipna, level)
        setattr(cls, 'mad', mad)

        @doc(_num_ddof_doc, desc='Return unbiased standard error of the mean over requested axis.\n\nNormalized by N-1 by default. This can be changed using the ddof argument', name1=name1, name2=name2, axis_descr=axis_descr, notes='', examples='')
        def sem(self, axis=None, skipna=True, level=None, ddof=1, numeric_only=None, **kwargs):
            return NDFrame.sem(self, axis, skipna, level, ddof, numeric_only, **kwargs)
        setattr(cls, 'sem', sem)

        @doc(_num_ddof_doc, desc='Return unbiased variance over requested axis.\n\nNormalized by N-1 by default. This can be changed using the ddof argument.', name1=name1, name2=name2, axis_descr=axis_descr, notes='', examples=_var_examples)
        ...
        @doc(_num_ddof_doc, desc='Return sample standard deviation over requested axis.\n\nNormalized by N-1 by default. This can be changed using the ddof argument.', name1=name1, name2=name2, axis_descr=axis_descr, notes=_std_notes, examples=_std_examples)
        ...
        def median(self, axis: int | None | lib.NoDefault=lib.no_default, skipna=True, level=None, numeric_only=None, **kwargs):
            return NDFrame.median(self, axis, skipna, level, numeric_only, **kwargs)
        setattr(cls, 'median', median)

        @doc(_num_doc, desc='Return the maximum of the values over the requested axis.\n\nIf you want the *index* of the maximum, use ``idxmax``. This is the equivalent of the ``numpy.ndarray`` method ``argmax``.', name1=name1, name2=name2, axis_descr=axis_descr, min_count='', see_also=_stat_func_see_also, examples=_max_examples)
        ...
        @doc(_num_doc, desc='Return the minimum of the values over the requested axis.\n\nIf you want the *index* of the minimum, use ``idxmin``. This is the equivalent of the ``numpy.ndarray`` method ``argmin``.', name1=name1, name2=name2, axis_descr=axis_descr, min_count='', see_also=_stat_func_see_also, examples=_min_examples)
    ...
    @final
    @doc(Rolling)
    def rolling(self, window: int | timedelta | BaseOffset | BaseIndexer, min_periods: int | None=None, center: bool_t=False, win_type: str | None=None, on: str | None=None, axis: Axis=0, closed: str | None=None, method: str='single'):
        axis = self._get_axis_number(axis)
    ...
    @final
    @doc(Expanding)
    def expanding(self, min_periods: int=1, center: bool_t | None=None, axis: Axis=0, method: str='single') -> Expanding:
        axis = self._get_axis_number(axis)
        if center is not None:
            warnings.warn('The `center` argument on `expanding` will be removed in the future.', FutureWarning, stacklevel=find_stack_level())
        else:
            center = False
    ...
    def ewm(self, com: float | None=None, span: float | None=None, halflife: float | TimedeltaConvertibleTypes | None=None, alpha: float | None=None, min_periods: int | None=0, adjust: bool_t=True, ignore_na: bool_t=False, axis: Axis=0, times: str | np.ndarray | DataFrame | Series | None=None, method: str='single') -> ExponentialMovingWindow:
        axis = self._get_axis_number(axis)
