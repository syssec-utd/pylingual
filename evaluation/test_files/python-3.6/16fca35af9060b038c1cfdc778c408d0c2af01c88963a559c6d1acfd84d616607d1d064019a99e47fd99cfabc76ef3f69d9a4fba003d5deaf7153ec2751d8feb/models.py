...
class UnetEIPAddrSetSchema(schema.ResponseSchema):
    ...
    fields = {'IP': fields.Str(required=False, load_from='IP'), 'OperatorName': fields.Str(required=False, load_from='OperatorName')}

class UnetAllocateEIPSetSchema(schema.ResponseSchema):
    """UnetAllocateEIPSet - AllocateEIP"""
    fields = {'EIPAddr': fields.List(UnetEIPAddrSetSchema()), 'EIPId': fields.Str(required=False, load_from='EIPId')}
