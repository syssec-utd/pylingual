...
class IntervalIndex(ExtensionIndex):
    ...
    def __new__(cls, data, closed=None, dtype: Dtype | None=None, copy: bool=False, name: Hashable=None, verify_integrity: bool=True) -> IntervalIndex:
    ...
    def from_breaks(cls, breaks, closed: str='right', name: Hashable=None, copy: bool=False, dtype: Dtype | None=None) -> IntervalIndex:
        with rewrite_exception('IntervalArray', cls.__name__):
    ...
    def from_arrays(cls, left, right, closed: str='right', name: Hashable=None, copy: bool=False, dtype: Dtype | None=None) -> IntervalIndex:
        with rewrite_exception('IntervalArray', cls.__name__):
    ...
    def from_tuples(cls, data, closed: str='right', name: Hashable=None, copy: bool=False, dtype: Dtype | None=None) -> IntervalIndex:
        with rewrite_exception('IntervalArray', cls.__name__):
...
def interval_range(start=None, end=None, periods=None, freq=None, name: Hashable=None, closed='right') -> IntervalIndex:
    """
