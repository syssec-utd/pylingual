...
class SetAdministratorTitle:
    ...
    async def set_administrator_title(self: 'pyrogram.Client', chat_id: Union[int, str], user_id: Union[int, str], title: str) -> bool:
        ...
        r = (await self.invoke(raw.functions.channels.GetParticipant(channel=chat_id, participant=user_id))).participant
        ...
        await self.invoke(raw.functions.channels.EditAdmin(channel=chat_id, user_id=user_id, admin_rights=admin_rights, rank=title))
        return True