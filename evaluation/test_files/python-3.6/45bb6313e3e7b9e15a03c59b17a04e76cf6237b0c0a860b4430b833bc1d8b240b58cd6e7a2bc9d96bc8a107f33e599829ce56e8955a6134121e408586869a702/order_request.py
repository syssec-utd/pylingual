...
class OrderRequest(object):
    ...
    openapi_types = {'properties': 'dict(str, PerpetualProperty)', 'instrument_identifiers': 'dict(str, str)', 'quantity': 'float', 'side': 'str', 'order_book_id': 'ResourceId', 'portfolio_id': 'ResourceId', 'id': 'ResourceId', 'state': 'str', 'type': 'str', 'time_in_force': 'str', 'date': 'datetime', 'price': 'CurrencyAndAmount', 'limit_price': 'CurrencyAndAmount', 'stop_price': 'CurrencyAndAmount', 'order_instruction': 'ResourceId', 'package': 'ResourceId'}
    attribute_map = {'properties': 'properties', 'instrument_identifiers': 'instrumentIdentifiers', 'quantity': 'quantity', 'side': 'side', 'order_book_id': 'orderBookId', 'portfolio_id': 'portfolioId', 'id': 'id', 'state': 'state', 'type': 'type', 'time_in_force': 'timeInForce', 'date': 'date', 'price': 'price', 'limit_price': 'limitPrice', 'stop_price': 'stopPrice', 'order_instruction': 'orderInstruction', 'package': 'package'}
    required_map = {'properties': 'optional', 'instrument_identifiers': 'required', 'quantity': 'required', 'side': 'required', 'order_book_id': 'optional', 'portfolio_id': 'required', 'id': 'required', 'state': 'optional', 'type': 'optional', 'time_in_force': 'optional', 'date': 'optional', 'price': 'optional', 'limit_price': 'optional', 'stop_price': 'optional', 'order_instruction': 'optional', 'package': 'optional'}

    def __init__(self, properties=None, instrument_identifiers=None, quantity=None, side=None, order_book_id=None, portfolio_id=None, id=None, state=None, type=None, time_in_force=None, date=None, price=None, limit_price=None, stop_price=None, order_instruction=None, package=None, local_vars_configuration=None):
    ...
    def instrument_identifiers(self, instrument_identifiers):
        ...
        :type instrument_identifiers: dict(str, str)
        """
        if self.local_vars_configuration.client_side_validation and instrument_identifiers is None:
            raise ValueError('Invalid value for `instrument_identifiers`, must not be `None`')
    ...
    def side(self, side):
        ...
        :type side: str
        """
        if self.local_vars_configuration.client_side_validation and side is None:
    ...
    def portfolio_id(self, portfolio_id):
        ...
        :type portfolio_id: lusid.ResourceId
        """
        if self.local_vars_configuration.client_side_validation and portfolio_id is None:
