...
class ChildrenHavingExpressionAttributeMixin(object):
    ...
    def getVisitableNodes(self):
        """The visitable nodes, with tuple values flattened."""
        return (self.subnode_expression, self.subnode_attribute)
    ...
    def getVisitableNodesNamed(self):
        ...
        For use in cloning nodes, debugging and XML output.
        """
        return (('expression', self.subnode_expression), ('attribute', self.subnode_attribute))
    ...
    def getCloneArgs(self):
        ...
        Needs to make clones of child nodes too.
        """
        values = {'expression': self.subnode_expression.makeClone(), 'attribute': self.subnode_attribute.makeClone()}
        values.update(self.getDetails())
        return values
...
class ChildrenHavingExpressionAttributeValueMixin(object):
    ...
    def __init__(self, expression, attribute, value):
        expression.parent = self
        self.subnode_expression = expression
        attribute.parent = self
        self.subnode_attribute = attribute
    ...
    def getVisitableNodes(self):
        """The visitable nodes, with tuple values flattened."""
        return (self.subnode_expression, self.subnode_attribute, self.subnode_value)
    ...
    def getVisitableNodesNamed(self):
        ...
        For use in cloning nodes, debugging and XML output.
        """
        return (('expression', self.subnode_expression), ('attribute', self.subnode_attribute), ('value', self.subnode_value))
    ...
    def getCloneArgs(self):
        ...
        Needs to make clones of child nodes too.
        """
        values = {'expression': self.subnode_expression.makeClone(), 'attribute': self.subnode_attribute.makeClone(), 'value': self.subnode_value.makeClone()}
        values.update(self.getDetails())
        return values
