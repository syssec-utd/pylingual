...
from pandas.core.dtypes.common import is_categorical_dtype, is_dtype_equal, is_object_dtype
import pandas as pd
...
def test_memory_usage(index_or_series_obj):
    ...
    is_object_string = is_dtype_equal(obj, 'string[python]') or (is_ser and is_dtype_equal(obj.index.dtype, 'string[python]'))
    if len(obj) == 0:
