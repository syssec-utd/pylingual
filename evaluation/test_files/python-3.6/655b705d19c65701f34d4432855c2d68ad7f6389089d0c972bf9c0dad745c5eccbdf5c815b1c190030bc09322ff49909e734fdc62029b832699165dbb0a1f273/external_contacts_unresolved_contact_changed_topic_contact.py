...
class ExternalContactsUnresolvedContactChangedTopicContact(object):
    ...
    def __init__(self):
        ...
        """
        self.swagger_types = {'id': 'str', 'type': 'str', 'first_name': 'str', 'middle_name': 'str', 'last_name': 'str', 'salutation': 'str', 'title': 'str', 'work_phone': 'ExternalContactsUnresolvedContactChangedTopicPhoneNumber', 'cell_phone': 'ExternalContactsUnresolvedContactChangedTopicPhoneNumber', 'home_phone': 'ExternalContactsUnresolvedContactChangedTopicPhoneNumber', 'other_phone': 'ExternalContactsUnresolvedContactChangedTopicPhoneNumber', 'work_email': 'str', 'personal_email': 'str', 'other_email': 'str', 'address': 'ExternalContactsUnresolvedContactChangedTopicContactAddress', 'survey_opt_out': 'bool', 'external_system_url': 'str', 'twitter_id': 'ExternalContactsUnresolvedContactChangedTopicTwitterId', 'line_id': 'ExternalContactsUnresolvedContactChangedTopicLineId', 'whats_app_id': 'ExternalContactsUnresolvedContactChangedTopicWhatsAppId', 'facebook_id': 'ExternalContactsUnresolvedContactChangedTopicFacebookId'}
        self.attribute_map = {'id': 'id', 'type': 'type', 'first_name': 'firstName', 'middle_name': 'middleName', 'last_name': 'lastName', 'salutation': 'salutation', 'title': 'title', 'work_phone': 'workPhone', 'cell_phone': 'cellPhone', 'home_phone': 'homePhone', 'other_phone': 'otherPhone', 'work_email': 'workEmail', 'personal_email': 'personalEmail', 'other_email': 'otherEmail', 'address': 'address', 'survey_opt_out': 'surveyOptOut', 'external_system_url': 'externalSystemUrl', 'twitter_id': 'twitterId', 'line_id': 'lineId', 'whats_app_id': 'whatsAppId', 'facebook_id': 'facebookId'}
        self._id = None
        self._type = None
