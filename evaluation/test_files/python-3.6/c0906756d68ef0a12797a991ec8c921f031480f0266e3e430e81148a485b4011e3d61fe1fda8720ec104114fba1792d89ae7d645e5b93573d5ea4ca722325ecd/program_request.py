...
class ProgramRequest(object):
    ...
    def __init__(self) -> None:
        ...
        """
        self.swagger_types = {'name': 'str', 'description': 'str', 'topic_ids': 'list[str]', 'tags': 'list[str]'}
        self.attribute_map = {'name': 'name', 'description': 'description', 'topic_ids': 'topicIds', 'tags': 'tags'}
        self._name = None
