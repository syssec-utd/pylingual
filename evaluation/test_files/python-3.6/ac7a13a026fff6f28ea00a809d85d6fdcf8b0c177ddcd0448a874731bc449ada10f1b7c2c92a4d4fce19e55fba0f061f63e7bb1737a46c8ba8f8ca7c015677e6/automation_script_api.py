...
class AutomationScriptAPI(object):
    ...
    swagger_types = {'arguments': 'list[Argument]', 'comment': 'str', 'context_keys': 'list[str]', 'depends_on': 'dict(str, list[str])', 'deprecated': 'bool', 'docker_image': 'str', 'enabled': 'bool', 'hidden': 'bool', 'id': 'str', 'locked': 'bool', 'modified': 'datetime', 'name': 'str', 'outputs': 'list[Output]', 'permitted': 'bool', 'roles': 'list[str]', 'run_as': 'str', 'script_target': 'ScriptTarget', 'system': 'bool', 'tags': 'list[str]', 'type': 'ScriptType', 'user': 'str', 'version': 'int'}
    attribute_map = {'arguments': 'arguments', 'comment': 'comment', 'context_keys': 'contextKeys', 'depends_on': 'dependsOn', 'deprecated': 'deprecated', 'docker_image': 'dockerImage', 'enabled': 'enabled', 'hidden': 'hidden', 'id': 'id', 'locked': 'locked', 'modified': 'modified', 'name': 'name', 'outputs': 'outputs', 'permitted': 'permitted', 'roles': 'roles', 'run_as': 'runAs', 'script_target': 'scriptTarget', 'system': 'system', 'tags': 'tags', 'type': 'type', 'user': 'user', 'version': 'version'}

    def __init__(self, arguments=None, comment=None, context_keys=None, depends_on=None, deprecated=None, docker_image=None, enabled=None, hidden=None, id=None, locked=None, modified=None, name=None, outputs=None, permitted=None, roles=None, run_as=None, script_target=None, system=None, tags=None, type=None, user=None, version=None):
        """AutomationScriptAPI - a model defined in Swagger"""
