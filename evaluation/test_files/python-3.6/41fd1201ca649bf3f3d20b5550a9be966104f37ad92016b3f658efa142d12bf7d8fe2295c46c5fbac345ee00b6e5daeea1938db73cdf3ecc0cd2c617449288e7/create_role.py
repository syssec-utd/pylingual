...
class CreateRole(object):
    ...
    openapi_types = {'analytics_access': 'str', 'audit_access': 'str', 'comment': 'str', 'gw_analytics_access': 'str', 'json': 'bool', 'name': 'str', 'sra_reports_access': 'str', 'token': 'str', 'uid_token': 'str'}
    attribute_map = {'analytics_access': 'analytics-access', 'audit_access': 'audit-access', 'comment': 'comment', 'gw_analytics_access': 'gw-analytics-access', 'json': 'json', 'name': 'name', 'sra_reports_access': 'sra-reports-access', 'token': 'token', 'uid_token': 'uid-token'}

    def __init__(self, analytics_access=None, audit_access=None, comment=None, gw_analytics_access=None, json=None, name=None, sra_reports_access=None, token=None, uid_token=None, local_vars_configuration=None):
