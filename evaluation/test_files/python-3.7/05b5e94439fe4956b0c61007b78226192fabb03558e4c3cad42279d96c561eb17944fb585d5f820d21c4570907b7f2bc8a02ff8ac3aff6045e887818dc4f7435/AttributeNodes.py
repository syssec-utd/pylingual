...
from .ChildrenHavingMixins import ChildHavingExpressionMixin, ChildrenExpressionBuiltinGetattrMixin, ChildrenExpressionBuiltinHasattrMixin, ChildrenExpressionBuiltinSetattrMixin
from .ExpressionBases import ExpressionBase
from .NodeMakingHelpers import makeCompileTimeConstantReplacementNode, wrapExpressionWithNodeSideEffects
...
class ExpressionBuiltinSetattr(ChildrenExpressionBuiltinSetattrMixin, ExpressionBase):
    ...
    def __init__(self, expression, name, value, source_ref):
        ChildrenExpressionBuiltinSetattrMixin.__init__(self, expression=expression, attribute=name, value=value)
        ExpressionBase.__init__(self, source_ref)
...
class ExpressionBuiltinHasattr(ChildrenExpressionBuiltinHasattrMixin, ExpressionBase):
    ...
    def __init__(self, expression, name, source_ref):
        ChildrenExpressionBuiltinHasattrMixin.__init__(self, expression=expression, attribute=name)
        ExpressionBase.__init__(self, source_ref)
