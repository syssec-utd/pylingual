...
import uuid
import frozendict
from openapi_streams import schemas

class AddressesTypesAddressesResponse(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class result(schemas.ListSchema):
                ...
                def __new__(cls, arg: typing.Union[typing.Tuple['Addresses'], typing.List['Addresses']], _configuration: typing.Optional[schemas.Configuration]=None) -> 'result':
            ...
            __annotations__ = {'result': result, 'total': total, 'cursor': cursor}
    ...
    def __new__(cls, *args: typing.Union[dict, frozendict.frozendict], result: typing.Union[MetaOapg.properties.result, list, tuple], total: typing.Union[MetaOapg.properties.total, decimal.Decimal, int, float], cursor: typing.Union[MetaOapg.properties.cursor, str, schemas.Unset]=schemas.unset, _configuration: typing.Optional[schemas.Configuration]=None) -> 'AddressesTypesAddressesResponse':
        return super().__new__(cls, *args, result=result, total=total, cursor=cursor, _configuration=_configuration)
