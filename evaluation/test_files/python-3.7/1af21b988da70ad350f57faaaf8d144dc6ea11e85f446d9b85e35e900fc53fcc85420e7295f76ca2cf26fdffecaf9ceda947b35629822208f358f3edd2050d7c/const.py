...
PLACEHOLDERS = {'api_key_url': 'https://steamcommunity.com/dev/apikey', 'account_id_url': 'https://steamid.io'}
...
STEAM_STATUSES = {0: STATE_OFFLINE, 1: STATE_ONLINE, 2: STATE_BUSY, 3: STATE_AWAY, 4: STATE_SNOOZE, 5: STATE_LOOKING_TO_TRADE, 6: STATE_LOOKING_TO_PLAY}
