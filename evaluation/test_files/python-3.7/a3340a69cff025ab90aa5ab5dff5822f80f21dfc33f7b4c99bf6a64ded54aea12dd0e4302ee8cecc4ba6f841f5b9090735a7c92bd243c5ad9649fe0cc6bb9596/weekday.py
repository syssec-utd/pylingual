...
class BranchDayOfWeekOperator(BaseBranchOperator):
    ...
    def __init__(self, *, follow_task_ids_if_true: Union[str, Iterable[str]], follow_task_ids_if_false: Union[str, Iterable[str]], week_day: Union[str, Iterable[str]], use_task_execution_day: bool=False, **kwargs) -> None:
