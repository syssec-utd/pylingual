...
class InteractiveShellTestCase(unittest.TestCase):
    ...
    def test_ofind_line_magic(self):
        ...
        info = dict(found=True, isalias=False, ismagic=True, namespace='IPython internal', obj=lmagic, parent=None)
    ...
    def test_ofind_cell_magic(self):
        ...
        info = dict(found=True, isalias=False, ismagic=True, namespace='IPython internal', obj=cmagic, parent=None)
    ...
    def test_ofind_property_with_error(self):
        ...
        info = dict(found=True, isalias=False, ismagic=False, namespace='locals', obj=A.foo, parent=a)
    ...
    def test_ofind_multiple_attribute_lookups(self):
        ...
        info = dict(found=True, isalias=False, ismagic=False, namespace='locals', obj=A.foo, parent=a.a.a)
        self.assertEqual(found, info)
    ...
    def test_ofind_slotted_attributes(self):
        ...
        info = dict(found=False, isalias=False, ismagic=False, namespace=None, obj=None, parent=a)
        self.assertEqual(found, info)
