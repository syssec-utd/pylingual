...
class NiatelemetryCloudDetailsResponse(ModelComposed):
    ...
    def openapi_types():
        ...
        """
        lazy_import()
        return {'object_type': (str,), 'count': (int,), 'results': ([MoTagKeySummary], none_type)}

    @cached_property
    def discriminator():
        lazy_import()
        val = {'mo.AggregateTransform': MoAggregateTransform, 'mo.DocumentCount': MoDocumentCount, 'mo.TagSummary': MoTagSummary, 'niatelemetry.CloudDetails.List': NiatelemetryCloudDetailsList}
        if not val:
            return None
        return {'object_type': val}
    attribute_map = {'object_type': 'ObjectType', 'count': 'Count', 'results': 'Results'}
    read_only_vars = {}

    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, object_type, *args, **kwargs):
        """NiatelemetryCloudDetailsResponse - a model defined in OpenAPI
        ...
        required_args = {'object_type': object_type}
    ...
    def _composed_schemas():
        lazy_import()
        return {'anyOf': [], 'allOf': [], 'oneOf': [MoAggregateTransform, MoDocumentCount, MoTagSummary, NiatelemetryCloudDetailsList]}