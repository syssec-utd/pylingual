...
from pyrfuniverse.registry.binary_utils import load_local_manifest, load_remote_manifest
...
default_registry.register_from_yaml('https://storage.googleapis.com/mlagents-test-environments/1.0.0/manifest.yaml')