...
def load_pdfcredential_settings():
    ...
    param_tools.registry.add('global', app_settings.ParametersForm, ugettext_lazy('PDF credentials'))
    param_tools.registry.add2('global', 'pdfcredentials', ugettext_lazy('PDF Credentials'), app_settings.PDF_CREDENTIALS_PARAMETERS_STRUCT, serializers.PDFCredentialsSettingsSerializer, True)
