...
identity_columns = Table('identity_columns', ischema, Column('object_id', Integer), Column('name', CoerceUnicode), Column('is_identity', Boolean), Column('seed_value', IdentitySqlVariant), Column('increment_value', IdentitySqlVariant), Column('last_value', IdentitySqlVariant), Column('is_not_for_replication', Boolean), schema='sys')