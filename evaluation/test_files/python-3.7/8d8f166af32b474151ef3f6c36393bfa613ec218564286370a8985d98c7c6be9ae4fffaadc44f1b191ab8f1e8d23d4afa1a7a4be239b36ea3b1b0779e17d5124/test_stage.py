...
TEST_STAGE_DICT = {'md5': '123456', 'cmd': 'mycmd', 'outs': [{'path': 'a', 'md5': '123456789'}], 'deps': [{'path': 'b', 'md5': '987654321'}]}
...
def test_stage_update(dvc, mocker):
    ...
    is_repo_import = mocker.patch(__name__ + '.Stage.is_repo_import', new_callable=mocker.PropertyMock)
...
@pytest.mark.skipif(not isinstance(threading.current_thread(), threading._MainThread), reason='Not running in the main thread.')
