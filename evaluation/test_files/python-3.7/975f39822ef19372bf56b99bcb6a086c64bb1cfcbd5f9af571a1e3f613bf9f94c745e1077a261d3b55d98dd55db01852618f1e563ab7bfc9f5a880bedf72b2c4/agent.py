...
class InformationRetrievalAgentConfig(AgentConfig, type=AgentType.INFORMATION_RETRIEVAL):
...
class WebSocketAgentTextEndMessage(WebSocketAgentMessage, type=WebSocketAgentMessageType.TEXT_END):
    pass