    ...
    def wsgi_app(self, environ, start_response):
        ...
        for (k, v) in environ.items():
            if k.startswith('HTTP_'):
                ...
                headers[h] = v
        req = Request(self, (environ['REMOTE_ADDR'], int(environ.get('REMOTE_PORT', '0'))), environ['REQUEST_METHOD'], path, environ['SERVER_PROTOCOL'], headers, stream=environ['wsgi.input'], sock=environ.get('gunicorn.socket'))
        req.environ = environ
