...
class AgentPoolAvailableVersions(_serialization.Model):
    ...
    """
    _validation = {'id': {'readonly': True}, 'name': {'readonly': True}, 'type': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'agent_pool_versions': {'key': 'properties.agentPoolVersions', 'type': '[AgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem]'}}

    def __init__(self, *, agent_pool_versions: Optional[List['_models.AgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem']]=None, **kwargs: Any) -> None:
        """
...
class AgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem(_serialization.Model):
    ...
    """
    _attribute_map = {'default': {'key': 'default', 'type': 'bool'}, 'kubernetes_version': {'key': 'kubernetesVersion', 'type': 'str'}, 'is_preview': {'key': 'isPreview', 'type': 'bool'}}

    def __init__(self, *, default: Optional[bool]=None, kubernetes_version: Optional[str]=None, is_preview: Optional[bool]=None, **kwargs: Any) -> None:
        """
...
class AgentPoolListResult(_serialization.Model):
    ...
    _attribute_map = {'value': {'key': 'value', 'type': '[AgentPool]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class AgentPoolUpgradeProfile(_serialization.Model):
    ...
    """
    _validation = {'id': {'readonly': True}, 'name': {'readonly': True}, 'type': {'readonly': True}, 'kubernetes_version': {'required': True}, 'os_type': {'required': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'kubernetes_version': {'key': 'properties.kubernetesVersion', 'type': 'str'}, 'os_type': {'key': 'properties.osType', 'type': 'str'}, 'upgrades': {'key': 'properties.upgrades', 'type': '[AgentPoolUpgradeProfilePropertiesUpgradesItem]'}}

    def __init__(self, *, kubernetes_version: str, os_type: Union[str, '_models.OSType']='Linux', upgrades: Optional[List['_models.AgentPoolUpgradeProfilePropertiesUpgradesItem']]=None, **kwargs: Any) -> None:
        """
...
class AgentPoolUpgradeProfilePropertiesUpgradesItem(_serialization.Model):
    ...
    :vartype is_preview: bool
    """
    _attribute_map = {'kubernetes_version': {'key': 'kubernetesVersion', 'type': 'str'}, 'is_preview': {'key': 'isPreview', 'type': 'bool'}}

    def __init__(self, *, kubernetes_version: Optional[str]=None, is_preview: Optional[bool]=None, **kwargs: Any) -> None:
        """
        :keyword kubernetes_version: Kubernetes version (major, minor, patch).
        :paramtype kubernetes_version: str
        :keyword is_preview: Whether Kubernetes version is currently in preview.
...
class CloudErrorBody(_serialization.Model):
    ...
    """
    _attribute_map = {'code': {'key': 'code', 'type': 'str'}, 'message': {'key': 'message', 'type': 'str'}, 'target': {'key': 'target', 'type': 'str'}, 'details': {'key': 'details', 'type': '[CloudErrorBody]'}}

    def __init__(self, *, code: Optional[str]=None, message: Optional[str]=None, target: Optional[str]=None, details: Optional[List['_models.CloudErrorBody']]=None, **kwargs: Any) -> None:
        """
...
class ContainerServiceDiagnosticsProfile(_serialization.Model):
    ...
    """
    _validation = {'vm_diagnostics': {'required': True}}
    _attribute_map = {'vm_diagnostics': {'key': 'vmDiagnostics', 'type': 'ContainerServiceVMDiagnostics'}}
...
class ContainerServiceLinuxProfile(_serialization.Model):
    ...
    """
    _validation = {'admin_username': {'required': True, 'pattern': '^[A-Za-z][-A-Za-z0-9_]*$'}, 'ssh': {'required': True}}
    _attribute_map = {'admin_username': {'key': 'adminUsername', 'type': 'str'}, 'ssh': {'key': 'ssh', 'type': 'ContainerServiceSshConfiguration'}}
...
class ContainerServiceMasterProfile(_serialization.Model):
    ...
    :vartype fqdn: str
    """
    _validation = {'dns_prefix': {'required': True}, 'vm_size': {'required': True}, 'os_disk_size_gb': {'maximum': 1023, 'minimum': 0}, 'fqdn': {'readonly': True}}
    _attribute_map = {'count': {'key': 'count', 'type': 'int'}, 'dns_prefix': {'key': 'dnsPrefix', 'type': 'str'}, 'vm_size': {'key': 'vmSize', 'type': 'str'}, 'os_disk_size_gb': {'key': 'osDiskSizeGB', 'type': 'int'}, 'vnet_subnet_id': {'key': 'vnetSubnetID', 'type': 'str'}, 'first_consecutive_static_ip': {'key': 'firstConsecutiveStaticIP', 'type': 'str'}, 'storage_profile': {'key': 'storageProfile', 'type': 'str'}, 'fqdn': {'key': 'fqdn', 'type': 'str'}}

    def __init__(self, *, dns_prefix: str, vm_size: Union[str, '_models.ContainerServiceVMSizeTypes'], count: Union[int, '_models.Count']=1, os_disk_size_gb: Optional[int]=None, vnet_subnet_id: Optional[str]=None, first_consecutive_static_ip: str='10.240.255.5', storage_profile: Optional[Union[str, '_models.ContainerServiceStorageProfileTypes']]=None, **kwargs: Any) -> None:
        """
...
class ContainerServiceNetworkProfile(_serialization.Model):
    ...
    """
    _validation = {'pod_cidr': {'pattern': '^([0-9]{1,3}\\.){3}[0-9]{1,3}(\\/([0-9]|[1-2][0-9]|3[0-2]))?$'}, 'service_cidr': {'pattern': '^([0-9]{1,3}\\.){3}[0-9]{1,3}(\\/([0-9]|[1-2][0-9]|3[0-2]))?$'}, 'dns_service_ip': {'pattern': '^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$'}, 'docker_bridge_cidr': {'pattern': '^([0-9]{1,3}\\.){3}[0-9]{1,3}(\\/([0-9]|[1-2][0-9]|3[0-2]))?$'}}
    _attribute_map = {'network_plugin': {'key': 'networkPlugin', 'type': 'str'}, 'network_policy': {'key': 'networkPolicy', 'type': 'str'}, 'pod_cidr': {'key': 'podCidr', 'type': 'str'}, 'service_cidr': {'key': 'serviceCidr', 'type': 'str'}, 'dns_service_ip': {'key': 'dnsServiceIP', 'type': 'str'}, 'docker_bridge_cidr': {'key': 'dockerBridgeCidr', 'type': 'str'}, 'load_balancer_sku': {'key': 'loadBalancerSku', 'type': 'str'}, 'load_balancer_profile': {'key': 'loadBalancerProfile', 'type': 'ManagedClusterLoadBalancerProfile'}}

    def __init__(self, *, network_plugin: Union[str, '_models.NetworkPlugin']='kubenet', network_policy: Optional[Union[str, '_models.NetworkPolicy']]=None, pod_cidr: str='10.244.0.0/16', service_cidr: str='10.0.0.0/16', dns_service_ip: str='10.0.0.10', docker_bridge_cidr: str='172.17.0.1/16', load_balancer_sku: Optional[Union[str, '_models.LoadBalancerSku']]=None, load_balancer_profile: Optional['_models.ManagedClusterLoadBalancerProfile']=None, **kwargs: Any) -> None:
        """
...
class ContainerServiceSshConfiguration(_serialization.Model):
    ...
    """
    _validation = {'public_keys': {'required': True}}
    _attribute_map = {'public_keys': {'key': 'publicKeys', 'type': '[ContainerServiceSshPublicKey]'}}
...
class ContainerServiceSshPublicKey(_serialization.Model):
    ...
    """
    _validation = {'key_data': {'required': True}}
    _attribute_map = {'key_data': {'key': 'keyData', 'type': 'str'}}
...
class ContainerServiceVMDiagnostics(_serialization.Model):
    ...
    """
    _validation = {'enabled': {'required': True}, 'storage_uri': {'readonly': True}}
    _attribute_map = {'enabled': {'key': 'enabled', 'type': 'bool'}, 'storage_uri': {'key': 'storageUri', 'type': 'str'}}
...
class CredentialResult(_serialization.Model):
    ...
    :vartype value: bytes
    """
    _validation = {'name': {'readonly': True}, 'value': {'readonly': True}}
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'value': {'key': 'value', 'type': 'bytearray'}}
...
class CredentialResults(_serialization.Model):
    ...
    """
    _validation = {'kubeconfigs': {'readonly': True}}
    _attribute_map = {'kubeconfigs': {'key': 'kubeconfigs', 'type': '[CredentialResult]'}}
...
class Resource(_serialization.Model):
    ...
    """
    _validation = {'id': {'readonly': True}, 'name': {'readonly': True}, 'type': {'readonly': True}, 'location': {'required': True}}
...
class ManagedClusterAADProfile(_serialization.Model):
    ...
    """
    _validation = {'client_app_id': {'required': True}, 'server_app_id': {'required': True}}
    _attribute_map = {'client_app_id': {'key': 'clientAppID', 'type': 'str'}, 'server_app_id': {'key': 'serverAppID', 'type': 'str'}, 'server_app_secret': {'key': 'serverAppSecret', 'type': 'str'}, 'tenant_id': {'key': 'tenantID', 'type': 'str'}}

    def __init__(self, *, client_app_id: str, server_app_id: str, server_app_secret: Optional[str]=None, tenant_id: Optional[str]=None, **kwargs: Any) -> None:
        """
...
class ManagedClusterAccessProfile(Resource):
    ...
    """
    _validation = {'id': {'readonly': True}, 'name': {'readonly': True}, 'type': {'readonly': True}, 'location': {'required': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'location': {'key': 'location', 'type': 'str'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'kube_config': {'key': 'properties.kubeConfig', 'type': 'bytearray'}}

    def __init__(self, *, location: str, tags: Optional[Dict[str, str]]=None, kube_config: Optional[bytes]=None, **kwargs: Any) -> None:
        """
        :keyword location: Resource location. Required.
        :paramtype location: str
        :keyword tags: Resource tags.
...
class ManagedClusterAddonProfile(_serialization.Model):
    ...
    _attribute_map = {'enabled': {'key': 'enabled', 'type': 'bool'}, 'config': {'key': 'config', 'type': '{str}'}}
...
class ManagedClusterAgentPoolProfile(ManagedClusterAgentPoolProfileProperties):
    ...
    :vartype name: str
    """
    _validation = {'os_disk_size_gb': {'maximum': 1023, 'minimum': 0}, 'provisioning_state': {'readonly': True}, 'name': {'required': True, 'pattern': '^[a-z][a-z0-9]{0,11}$'}}
    _attribute_map = {'count': {'key': 'count', 'type': 'int'}, 'vm_size': {'key': 'vmSize', 'type': 'str'}, 'os_disk_size_gb': {'key': 'osDiskSizeGB', 'type': 'int'}, 'vnet_subnet_id': {'key': 'vnetSubnetID', 'type': 'str'}, 'max_pods': {'key': 'maxPods', 'type': 'int'}, 'os_type': {'key': 'osType', 'type': 'str'}, 'max_count': {'key': 'maxCount', 'type': 'int'}, 'min_count': {'key': 'minCount', 'type': 'int'}, 'enable_auto_scaling': {'key': 'enableAutoScaling', 'type': 'bool'}, 'type': {'key': 'type', 'type': 'str'}, 'orchestrator_version': {'key': 'orchestratorVersion', 'type': 'str'}, 'provisioning_state': {'key': 'provisioningState', 'type': 'str'}, 'availability_zones': {'key': 'availabilityZones', 'type': '[str]'}, 'enable_node_public_ip': {'key': 'enableNodePublicIP', 'type': 'bool'}, 'scale_set_priority': {'key': 'scaleSetPriority', 'type': 'str'}, 'scale_set_eviction_policy': {'key': 'scaleSetEvictionPolicy', 'type': 'str'}, 'node_taints': {'key': 'nodeTaints', 'type': '[str]'}, 'name': {'key': 'name', 'type': 'str'}}

    def __init__(self, *, name: str, count: Optional[int]=None, vm_size: Optional[Union[str, '_models.ContainerServiceVMSizeTypes']]=None, os_disk_size_gb: Optional[int]=None, vnet_subnet_id: Optional[str]=None, max_pods: Optional[int]=None, os_type: Union[str, '_models.OSType']='Linux', max_count: Optional[int]=None, min_count: Optional[int]=None, enable_auto_scaling: Optional[bool]=None, type: Optional[Union[str, '_models.AgentPoolType']]=None, orchestrator_version: Optional[str]=None, availability_zones: Optional[List[str]]=None, enable_node_public_ip: Optional[bool]=None, scale_set_priority: Union[str, '_models.ScaleSetPriority']='Regular', scale_set_eviction_policy: Union[str, '_models.ScaleSetEvictionPolicy']='Delete', node_taints: Optional[List[str]]=None, **kwargs: Any) -> None:
        """
        :keyword count: Number of agents (VMs) to host docker containers. Allowed values must be in the
         range of 1 to 100 (inclusive). The default value is 1.
        :paramtype count: int
...
class ManagedClusterAPIServerAccessProfile(_serialization.Model):
    ...
    """
    _attribute_map = {'authorized_ip_ranges': {'key': 'authorizedIPRanges', 'type': '[str]'}, 'enable_private_cluster': {'key': 'enablePrivateCluster', 'type': 'bool'}}

    def __init__(self, *, authorized_ip_ranges: Optional[List[str]]=None, enable_private_cluster: Optional[bool]=None, **kwargs: Any) -> None:
        """
...
class ManagedClusterIdentity(_serialization.Model):
    ...
    """
    _validation = {'principal_id': {'readonly': True}, 'tenant_id': {'readonly': True}}
    _attribute_map = {'principal_id': {'key': 'principalId', 'type': 'str'}, 'tenant_id': {'key': 'tenantId', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}}
...
class ManagedClusterListResult(_serialization.Model):
    ...
    """
    _validation = {'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[ManagedCluster]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class ManagedClusterLoadBalancerProfileManagedOutboundIPs(_serialization.Model):
    ...
    :vartype count: int
    """
    _validation = {'count': {'maximum': 100, 'minimum': 1}}
    _attribute_map = {'count': {'key': 'count', 'type': 'int'}}
...
class ManagedClusterLoadBalancerProfileOutboundIPPrefixes(_serialization.Model):
    ...
    :vartype public_ip_prefixes:
     list[~azure.mgmt.containerservice.v2019_08_01.models.ResourceReference]
    """
    _attribute_map = {'public_ip_prefixes': {'key': 'publicIPPrefixes', 'type': '[ResourceReference]'}}

    def __init__(self, *, public_ip_prefixes: Optional[List['_models.ResourceReference']]=None, **kwargs: Any) -> None:
        """
...
class ManagedClusterLoadBalancerProfileOutboundIPs(_serialization.Model):
    ...
    """
    _attribute_map = {'public_i_ps': {'key': 'publicIPs', 'type': '[ResourceReference]'}}
...
class ManagedClusterPoolUpgradeProfile(_serialization.Model):
    ...
    """
    _validation = {'kubernetes_version': {'required': True}, 'os_type': {'required': True}}
    _attribute_map = {'kubernetes_version': {'key': 'kubernetesVersion', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'os_type': {'key': 'osType', 'type': 'str'}, 'upgrades': {'key': 'upgrades', 'type': '[ManagedClusterPoolUpgradeProfileUpgradesItem]'}}

    def __init__(self, *, kubernetes_version: str, os_type: Union[str, '_models.OSType']='Linux', name: Optional[str]=None, upgrades: Optional[List['_models.ManagedClusterPoolUpgradeProfileUpgradesItem']]=None, **kwargs: Any) -> None:
        """
        :keyword kubernetes_version: Kubernetes version (major, minor, patch). Required.
        :paramtype kubernetes_version: str
...
class ManagedClusterServicePrincipalProfile(_serialization.Model):
    ...
    :vartype secret: str
    """
    _validation = {'client_id': {'required': True}}
    _attribute_map = {'client_id': {'key': 'clientId', 'type': 'str'}, 'secret': {'key': 'secret', 'type': 'str'}}
...
class ManagedClusterUpgradeProfile(_serialization.Model):
    ...
    """
    _validation = {'id': {'readonly': True}, 'name': {'readonly': True}, 'type': {'readonly': True}, 'control_plane_profile': {'required': True}, 'agent_pool_profiles': {'required': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'control_plane_profile': {'key': 'properties.controlPlaneProfile', 'type': 'ManagedClusterPoolUpgradeProfile'}, 'agent_pool_profiles': {'key': 'properties.agentPoolProfiles', 'type': '[ManagedClusterPoolUpgradeProfile]'}}

    def __init__(self, *, control_plane_profile: '_models.ManagedClusterPoolUpgradeProfile', agent_pool_profiles: List['_models.ManagedClusterPoolUpgradeProfile'], **kwargs: Any) -> None:
        """
...
class ManagedClusterWindowsProfile(_serialization.Model):
    ...
    """
    _validation = {'admin_username': {'required': True}}
    _attribute_map = {'admin_username': {'key': 'adminUsername', 'type': 'str'}, 'admin_password': {'key': 'adminPassword', 'type': 'str'}}
...
class OperationListResult(_serialization.Model):
    ...
    _attribute_map = {'value': {'key': 'value', 'type': '[OperationValue]'}}
...
class OperationValue(_serialization.Model):
    ...
    """
    _validation = {'origin': {'readonly': True}, 'name': {'readonly': True}, 'operation': {'readonly': True}, 'resource': {'readonly': True}, 'description': {'readonly': True}, 'provider': {'readonly': True}}
    _attribute_map = {'origin': {'key': 'origin', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'operation': {'key': 'display.operation', 'type': 'str'}, 'resource': {'key': 'display.resource', 'type': 'str'}, 'description': {'key': 'display.description', 'type': 'str'}, 'provider': {'key': 'display.provider', 'type': 'str'}}
