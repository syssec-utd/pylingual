...
class CorporateAction(object):
    ...
    openapi_types = {'corporate_action_code': 'str', 'description': 'str', 'announcement_date': 'datetime', 'ex_date': 'datetime', 'record_date': 'datetime', 'payment_date': 'datetime', 'transitions': 'list[CorporateActionTransition]'}
    attribute_map = {'corporate_action_code': 'corporateActionCode', 'description': 'description', 'announcement_date': 'announcementDate', 'ex_date': 'exDate', 'record_date': 'recordDate', 'payment_date': 'paymentDate', 'transitions': 'transitions'}
    required_map = {'corporate_action_code': 'required', 'description': 'optional', 'announcement_date': 'optional', 'ex_date': 'optional', 'record_date': 'optional', 'payment_date': 'optional', 'transitions': 'optional'}

    def __init__(self, corporate_action_code=None, description=None, announcement_date=None, ex_date=None, record_date=None, payment_date=None, transitions=None, local_vars_configuration=None):
    ...
    def corporate_action_code(self, corporate_action_code):
        ...
        :type corporate_action_code: str
        """
        if self.local_vars_configuration.client_side_validation and corporate_action_code is None:
            raise ValueError('Invalid value for `corporate_action_code`, must not be `None`')
