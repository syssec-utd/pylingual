...
class OnDeleteTests(TestCase):
    ...
    def test_protect(self):
        a = create_a('protect')
        msg = "Cannot delete some instances of model 'R' because they are referenced through protected foreign keys: 'A.protect'."
    ...
    def test_protect_multiple(self):
        ...
        msg = "Cannot delete some instances of model 'R' because they are referenced through protected foreign keys: 'A.protect', 'B.protect'."
        with self.assertRaisesMessage(ProtectedError, msg) as cm:
            a.protect.delete()
    ...
    def test_protect_path(self):
        ...
        a.protect.save()
        msg = "Cannot delete some instances of model 'P' because they are referenced through protected foreign keys: 'R.p'."
        with self.assertRaisesMessage(ProtectedError, msg) as cm:
            a.protect.p.delete()
        self.assertEqual(cm.exception.protected_objects, {a})
    ...
    def test_restrict(self):
        a = create_a('restrict')
        msg = "Cannot delete some instances of model 'R' because they are referenced through restricted foreign keys: 'A.restrict'."
    ...
    def test_restrict_multiple(self):
        ...
        msg = "Cannot delete some instances of model 'R' because they are referenced through restricted foreign keys: 'A.restrict', 'B3.restrict'."
        with self.assertRaisesMessage(RestrictedError, msg) as cm:
            a.restrict.delete()
    ...
    def test_restrict_path_cascade_indirect(self):
        ...
        a.restrict.save()
        msg = "Cannot delete some instances of model 'P' because they are referenced through restricted foreign keys: 'A.restrict'."
        with self.assertRaisesMessage(RestrictedError, msg) as cm:
            a.restrict.p.delete()
        self.assertEqual(cm.exception.restricted_objects, {a})
    ...
    def test_restrict_path_cascade_indirect_diamond(self):
        ...
        msg = "Cannot delete some instances of model 'B1' because they are referenced through restricted foreign keys: 'DeleteBottom.b1'."
        with self.assertRaisesMessage(RestrictedError, msg) as cm:
            b1.delete()
    ...
    def test_restrict_gfk_no_fast_delete(self):
        ...
        generic_delete_bottom = GenericDeleteBottom.objects.create(generic_b1=generic_b1, generic_b2=generic_b2)
        msg = "Cannot delete some instances of model 'GenericB1' because they are referenced through restricted foreign keys: 'GenericDeleteBottom.generic_b1'."
        with self.assertRaisesMessage(RestrictedError, msg) as cm:
            generic_b1.delete()
...
class DeletionTests(TestCase):
    ...
    def test_deletion_order(self):
        ...
        r_pk = r.pk
        r.delete()
        self.assertEqual(pre_delete_order, [(T, t2.pk), (T, t1.pk), (RChild, rchild.pk), (S, s2.pk), (S, s1.pk), (R, r_pk)])
        self.assertEqual(post_delete_order, [(T, t1.pk), (T, t2.pk), (RChild, rchild.pk), (S, s1.pk), (S, s2.pk), (R, r_pk)])
    ...
    def test_queryset_delete_returns_num_rows(self):
        ...
        existed_objs = {R._meta.label: R.objects.count(), HiddenUser._meta.label: HiddenUser.objects.count(), HiddenUserProfile._meta.label: HiddenUserProfile.objects.count()}
    ...
    def test_model_delete_returns_num_rows(self):
        ...
        r.m_set.add(m2)
        r.save()
        existed_objs = {R._meta.label: R.objects.count(), HiddenUser._meta.label: HiddenUser.objects.count(), MR._meta.label: MR.objects.count(), HiddenUserProfile._meta.label: HiddenUserProfile.objects.count(), M.m2m.through._meta.label: M.m2m.through.objects.count()}
    ...
    def test_only_referenced_fields_selected(self):
        ...
        expected_sql = str(Referrer.objects.only('id', 'unique_field').filter(origin__in=[origin]).query)
        ...
        for signal_name in ('pre_delete', 'post_delete'):
            with self.subTest(signal=signal_name):
                ...
                with self.assertNumQueries(2) as ctx:
                    origin.delete()
                self.assertIn(connection.ops.quote_name('large_field'), ctx.captured_queries[0]['sql'])
...
class FastDeleteTests(TestCase):
    ...
    def test_fast_delete_empty_no_update_can_self_select(self):
        ...
        """
        with self.assertNumQueries(1):
            self.assertEqual(User.objects.filter(avatar__desc='missing').delete(), (0, {}))
    ...
    def test_fast_delete_aggregation(self):
        Base.objects.create()
        with self.assertNumQueries(1):
            self.assertEqual(Base.objects.annotate(rels_count=models.Count('rels')).filter(rels_count=0).delete(), (1, {'delete.Base': 1}))
