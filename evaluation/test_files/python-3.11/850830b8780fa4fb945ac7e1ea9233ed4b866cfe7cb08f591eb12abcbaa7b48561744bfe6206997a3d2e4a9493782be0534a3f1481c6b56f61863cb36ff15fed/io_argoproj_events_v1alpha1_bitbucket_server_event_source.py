...
import re
import sys
from argo_workflows.model_utils import ApiTypeError, ModelComposed, ModelNormal, ModelSimple, cached_property, change_keys_js_to_python, convert_js_args_to_python_args, date, datetime, file_type, none_type, validate_get_composed_info
...
class IoArgoprojEventsV1alpha1BitbucketServerEventSource(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        lazy_import()
        return {'access_token': (SecretKeySelector,), 'bitbucketserver_base_url': (str,), 'delete_hook_on_finish': (bool,), 'events': ([str],), 'filter': (IoArgoprojEventsV1alpha1EventSourceFilter,), 'metadata': ({str: (str,)},), 'project_key': (str,), 'repositories': ([IoArgoprojEventsV1alpha1BitbucketServerRepository],), 'repository_slug': (str,), 'webhook': (IoArgoprojEventsV1alpha1WebhookContext,), 'webhook_secret': (SecretKeySelector,)}

    @cached_property
    def discriminator():
        return None
    attribute_map = {'access_token': 'accessToken', 'bitbucketserver_base_url': 'bitbucketserverBaseURL', 'delete_hook_on_finish': 'deleteHookOnFinish', 'events': 'events', 'filter': 'filter', 'metadata': 'metadata', 'project_key': 'projectKey', 'repositories': 'repositories', 'repository_slug': 'repositorySlug', 'webhook': 'webhook', 'webhook_secret': 'webhookSecret'}
    read_only_vars = {}
    _composed_schemas = {}
