...
class WebRTCEvent(object):
    ...
    openapi_types = {'id': 'int', 'model': 'WebRTCEventModel', 'created_dt': 'datetime', 'source': 'EventSource', 'event_name': 'WebRTCEventName', 'data': 'dict(str, object)', 'polymorphic_ctype': 'int', 'user': 'int', 'device': 'int', 'stream': 'int'}
    attribute_map = {'id': 'id', 'model': 'model', 'created_dt': 'created_dt', 'source': 'source', 'event_name': 'event_name', 'data': 'data', 'polymorphic_ctype': 'polymorphic_ctype', 'user': 'user', 'device': 'device', 'stream': 'stream'}

    def __init__(self, id=None, model=None, created_dt=None, source=None, event_name=None, data=None, polymorphic_ctype=None, user=None, device=None, stream=None, local_vars_configuration=None):
        """WebRTCEvent - a model defined in OpenAPI"""
    ...
    def model(self, model):
        ...
        """
        if self.local_vars_configuration.client_side_validation and model is None:
    ...
    def created_dt(self, created_dt):
        ...
        """
        if self.local_vars_configuration.client_side_validation and created_dt is None:
            raise ValueError('Invalid value for `created_dt`, must not be `None`')
    ...
    def source(self, source):
        ...
        """
        if self.local_vars_configuration.client_side_validation and source is None:
    ...
    def event_name(self, event_name):
        ...
        """
        if self.local_vars_configuration.client_side_validation and event_name is None:
    ...
    def polymorphic_ctype(self, polymorphic_ctype):
        ...
        """
        if self.local_vars_configuration.client_side_validation and polymorphic_ctype is None:
            raise ValueError('Invalid value for `polymorphic_ctype`, must not be `None`')
    ...
    def device(self, device):
        ...
        :type device: int
        """
        if self.local_vars_configuration.client_side_validation and device is None:
    ...
    def stream(self, stream):
        ...
        :type stream: int
        """
        if self.local_vars_configuration.client_side_validation and stream is None:
