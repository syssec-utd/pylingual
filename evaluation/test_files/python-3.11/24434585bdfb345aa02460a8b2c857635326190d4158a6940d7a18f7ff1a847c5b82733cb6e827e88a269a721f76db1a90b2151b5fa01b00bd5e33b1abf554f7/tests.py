...
from reviewboard.ssh.storage import FileSSHStorage, get_ssh_storage_backend_path, set_ssh_storage_backend_path
...
class SettingsTests(TestCase):
    ...
    def test_set_ssh_storage_backend_path(self):
        ...
        self.assertEqual(self.siteconfig.get('ssh_storage_backend'), 'foo.bar.FooStorage')

    def test_get_ssh_storage_backend_path(self):
        """Testing set_ssh_storage_backend_path"""
        self.siteconfig.set('ssh_storage_backend', 'foo.bar.BarStorage')
        self.assertEqual(get_ssh_storage_backend_path(), 'foo.bar.BarStorage')
