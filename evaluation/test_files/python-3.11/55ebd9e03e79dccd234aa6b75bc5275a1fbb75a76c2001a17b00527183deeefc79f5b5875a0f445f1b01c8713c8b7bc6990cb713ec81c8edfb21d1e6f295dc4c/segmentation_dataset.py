...
from modelscope.msdatasets.dataset_cls.custom_datasets.easycv_base import EasyCVBaseDataset
from modelscope.utils.constant import Tasks

@CUSTOM_DATASETS.register_module(group_key=Tasks.image_segmentation, module_name=CustomDatasets.SegDataset)
class SegDataset(EasyCVBaseDataset, _SegDataset):
    ...
    def __init__(self, split_config=None, preprocessor=None, mode=None, *args, **kwargs) -> None:
        EasyCVBaseDataset.__init__(self, split_config=split_config, preprocessor=preprocessor, mode=mode, args=args, kwargs=kwargs)
