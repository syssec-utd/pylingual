...
class GatewayCreateMigration(object):
    ...
    openapi_types = {'_1password_email': 'str', '_1password_password': 'str', '_1password_secret_key': 'str', '_1password_url': 'str', '_1password_vaults': 'list[str]', 'ad_auto_rotate_boolean': 'bool', 'ad_discover_local_users_boolean': 'bool', 'ad_local_users_ignore_list': 'dict(str, bool)', 'ad_sra_enable_rdp_boolean': 'bool', 'ad_auto_rotate': 'str', 'ad_computer_base_dn': 'str', 'ad_discover_local_users': 'str', 'ad_domain_name': 'str', 'ad_domain_users_path_template': 'str', 'ad_local_users_ignore': 'str', 'ad_local_users_path_template': 'str', 'ad_rotation_hour': 'int', 'ad_rotation_interval': 'int', 'ad_sra_enable_rdp': 'str', 'ad_target_name': 'str', 'ad_targets_path_template': 'str', 'ad_user_base_dn': 'str', 'ad_user_groups': 'str', 'as_ssh_port': 'str', 'aws_key': 'str', 'aws_key_id': 'str', 'aws_region': 'str', 'azure_client_id': 'str', 'azure_kv_name': 'str', 'azure_secret': 'str', 'azure_tenant_id': 'str', 'gcp_key': 'str', 'hashi_json': 'str', 'hashi_ns': 'list[str]', 'hashi_token': 'str', 'hashi_url': 'str', 'json': 'bool', 'k8s_ca_certificate': 'list[int]', 'k8s_client_certificate': 'list[int]', 'k8s_client_key': 'list[int]', 'k8s_namespace': 'str', 'k8s_password': 'str', 'k8s_skip_system': 'bool', 'k8s_token': 'str', 'k8s_url': 'str', 'k8s_username': 'str', 'name': 'str', 'protection_key': 'str', 'target_location': 'str', 'token': 'str', 'type': 'str', 'uid_token': 'str'}
    attribute_map = {'_1password_email': '1password-email', '_1password_password': '1password-password', '_1password_secret_key': '1password-secret-key', '_1password_url': '1password-url', '_1password_vaults': '1password-vaults', 'ad_auto_rotate_boolean': 'AdAutoRotateBoolean', 'ad_discover_local_users_boolean': 'AdDiscoverLocalUsersBoolean', 'ad_local_users_ignore_list': 'AdLocalUsersIgnoreList', 'ad_sra_enable_rdp_boolean': 'AdSRAEnableRDPBoolean', 'ad_auto_rotate': 'ad_auto_rotate', 'ad_computer_base_dn': 'ad_computer_base_dn', 'ad_discover_local_users': 'ad_discover_local_users', 'ad_domain_name': 'ad_domain_name', 'ad_domain_users_path_template': 'ad_domain_users_path_template', 'ad_local_users_ignore': 'ad_local_users_ignore', 'ad_local_users_path_template': 'ad_local_users_path_template', 'ad_rotation_hour': 'ad_rotation_hour', 'ad_rotation_interval': 'ad_rotation_interval', 'ad_sra_enable_rdp': 'ad_sra_enable_rdp', 'ad_target_name': 'ad_target_name', 'ad_targets_path_template': 'ad_targets_path_template', 'ad_user_base_dn': 'ad_user_base_dn', 'ad_user_groups': 'ad_user_groups', 'as_ssh_port': 'as_ssh_port', 'aws_key': 'aws-key', 'aws_key_id': 'aws-key-id', 'aws_region': 'aws-region', 'azure_client_id': 'azure-client-id', 'azure_kv_name': 'azure-kv-name', 'azure_secret': 'azure-secret', 'azure_tenant_id': 'azure-tenant-id', 'gcp_key': 'gcp-key', 'hashi_json': 'hashi-json', 'hashi_ns': 'hashi-ns', 'hashi_token': 'hashi-token', 'hashi_url': 'hashi-url', 'json': 'json', 'k8s_ca_certificate': 'k8s-ca-certificate', 'k8s_client_certificate': 'k8s-client-certificate', 'k8s_client_key': 'k8s-client-key', 'k8s_namespace': 'k8s-namespace', 'k8s_password': 'k8s-password', 'k8s_skip_system': 'k8s-skip-system', 'k8s_token': 'k8s-token', 'k8s_url': 'k8s-url', 'k8s_username': 'k8s-username', 'name': 'name', 'protection_key': 'protection-key', 'target_location': 'target-location', 'token': 'token', 'type': 'type', 'uid_token': 'uid-token'}
    ...
    def __init__(self, _1password_email=None, _1password_password=None, _1password_secret_key=None, _1password_url=None, _1password_vaults=None, ad_auto_rotate_boolean=None, ad_discover_local_users_boolean=None, ad_local_users_ignore_list=None, ad_sra_enable_rdp_boolean=None, ad_auto_rotate=None, ad_computer_base_dn=None, ad_discover_local_users=None, ad_domain_name=None, ad_domain_users_path_template=None, ad_local_users_ignore=None, ad_local_users_path_template=None, ad_rotation_hour=None, ad_rotation_interval=None, ad_sra_enable_rdp=None, ad_target_name=None, ad_targets_path_template=None, ad_user_base_dn=None, ad_user_groups=None, as_ssh_port=None, aws_key=None, aws_key_id=None, aws_region=None, azure_client_id=None, azure_kv_name=None, azure_secret=None, azure_tenant_id=None, gcp_key=None, hashi_json=None, hashi_ns=None, hashi_token=None, hashi_url=None, json=None, k8s_ca_certificate=None, k8s_client_certificate=None, k8s_client_key=None, k8s_namespace=None, k8s_password=None, k8s_skip_system=None, k8s_token=None, k8s_url=None, k8s_username=None, name=None, protection_key=None, target_location=None, token=None, type=None, uid_token=None, local_vars_configuration=None):
        """GatewayCreateMigration - a model defined in OpenAPI"""
    ...
    def target_location(self, target_location):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and target_location is None:
