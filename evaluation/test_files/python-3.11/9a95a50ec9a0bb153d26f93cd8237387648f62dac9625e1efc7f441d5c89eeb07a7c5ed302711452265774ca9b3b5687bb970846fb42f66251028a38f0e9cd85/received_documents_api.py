...
from fattureincloud_python_sdk.exceptions import ApiTypeError, ApiValueError
...
class ReceivedDocumentsApi(object):
    ...
    @validate_arguments
    def create_received_document(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], create_received_document_request: Annotated[Optional[CreateReceivedDocumentRequest], Field(description='Document to create')]=None, **kwargs) -> CreateReceivedDocumentResponse:
        ...
        return self.create_received_document_with_http_info(company_id, create_received_document_request, **kwargs)

    @validate_arguments
    def create_received_document_with_http_info(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], create_received_document_request: Annotated[Optional[CreateReceivedDocumentRequest], Field(description='Document to create')]=None, **kwargs):
        """Create Received Document  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method create_received_document" % _key)
            _params[_key] = _val
        del _params['kwargs']
        _collection_formats = {}
        _path_params = {}
        ...
        _auth_settings = ['OAuth2AuthenticationCodeFlow']
        _response_types_map = {'200': 'CreateReceivedDocumentResponse'}
        return self.api_client.call_api('/c/{company_id}/received_documents', 'POST', _path_params, _query_params, _header_params, body=_body_params, post_params=_form_params, files=_files, response_types_map=_response_types_map, auth_settings=_auth_settings, async_req=_params.get('async_req'), _return_http_data_only=_params.get('_return_http_data_only'), _preload_content=_params.get('_preload_content', True), _request_timeout=_params.get('_request_timeout'), collection_formats=_collection_formats, _request_auth=_params.get('_request_auth'))

    @validate_arguments
    def delete_received_document(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], document_id: Annotated[StrictInt, Field(..., description='The ID of the document.')], **kwargs) -> None:
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_received_document_with_http_info(company_id, document_id, **kwargs)

    @validate_arguments
    def delete_received_document_with_http_info(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], document_id: Annotated[StrictInt, Field(..., description='The ID of the document.')], **kwargs):
        """Delete Received Document  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method delete_received_document" % _key)
            _params[_key] = _val
        del _params['kwargs']
        _collection_formats = {}
        _path_params = {}
        ...
        _auth_settings = ['OAuth2AuthenticationCodeFlow']
        _response_types_map = {}
        return self.api_client.call_api('/c/{company_id}/received_documents/{document_id}', 'DELETE', _path_params, _query_params, _header_params, body=_body_params, post_params=_form_params, files=_files, response_types_map=_response_types_map, auth_settings=_auth_settings, async_req=_params.get('async_req'), _return_http_data_only=_params.get('_return_http_data_only'), _preload_content=_params.get('_preload_content', True), _request_timeout=_params.get('_request_timeout'), collection_formats=_collection_formats, _request_auth=_params.get('_request_auth'))

    @validate_arguments
    def delete_received_document_attachment(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], document_id: Annotated[StrictInt, Field(..., description='The ID of the document.')], **kwargs) -> None:
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_received_document_attachment_with_http_info(company_id, document_id, **kwargs)

    @validate_arguments
    def delete_received_document_attachment_with_http_info(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], document_id: Annotated[StrictInt, Field(..., description='The ID of the document.')], **kwargs):
        """Delete Received Document Attachment  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method delete_received_document_attachment" % _key)
            _params[_key] = _val
        del _params['kwargs']
        _collection_formats = {}
        _path_params = {}
        ...
        _auth_settings = ['OAuth2AuthenticationCodeFlow']
        _response_types_map = {}
        return self.api_client.call_api('/c/{company_id}/received_documents/{document_id}/attachment', 'DELETE', _path_params, _query_params, _header_params, body=_body_params, post_params=_form_params, files=_files, response_types_map=_response_types_map, auth_settings=_auth_settings, async_req=_params.get('async_req'), _return_http_data_only=_params.get('_return_http_data_only'), _preload_content=_params.get('_preload_content', True), _request_timeout=_params.get('_request_timeout'), collection_formats=_collection_formats, _request_auth=_params.get('_request_auth'))
    ...
    def get_existing_received_document_totals(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], document_id: Annotated[StrictInt, Field(..., description='The ID of the document.')], get_existing_received_document_totals_request: Annotated[Optional[GetExistingReceivedDocumentTotalsRequest], Field(description='Received document.')]=None, **kwargs) -> GetExistingReceivedDocumentTotalsResponse:
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_existing_received_document_totals_with_http_info(company_id, document_id, get_existing_received_document_totals_request, **kwargs)
    ...
    def get_existing_received_document_totals_with_http_info(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], document_id: Annotated[StrictInt, Field(..., description='The ID of the document.')], get_existing_received_document_totals_request: Annotated[Optional[GetExistingReceivedDocumentTotalsRequest], Field(description='Received document.')]=None, **kwargs):
        ...
        """
        _params = locals()
        _all_params = ['company_id', 'document_id', 'get_existing_received_document_totals_request']
        _all_params.extend(['async_req', '_return_http_data_only', '_preload_content', '_request_timeout', '_request_auth', '_content_type', '_headers'])
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method get_existing_received_document_totals" % _key)
            _params[_key] = _val
        del _params['kwargs']
        _collection_formats = {}
        _path_params = {}
        ...
        if _content_types_list:
            _header_params['Content-Type'] = _content_types_list
        _auth_settings = ['OAuth2AuthenticationCodeFlow']
        _response_types_map = {'200': 'GetExistingReceivedDocumentTotalsResponse'}
        return self.api_client.call_api('/c/{company_id}/received_documents/{document_id}/totals', 'POST', _path_params, _query_params, _header_params, body=_body_params, post_params=_form_params, files=_files, response_types_map=_response_types_map, auth_settings=_auth_settings, async_req=_params.get('async_req'), _return_http_data_only=_params.get('_return_http_data_only'), _preload_content=_params.get('_preload_content', True), _request_timeout=_params.get('_request_timeout'), collection_formats=_collection_formats, _request_auth=_params.get('_request_auth'))

    @validate_arguments
    def get_new_received_document_totals(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], get_new_received_document_totals_request: Annotated[Optional[GetNewReceivedDocumentTotalsRequest], Field(description='Received document.')]=None, **kwargs) -> GetNewReceivedDocumentTotalsResponse:
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_new_received_document_totals_with_http_info(company_id, get_new_received_document_totals_request, **kwargs)

    @validate_arguments
    def get_new_received_document_totals_with_http_info(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], get_new_received_document_totals_request: Annotated[Optional[GetNewReceivedDocumentTotalsRequest], Field(description='Received document.')]=None, **kwargs):
        """Get New Received Document Totals  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method get_new_received_document_totals" % _key)
            _params[_key] = _val
        del _params['kwargs']
        _collection_formats = {}
        _path_params = {}
        ...
        if _content_types_list:
            _header_params['Content-Type'] = _content_types_list
        _auth_settings = ['OAuth2AuthenticationCodeFlow']
        _response_types_map = {'200': 'GetNewReceivedDocumentTotalsResponse', '401': None, '404': None}
        return self.api_client.call_api('/c/{company_id}/received_documents/totals', 'POST', _path_params, _query_params, _header_params, body=_body_params, post_params=_form_params, files=_files, response_types_map=_response_types_map, auth_settings=_auth_settings, async_req=_params.get('async_req'), _return_http_data_only=_params.get('_return_http_data_only'), _preload_content=_params.get('_preload_content', True), _request_timeout=_params.get('_request_timeout'), collection_formats=_collection_formats, _request_auth=_params.get('_request_auth'))
    ...
    def get_received_document(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], document_id: Annotated[StrictInt, Field(..., description='The ID of the document.')], fields: Annotated[Optional[StrictStr], Field(description='List of comma-separated fields.')]=None, fieldset: Annotated[Optional[StrictStr], Field(description='Name of the fieldset.')]=None, **kwargs) -> GetReceivedDocumentResponse:
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_received_document_with_http_info(company_id, document_id, fields, fieldset, **kwargs)

    @validate_arguments
    def get_received_document_with_http_info(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], document_id: Annotated[StrictInt, Field(..., description='The ID of the document.')], fields: Annotated[Optional[StrictStr], Field(description='List of comma-separated fields.')]=None, fieldset: Annotated[Optional[StrictStr], Field(description='Name of the fieldset.')]=None, **kwargs):
        """Get Received Document  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method get_received_document" % _key)
            _params[_key] = _val
        del _params['kwargs']
        _collection_formats = {}
        _path_params = {}
        ...
        if _params['document_id']:
            _path_params['document_id'] = _params['document_id']
        _query_params = []
        if _params.get('fields') is not None:
            _query_params.append(('fields', _params['fields']))
        if _params.get('fieldset') is not None:
        ...
        _header_params['Accept'] = self.api_client.select_header_accept(['application/json'])
        _auth_settings = ['OAuth2AuthenticationCodeFlow']
        _response_types_map = {'200': 'GetReceivedDocumentResponse', '401': None, '404': None}
        return self.api_client.call_api('/c/{company_id}/received_documents/{document_id}', 'GET', _path_params, _query_params, _header_params, body=_body_params, post_params=_form_params, files=_files, response_types_map=_response_types_map, auth_settings=_auth_settings, async_req=_params.get('async_req'), _return_http_data_only=_params.get('_return_http_data_only'), _preload_content=_params.get('_preload_content', True), _request_timeout=_params.get('_request_timeout'), collection_formats=_collection_formats, _request_auth=_params.get('_request_auth'))

    @validate_arguments
    def get_received_document_pre_create_info(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], type: Annotated[StrictStr, Field(..., description='The type of the received document.')], **kwargs) -> GetReceivedDocumentPreCreateInfoResponse:
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_received_document_pre_create_info_with_http_info(company_id, type, **kwargs)

    @validate_arguments
    def get_received_document_pre_create_info_with_http_info(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], type: Annotated[StrictStr, Field(..., description='The type of the received document.')], **kwargs):
        """Get Received Document Pre-Create Info  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method get_received_document_pre_create_info" % _key)
            _params[_key] = _val
        del _params['kwargs']
        _collection_formats = {}
        _path_params = {}
    ...
    def list_received_documents(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], type: Annotated[StrictStr, Field(..., description='The type of the received document.')], fields: Annotated[Optional[StrictStr], Field(description='List of comma-separated fields.')]=None, fieldset: Annotated[Optional[StrictStr], Field(description='Name of the fieldset.')]=None, sort: Annotated[Optional[StrictStr], Field(description='List of comma-separated fields for result sorting (minus for desc sorting).')]=None, page: Annotated[Optional[StrictInt], Field(description='The page to retrieve.')]=None, per_page: Annotated[Optional[conint(strict=True, le=100, ge=1)], Field(description='The size of the page.')]=None, q: Annotated[Optional[StrictStr], Field(description='Query for filtering the results.')]=None, **kwargs) -> ListReceivedDocumentsResponse:
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_received_documents_with_http_info(company_id, type, fields, fieldset, sort, page, per_page, q, **kwargs)

    @validate_arguments
    def list_received_documents_with_http_info(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], type: Annotated[StrictStr, Field(..., description='The type of the received document.')], fields: Annotated[Optional[StrictStr], Field(description='List of comma-separated fields.')]=None, fieldset: Annotated[Optional[StrictStr], Field(description='Name of the fieldset.')]=None, sort: Annotated[Optional[StrictStr], Field(description='List of comma-separated fields for result sorting (minus for desc sorting).')]=None, page: Annotated[Optional[StrictInt], Field(description='The page to retrieve.')]=None, per_page: Annotated[Optional[conint(strict=True, le=100, ge=1)], Field(description='The size of the page.')]=None, q: Annotated[Optional[StrictStr], Field(description='Query for filtering the results.')]=None, **kwargs):
        """List Received Documents  # noqa: E501
        ...
        """
        _params = locals()
        _all_params = ['company_id', 'type', 'fields', 'fieldset', 'sort', 'page', 'per_page', 'q']
        _all_params.extend(['async_req', '_return_http_data_only', '_preload_content', '_request_timeout', '_request_auth', '_content_type', '_headers'])
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method list_received_documents" % _key)
            _params[_key] = _val
        del _params['kwargs']
        _collection_formats = {}
        _path_params = {}
        ...
        _header_params['Accept'] = self.api_client.select_header_accept(['application/json'])
        _auth_settings = ['OAuth2AuthenticationCodeFlow']
        _response_types_map = {'200': 'ListReceivedDocumentsResponse', '401': None}
        return self.api_client.call_api('/c/{company_id}/received_documents', 'GET', _path_params, _query_params, _header_params, body=_body_params, post_params=_form_params, files=_files, response_types_map=_response_types_map, auth_settings=_auth_settings, async_req=_params.get('async_req'), _return_http_data_only=_params.get('_return_http_data_only'), _preload_content=_params.get('_preload_content', True), _request_timeout=_params.get('_request_timeout'), collection_formats=_collection_formats, _request_auth=_params.get('_request_auth'))
    ...
    def modify_received_document(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], document_id: Annotated[StrictInt, Field(..., description='The ID of the document.')], modify_received_document_request: Annotated[Optional[ModifyReceivedDocumentRequest], Field(description='Modified document.')]=None, **kwargs) -> ModifyReceivedDocumentResponse:
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.modify_received_document_with_http_info(company_id, document_id, modify_received_document_request, **kwargs)

    @validate_arguments
    def modify_received_document_with_http_info(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], document_id: Annotated[StrictInt, Field(..., description='The ID of the document.')], modify_received_document_request: Annotated[Optional[ModifyReceivedDocumentRequest], Field(description='Modified document.')]=None, **kwargs):
        """Modify Received Document  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method modify_received_document" % _key)
            _params[_key] = _val
        del _params['kwargs']
        _collection_formats = {}
        _path_params = {}
        ...
        if _content_types_list:
            _header_params['Content-Type'] = _content_types_list
        _auth_settings = ['OAuth2AuthenticationCodeFlow']
        _response_types_map = {'200': 'ModifyReceivedDocumentResponse', '401': None, '404': None}
        return self.api_client.call_api('/c/{company_id}/received_documents/{document_id}', 'PUT', _path_params, _query_params, _header_params, body=_body_params, post_params=_form_params, files=_files, response_types_map=_response_types_map, auth_settings=_auth_settings, async_req=_params.get('async_req'), _return_http_data_only=_params.get('_return_http_data_only'), _preload_content=_params.get('_preload_content', True), _request_timeout=_params.get('_request_timeout'), collection_formats=_collection_formats, _request_auth=_params.get('_request_auth'))

    @validate_arguments
    def upload_received_document_attachment(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], filename: Annotated[Optional[StrictStr], Field(description='Name of the file.')]=None, attachment: Annotated[Optional[StrictStr], Field(description='Valid format: .png, .jpg, .gif, .pdf, .zip, .xls, .xlsx, .doc, .docx')]=None, **kwargs) -> UploadReceivedDocumentAttachmentResponse:
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.upload_received_document_attachment_with_http_info(company_id, filename, attachment, **kwargs)

    @validate_arguments
    def upload_received_document_attachment_with_http_info(self, company_id: Annotated[StrictInt, Field(..., description='The ID of the company.')], filename: Annotated[Optional[StrictStr], Field(description='Name of the file.')]=None, attachment: Annotated[Optional[StrictStr], Field(description='Valid format: .png, .jpg, .gif, .pdf, .zip, .xls, .xlsx, .doc, .docx')]=None, **kwargs):
        """Upload Received Document Attachment  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s' to method upload_received_document_attachment" % _key)
            _params[_key] = _val
        del _params['kwargs']
        _collection_formats = {}
        _path_params = {}
        ...
        if _content_types_list:
            _header_params['Content-Type'] = _content_types_list
        _auth_settings = ['OAuth2AuthenticationCodeFlow']
        _response_types_map = {'200': 'UploadReceivedDocumentAttachmentResponse', '401': None}
        return self.api_client.call_api('/c/{company_id}/received_documents/attachment', 'POST', _path_params, _query_params, _header_params, body=_body_params, post_params=_form_params, files=_files, response_types_map=_response_types_map, auth_settings=_auth_settings, async_req=_params.get('async_req'), _return_http_data_only=_params.get('_return_http_data_only'), _preload_content=_params.get('_preload_content', True), _request_timeout=_params.get('_request_timeout'), collection_formats=_collection_formats, _request_auth=_params.get('_request_auth'))