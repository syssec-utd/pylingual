...
class Select(ZooKerasLayer):
    ...
    def __init__(self, dim, index, input_shape=None, **kwargs):
        super(Select, self).__init__(None, dim, index, list(input_shape) if input_shape else None, **kwargs)
...
class Narrow(ZooKerasLayer):
    ...
    def __init__(self, dim, offset, length=1, input_shape=None, **kwargs):
        super(Narrow, self).__init__(None, dim, offset, length, list(input_shape) if input_shape else None, **kwargs)
...
class Squeeze(ZooKerasLayer):
    ...
    def __init__(self, dim=None, input_shape=None, **kwargs):
        if isinstance(dim, int):
            dim = (dim,)
        super(Squeeze, self).__init__(None, dim, list(input_shape) if input_shape else None, **kwargs)
...
class AddConstant(ZooKerasLayer):
    ...
    def __init__(self, constant, input_shape=None, **kwargs):
        super(AddConstant, self).__init__(None, float(constant), list(input_shape) if input_shape else None, **kwargs)
...
class MulConstant(ZooKerasLayer):
    ...
    def __init__(self, constant, input_shape=None, **kwargs):
        super(MulConstant, self).__init__(None, float(constant), list(input_shape) if input_shape else None, **kwargs)
...
class ShareConvolution2D(ZooKerasLayer):
    ...
    def __init__(self, nb_filter, nb_row, nb_col, init='glorot_uniform', activation=None, subsample=(1, 1), pad_h=0, pad_w=0, propagate_back=True, dim_ordering='th', W_regularizer=None, b_regularizer=None, bias=True, input_shape=None, **kwargs):
        super(ShareConvolution2D, self).__init__(None, nb_filter, nb_row, nb_col, init, activation, subsample, pad_h, pad_w, propagate_back, dim_ordering, W_regularizer, b_regularizer, bias, list(input_shape) if input_shape else None, **kwargs)
...
class CAdd(ZooKerasLayer):
    ...
    def __init__(self, size, b_regularizer=None, input_shape=None, **kwargs):
        super(CAdd, self).__init__(None, size, b_regularizer, list(input_shape) if input_shape else None, **kwargs)
...
class CMul(ZooKerasLayer):
    ...
    def __init__(self, size, W_regularizer=None, input_shape=None, **kwargs):
        super(CMul, self).__init__(None, size, W_regularizer, list(input_shape) if input_shape else None, **kwargs)
...
class Identity(ZooKerasLayer):
    ...
    def __init__(self, input_shape=None, **kwargs):
        super(Identity, self).__init__(None, list(input_shape) if input_shape else None, **kwargs)
...
class Log(ZooKerasLayer):
    ...
    def __init__(self, input_shape=None, **kwargs):
        super(Log, self).__init__(None, list(input_shape) if input_shape else None, **kwargs)
...
class Power(ZooKerasLayer):
    ...
    def __init__(self, power, scale=1, shift=0, input_shape=None, **kwargs):
        super(Power, self).__init__(None, float(power), float(scale), float(shift), list(input_shape) if input_shape else None, **kwargs)
...
class Scale(ZooKerasLayer):
    ...
    def __init__(self, size, input_shape=None, **kwargs):
        super(Scale, self).__init__(None, size, list(input_shape) if input_shape else None, **kwargs)
...
class Sqrt(ZooKerasLayer):
    ...
    def __init__(self, input_shape=None, **kwargs):
        super(Sqrt, self).__init__(None, list(input_shape) if input_shape else None, **kwargs)
...
class Square(ZooKerasLayer):
    ...
    def __init__(self, input_shape=None, **kwargs):
        super(Square, self).__init__(None, list(input_shape) if input_shape else None, **kwargs)
...
class HardShrink(ZooKerasLayer):
    ...
    def __init__(self, value=0.5, input_shape=None, **kwargs):
        super(HardShrink, self).__init__(None, float(value), list(input_shape) if input_shape else None, **kwargs)
...
class HardTanh(ZooKerasLayer):
    ...
    def __init__(self, min_value=-1, max_value=1, input_shape=None, **kwargs):
        super(HardTanh, self).__init__(None, float(min_value), float(max_value), list(input_shape) if input_shape else None, **kwargs)
...
class Negative(ZooKerasLayer):
    ...
    def __init__(self, input_shape=None, **kwargs):
        super(Negative, self).__init__(None, list(input_shape) if input_shape else None, **kwargs)
...
class PReLU(ZooKerasLayer):
    ...
    def __init__(self, n_output_plane=0, input_shape=None, **kwargs):
        super(PReLU, self).__init__(None, n_output_plane, list(input_shape) if input_shape else None, **kwargs)
...
class RReLU(ZooKerasLayer):
    ...
    def __init__(self, lower=1.0 / 8, upper=1.0 / 3, input_shape=None, **kwargs):
        super(RReLU, self).__init__(None, float(lower), float(upper), list(input_shape) if input_shape else None, **kwargs)
...
class SoftShrink(ZooKerasLayer):
    ...
    def __init__(self, value=0.5, input_shape=None, **kwargs):
        super(SoftShrink, self).__init__(None, float(value), list(input_shape) if input_shape else None, **kwargs)
...
class WithinChannelLRN2D(ZooKerasLayer):
    ...
    def __init__(self, size=5, alpha=1.0, beta=0.75, input_shape=None, **kwargs):
        super(WithinChannelLRN2D, self).__init__(None, size, float(alpha), float(beta), list(input_shape) if input_shape else None, **kwargs)
...
class BinaryThreshold(ZooKerasLayer):
    ...
    def __init__(self, value=1e-06, input_shape=None, **kwargs):
        super(BinaryThreshold, self).__init__(None, float(value), list(input_shape) if input_shape else None, **kwargs)
...
class Threshold(ZooKerasLayer):
    ...
    def __init__(self, th=1e-06, v=0.0, input_shape=None, **kwargs):
        super(Threshold, self).__init__(None, float(th), float(v), list(input_shape) if input_shape else None, **kwargs)
...
class ResizeBilinear(ZooKerasLayer):
    ...
    def __init__(self, output_height, output_width, align_corner=False, dim_ordering='th', input_shape=None, **kwargs):
        super(ResizeBilinear, self).__init__(None, output_height, output_width, align_corner, dim_ordering, list(input_shape) if input_shape else None, **kwargs)
...
class SelectTable(ZooKerasLayer):
    ...
    def __init__(self, index, input_shape=None, **kwargs):
        super(SelectTable, self).__init__(None, index, list(input_shape) if input_shape else None, **kwargs)