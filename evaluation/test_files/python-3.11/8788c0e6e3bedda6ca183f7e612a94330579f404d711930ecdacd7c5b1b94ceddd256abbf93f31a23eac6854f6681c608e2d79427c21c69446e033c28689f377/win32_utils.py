...
class APPBARDATA(Structure):
    _fields_ = [('cbSize', DWORD), ('hWnd', HWND), ('uCallbackMessage', UINT), ('uEdge', UINT), ('rc', RECT), ('lParam', LPARAM)]
        ...
        if isGreaterEqualWin8_1():
            ...
            for position in positions:
                ...
                if windll.shell32.SHAppBarMessage(11, byref(appbarData)):
                    return position
            return cls.NO_POSITION
        appbarData = APPBARDATA(sizeof(APPBARDATA), win32gui.FindWindow('Shell_TrayWnd', None), 0, 0, RECT(0, 0, 0, 0), 0)
        if appbarData.hWnd:
