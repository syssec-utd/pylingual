...
class cryptocom(Exchange):
    ...
    def fetch_spot_markets(self, params={}):
        ...
        for i in range(0, len(markets)):
            ...
            result.append({'id': id, 'symbol': base + '/' + quote, 'base': base, 'quote': quote, 'settle': None, 'baseId': baseId, 'quoteId': quoteId, 'settleId': None, 'type': 'spot', 'spot': True, 'margin': self.safe_value(market, 'margin_trading_enabled'), 'swap': False, 'future': False, 'option': False, 'active': None, 'contract': False, 'linear': None, 'inverse': None, 'contractSize': None, 'expiry': None, 'expiryDatetime': None, 'strike': None, 'optionType': None, 'precision': {'amount': self.safe_number(market, 'quantity_tick_size'), 'price': self.safe_number(market, 'price_tick_size')}, 'limits': {'leverage': {'min': self.parse_number('1'), 'max': maxLeverage}, 'amount': {'min': self.parse_number(minQuantity), 'max': self.safe_number(market, 'max_quantity')}, 'price': {'min': self.parse_number(minPrice), 'max': self.safe_number(market, 'max_price')}, 'cost': {'min': self.parse_number(Precise.string_mul(minQuantity, minPrice)), 'max': None}}, 'info': market})
        return result
    ...
    def fetch_derivatives_markets(self, params={}):
        ...
        for i in range(0, len(data)):
            ...
            result.append({'id': self.safe_string(market, 'symbol'), 'symbol': symbol, 'base': base, 'quote': quote, 'settle': quote, 'baseId': baseId, 'quoteId': quoteId, 'settleId': quoteId, 'type': type, 'spot': False, 'margin': False, 'swap': swap, 'future': future, 'option': False, 'active': self.safe_value(market, 'tradable'), 'contract': True, 'linear': True, 'inverse': False, 'contractSize': contractSize, 'expiry': expiry, 'expiryDatetime': self.iso8601(expiry), 'strike': None, 'optionType': None, 'precision': {'price': self.parse_number(self.parse_precision(self.safe_string(market, 'quote_decimals'))), 'amount': self.parse_number(self.parse_precision(self.safe_string(market, 'quantity_decimals')))}, 'limits': {'leverage': {'min': self.parse_number('1'), 'max': self.safe_number(market, 'max_leverage')}, 'amount': {'min': self.parse_number(contractSize), 'max': None}, 'price': {'min': None, 'max': None}, 'cost': {'min': None, 'max': None}}, 'info': market})
        return result
    ...
    def fetch_tickers(self, symbols=None, params={}):
        ...
        method = self.get_supported_mapping(marketType, {'spot': 'v2PublicGetPublicGetTicker', 'future': 'derivativesPublicGetPublicGetTickers', 'swap': 'derivativesPublicGetPublicGetTickers'})
    ...
    def fetch_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        method = self.get_supported_mapping(marketType, {'spot': 'v2PrivatePostPrivateGetOrderHistory', 'margin': 'v2PrivatePostPrivateMarginGetOrderHistory', 'future': 'derivativesPrivatePostPrivateGetOrderHistory', 'swap': 'derivativesPrivatePostPrivateGetOrderHistory'})
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        method = self.get_supported_mapping(marketType, {'spot': 'v2PublicGetPublicGetTrades', 'future': 'derivativesPublicGetPublicGetTrades', 'swap': 'derivativesPublicGetPublicGetTrades'})
        response = getattr(self, method)(self.extend(request, query))
        resultResponse = self.safe_value(response, 'result', {})
        data = self.safe_value(resultResponse, 'data', [])
    ...
    def fetch_ohlcv(self, symbol, timeframe='1m', since=None, limit=None, params={}):
        ...
        self.load_markets()
        market = self.market(symbol)
        request = {'instrument_name': market['id'], 'timeframe': self.timeframes[timeframe]}
        marketType, query = self.handle_market_type_and_params('fetchOHLCV', market, params)
        method = self.get_supported_mapping(marketType, {'spot': 'v2PublicGetPublicGetCandlestick', 'future': 'derivativesPublicGetPublicGetCandlestick', 'swap': 'derivativesPublicGetPublicGetCandlestick'})
        if marketType != 'spot':
            reqLimit = 100
            if limit is not None:
                reqLimit = limit
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        method = self.get_supported_mapping(marketType, {'spot': 'v2PublicGetPublicGetBook', 'future': 'derivativesPublicGetPublicGetBook', 'swap': 'derivativesPublicGetPublicGetBook'})
        response = getattr(self, method)(self.extend(request, query))
        result = self.safe_value(response, 'result')
        data = self.safe_value(result, 'data')
    ...
    def fetch_balance(self, params={}):
        ...
        method = self.get_supported_mapping(marketType, {'spot': 'v2PrivatePostPrivateGetAccountSummary', 'margin': 'v2PrivatePostPrivateMarginGetAccountSummary', 'future': 'derivativesPrivatePostPrivateUserBalance', 'swap': 'derivativesPrivatePostPrivateUserBalance'})
        ...
        response = getattr(self, method)(query)
        parser = self.get_supported_mapping(marketType, {'spot': 'parseSpotBalance', 'margin': 'parseSpotBalance', 'future': 'parseSwapBalance', 'swap': 'parseSwapBalance'})
    ...
    def fetch_order(self, id, symbol=None, params={}):
        ...
        method = self.get_supported_mapping(marketType, {'spot': 'v2PrivatePostPrivateGetOrderDetail', 'margin': 'v2PrivatePostPrivateMarginGetOrderDetail', 'future': 'derivativesPrivatePostPrivateGetOrderDetail', 'swap': 'derivativesPrivatePostPrivateGetOrderDetail'})
        if marginMode is not None:
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        request = {'instrument_name': market['id'], 'side': side.upper(), 'type': uppercaseType, 'quantity': self.amount_to_precision(symbol, amount)}
        ...
        method = self.get_supported_mapping(marketType, {'spot': 'v2PrivatePostPrivateCreateOrder', 'margin': 'v2PrivatePostPrivateMarginCreateOrder', 'future': 'derivativesPrivatePostPrivateCreateOrder', 'swap': 'derivativesPrivatePostPrivateCreateOrder'})
    ...
    def cancel_all_orders(self, symbol=None, params={}):
        ...
        if marketType == 'spot' or marketType == 'margin' or marginMode is not None:
            ...
            request['instrument_name'] = market['id']
        method = self.get_supported_mapping(marketType, {'spot': 'v2PrivatePostPrivateCancelAllOrders', 'margin': 'v2PrivatePostPrivateMarginCancelAllOrders', 'future': 'derivativesPrivatePostPrivateCancelAllOrders', 'swap': 'derivativesPrivatePostPrivateCancelAllOrders'})
        if marginMode is not None:
    ...
    def cancel_order(self, id, symbol=None, params={}):
        ...
        if marketType == 'spot' or marketType == 'margin' or marginMode is not None:
            ...
            request['order_id'] = int(id)
        method = self.get_supported_mapping(marketType, {'spot': 'v2PrivatePostPrivateCancelOrder', 'margin': 'v2PrivatePostPrivateMarginCancelOrder', 'future': 'derivativesPrivatePostPrivateCancelOrder', 'swap': 'derivativesPrivatePostPrivateCancelOrder'})
        if marginMode is not None:
    ...
    def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        method = self.get_supported_mapping(marketType, {'spot': 'v2PrivatePostPrivateGetOpenOrders', 'margin': 'v2PrivatePostPrivateMarginGetOpenOrders', 'future': 'derivativesPrivatePostPrivateGetOpenOrders', 'swap': 'derivativesPrivatePostPrivateGetOpenOrders'})
    ...
    def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        method = self.get_supported_mapping(marketType, {'spot': 'v2PrivatePostPrivateGetTrades', 'margin': 'v2PrivatePostPrivateMarginGetTrades', 'future': 'derivativesPrivatePostPrivateGetTrades', 'swap': 'derivativesPrivatePostPrivateGetTrades'})
    ...
    def withdraw(self, code, amount, address, tag=None, params={}):
        ...
        request = {'currency': currency['id'], 'amount': amount, 'address': address}
        if tag is not None:
    ...
    def fetch_deposit_addresses_by_network(self, code, params={}):
        ...
        for i in range(0, len(addresses)):
            ...
            result[network] = {'info': value, 'currency': responseCode, 'address': address, 'tag': tag, 'network': network}
        return result
    ...
    def safe_network(self, networkId):
        networksById = {'BTC': 'BTC', 'ETH': 'ETH', 'SOL': 'SOL', 'BNB': 'BNB', 'CRONOS': 'CRONOS', 'MATIC': 'MATIC', 'OP': 'OP'}
    ...
    def transfer(self, code, amount, fromAccount, toAccount, params={}):
        ...
        request = {'currency': currency['id'], 'amount': float(amount), 'from': fromId, 'to': toId}
    ...
    def fetch_transfers(self, code=None, since=None, limit=None, params={}):
        ...
        response = getattr(self, method)(self.extend(request, query))
        transfer = []
        transfer.append({'response': response})
        return self.parse_transfers(transfer, currency, since, limit, params)

    def parse_transfer_status(self, status):
        statuses = {'COMPLETED': 'ok', 'PROCESSING': 'pending'}
    ...
    def parse_transfer(self, transfer, currency=None):
        ...
        return {'info': transferList, 'id': self.safe_string(response, 'id'), 'timestamp': timestamp, 'datetime': self.iso8601(timestamp), 'currency': code, 'amount': amount, 'fromAccount': fromAccount, 'toAccount': toAccount, 'status': status}
    ...
    def parse_ticker(self, ticker, market=None):
        ...
        return self.safe_ticker({'symbol': symbol, 'timestamp': timestamp, 'datetime': self.iso8601(timestamp), 'high': self.safe_string(ticker, 'h'), 'low': self.safe_string(ticker, 'l'), 'bid': self.safe_string(ticker, 'b'), 'bidVolume': None, 'ask': self.safe_string(ticker, 'k'), 'askVolume': None, 'vwap': None, 'open': None, 'close': last, 'last': last, 'previousClose': None, 'change': relativeChange, 'percentage': None, 'average': None, 'baseVolume': self.safe_string(ticker, 'v'), 'quoteVolume': None, 'info': ticker}, market)
    ...
    def parse_trade(self, trade, market=None):
        ...
        return self.safe_trade({'info': trade, 'id': id, 'timestamp': timestamp, 'datetime': self.iso8601(timestamp), 'symbol': symbol, 'side': side, 'price': price, 'amount': amount, 'cost': None, 'order': order, 'takerOrMaker': takerOrMaker, 'type': None, 'fee': fee}, market)
    ...
    def parse_order_status(self, status):
        statuses = {'ACTIVE': 'open', 'CANCELED': 'canceled', 'FILLED': 'closed', 'REJECTED': 'rejected', 'EXPIRED': 'expired'}
        return self.safe_string(statuses, status, status)

    def parse_time_in_force(self, timeInForce):
        timeInForces = {'GOOD_TILL_CANCEL': 'GTC', 'IMMEDIATE_OR_CANCEL': 'IOC', 'FILL_OR_KILL': 'FOK'}
    ...
    def parse_order(self, order, market=None):
        ...
        if feeCost is not None:
            ...
            fee = {'cost': feeCost, 'currency': self.safe_currency_code(feeCurrency)}
        return self.safe_order({'info': order, 'id': id, 'clientOrderId': clientOrderId, 'timestamp': created, 'datetime': self.iso8601(created), 'lastTradeTimestamp': updated, 'status': status, 'symbol': symbol, 'type': type, 'timeInForce': timeInForce, 'postOnly': postOnly, 'side': side, 'price': price, 'amount': amount, 'filled': filled, 'remaining': None, 'cost': cost, 'fee': fee, 'average': average, 'trades': []}, market)

    def parse_deposit_status(self, status):
        statuses = {'0': 'pending', '1': 'ok', '2': 'failed', '3': 'pending'}
        return self.safe_string(statuses, status, status)

    def parse_withdrawal_status(self, status):
        statuses = {'0': 'pending', '1': 'pending', '2': 'failed', '3': 'pending', '4': 'failed', '5': 'ok', '6': 'canceled'}
        return self.safe_string(statuses, status, status)
    ...
    def parse_transaction(self, transaction, currency=None):
        ...
        return {'info': transaction, 'id': id, 'txid': txId, 'timestamp': timestamp, 'datetime': self.iso8601(timestamp), 'network': None, 'address': address, 'addressTo': address, 'addressFrom': None, 'tag': tag, 'tagTo': tag, 'tagFrom': None, 'type': type, 'amount': amount, 'currency': code, 'status': status, 'updated': updated, 'internal': None, 'fee': fee}
    ...
    def parse_margin_loan(self, info, currency=None):
        return {'id': self.safe_integer(info, 'id'), 'currency': self.safe_currency_code(None, currency), 'amount': None, 'symbol': None, 'timestamp': None, 'datetime': None, 'info': info}
    ...
    def parse_borrow_interest(self, info, market=None):
        ...
        if market is not None:
            symbol = market['symbol']
        return {'symbol': symbol, 'marginMode': None, 'currency': self.safe_currency_code(self.safe_string(info, 'currency')), 'interest': self.safe_number(info, 'interest'), 'interestRate': self.safe_number(info, 'interest_rate'), 'amountBorrowed': None, 'timestamp': timestamp, 'datetime': self.iso8601(timestamp), 'info': info}
    ...
    def parse_borrow_rates(self, info, codeKey):
        ...
        for i in range(0, len(info)):
            entry = info[i]
            rates.append({'currency': self.safe_currency_code(self.safe_string(entry, 'currency')), 'rate': self.safe_number(entry, 'hourly_rate'), 'period': 3600000, 'timestamp': timestamp, 'datetime': self.iso8601(timestamp), 'info': entry})
        return rates
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if access == 'public':
            ...
            body = self.json({'id': nonce, 'method': path, 'params': params, 'api_key': self.apiKey, 'sig': signature, 'nonce': nonce})
