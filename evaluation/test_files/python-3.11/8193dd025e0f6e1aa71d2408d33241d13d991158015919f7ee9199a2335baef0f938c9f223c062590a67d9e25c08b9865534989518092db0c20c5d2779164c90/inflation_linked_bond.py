...
class InflationLinkedBond(object):
    ...
    openapi_types = {'start_date': 'datetime', 'maturity_date': 'datetime', 'flow_conventions': 'FlowConventions', 'coupon_rate': 'float', 'identifiers': 'dict(str, str)', 'dom_ccy': 'str', 'base_cpi': 'float', 'base_cpi_date': 'datetime', 'calculation_type': 'str', 'ex_dividend_days': 'int', 'index_precision': 'int', 'inflation_index_name': 'str', 'inflation_interpolation': 'str', 'inflation_roll_day': 'int', 'observation_lag': 'str', 'principal': 'float', 'principal_protection': 'bool', 'stub_type': 'str', 'instrument_type': 'str'}
    attribute_map = {'start_date': 'startDate', 'maturity_date': 'maturityDate', 'flow_conventions': 'flowConventions', 'coupon_rate': 'couponRate', 'identifiers': 'identifiers', 'dom_ccy': 'domCcy', 'base_cpi': 'baseCPI', 'base_cpi_date': 'baseCPIDate', 'calculation_type': 'calculationType', 'ex_dividend_days': 'exDividendDays', 'index_precision': 'indexPrecision', 'inflation_index_name': 'inflationIndexName', 'inflation_interpolation': 'inflationInterpolation', 'inflation_roll_day': 'inflationRollDay', 'observation_lag': 'observationLag', 'principal': 'principal', 'principal_protection': 'principalProtection', 'stub_type': 'stubType', 'instrument_type': 'instrumentType'}
    required_map = {'start_date': 'required', 'maturity_date': 'required', 'flow_conventions': 'required', 'coupon_rate': 'required', 'identifiers': 'optional', 'dom_ccy': 'required', 'base_cpi': 'optional', 'base_cpi_date': 'optional', 'calculation_type': 'optional', 'ex_dividend_days': 'optional', 'index_precision': 'optional', 'inflation_index_name': 'required', 'inflation_interpolation': 'optional', 'inflation_roll_day': 'optional', 'observation_lag': 'optional', 'principal': 'required', 'principal_protection': 'optional', 'stub_type': 'optional', 'instrument_type': 'required'}

    def __init__(self, start_date=None, maturity_date=None, flow_conventions=None, coupon_rate=None, identifiers=None, dom_ccy=None, base_cpi=None, base_cpi_date=None, calculation_type=None, ex_dividend_days=None, index_precision=None, inflation_index_name=None, inflation_interpolation=None, inflation_roll_day=None, observation_lag=None, principal=None, principal_protection=None, stub_type=None, instrument_type=None, local_vars_configuration=None):
    ...
    def start_date(self, start_date):
        ...
        :type start_date: datetime
        """
        if self.local_vars_configuration.client_side_validation and start_date is None:
    ...
    def maturity_date(self, maturity_date):
        ...
        :type maturity_date: datetime
        """
        if self.local_vars_configuration.client_side_validation and maturity_date is None:
            raise ValueError('Invalid value for `maturity_date`, must not be `None`')
    ...
    def flow_conventions(self, flow_conventions):
        ...
        :type flow_conventions: lusid.FlowConventions
        """
        if self.local_vars_configuration.client_side_validation and flow_conventions is None:
            raise ValueError('Invalid value for `flow_conventions`, must not be `None`')
    ...
    def coupon_rate(self, coupon_rate):
        ...
        :type coupon_rate: float
        """
        if self.local_vars_configuration.client_side_validation and coupon_rate is None:
            raise ValueError('Invalid value for `coupon_rate`, must not be `None`')
    ...
    def dom_ccy(self, dom_ccy):
        ...
        :type dom_ccy: str
        """
        if self.local_vars_configuration.client_side_validation and dom_ccy is None:
            raise ValueError('Invalid value for `dom_ccy`, must not be `None`')
    ...
    def inflation_index_name(self, inflation_index_name):
        ...
        :type inflation_index_name: str
        """
        if self.local_vars_configuration.client_side_validation and inflation_index_name is None:
            raise ValueError('Invalid value for `inflation_index_name`, must not be `None`')
    ...
    def principal(self, principal):
        ...
        :type principal: float
        """
        if self.local_vars_configuration.client_side_validation and principal is None:
    ...
    def instrument_type(self, instrument_type):
        ...
        :type instrument_type: str
        """
        if self.local_vars_configuration.client_side_validation and instrument_type is None:
        ...
        if self.local_vars_configuration.client_side_validation and instrument_type not in allowed_values:
            raise ValueError('Invalid value for `instrument_type` ({0}), must be one of {1}'.format(instrument_type, allowed_values))
