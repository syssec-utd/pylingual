...
class AuditRealtimeQueryRequest(object):
    ...
    def __init__(self) -> None:
        ...
        """
        self.swagger_types = {'interval': 'str', 'service_name': 'str', 'filters': 'list[AuditQueryFilter]', 'sort': 'list[AuditQuerySort]', 'page_number': 'int', 'page_size': 'int'}
        self.attribute_map = {'interval': 'interval', 'service_name': 'serviceName', 'filters': 'filters', 'sort': 'sort', 'page_number': 'pageNumber', 'page_size': 'pageSize'}
        self._interval = None
