...
class VirtualizationBaseVirtualNetworkInterfaceCard(ModelComposed):
    ...
    """
    allowed_values = {('class_id',): {'CLOUD.AWSNETWORKINTERFACE': 'cloud.AwsNetworkInterface', 'VIRTUALIZATION.IWEVIRTUALMACHINENETWORKINTERFACE': 'virtualization.IweVirtualMachineNetworkInterface'}, ('object_type',): {'CLOUD.AWSNETWORKINTERFACE': 'cloud.AwsNetworkInterface', 'VIRTUALIZATION.IWEVIRTUALMACHINENETWORKINTERFACE': 'virtualization.IweVirtualMachineNetworkInterface'}, ('adapter_type',): {'UNKNOWN': 'Unknown', 'E1000': 'E1000', 'SRIOV': 'SRIOV', 'VMXNET2': 'VMXNET2', 'VMXNET3': 'VMXNET3', 'E1000E': 'E1000E', 'NE2K_PCI': 'NE2K_PCI', 'PCNET': 'PCnet', 'RTL8139': 'RTL8139', 'VIRTIO': 'VirtIO', 'EMPTY': ''}}
    validations = {('mac_address',): {'regex': {'pattern': '^$|^([0-9A-Fa-f]{2}[:-]){5}([0-9A-Fa-f]{2})$'}}}
    ...
    def openapi_types():
        ...
        """
        lazy_import()
        return {'class_id': (str,), 'object_type': (str,), 'adapter_type': (str,), 'mac_address': (str,), 'name': (str,), 'account_moid': (str,), 'create_time': (datetime,), 'domain_group_moid': (str,), 'mod_time': (datetime,), 'moid': (str,), 'owners': ([str], none_type), 'shared_scope': (str,), 'tags': ([MoTag], none_type), 'version_context': (MoVersionContext,), 'ancestors': ([MoBaseMoRelationship], none_type), 'parent': (MoBaseMoRelationship,), 'permission_resources': ([MoBaseMoRelationship], none_type), 'display_names': (DisplayNames,), 'registered_device': (AssetDeviceRegistrationRelationship,)}

    @cached_property
    def discriminator():
        lazy_import()
        val = {'cloud.AwsNetworkInterface': CloudAwsNetworkInterface, 'cloud.BaseNetworkInterface': CloudBaseNetworkInterface, 'virtualization.IweVirtualMachineNetworkInterface': VirtualizationIweVirtualMachineNetworkInterface}
        if not val:
            return None
        return {'class_id': val}
    attribute_map = {'class_id': 'ClassId', 'object_type': 'ObjectType', 'adapter_type': 'AdapterType', 'mac_address': 'MacAddress', 'name': 'Name', 'account_moid': 'AccountMoid', 'create_time': 'CreateTime', 'domain_group_moid': 'DomainGroupMoid', 'mod_time': 'ModTime', 'moid': 'Moid', 'owners': 'Owners', 'shared_scope': 'SharedScope', 'tags': 'Tags', 'version_context': 'VersionContext', 'ancestors': 'Ancestors', 'parent': 'Parent', 'permission_resources': 'PermissionResources', 'display_names': 'DisplayNames', 'registered_device': 'RegisteredDevice'}
    read_only_vars = {'account_moid', 'create_time', 'domain_group_moid', 'mod_time', 'shared_scope', 'ancestors', 'permission_resources'}
    ...
    def _composed_schemas():
        lazy_import()
        return {'anyOf': [], 'allOf': [VirtualizationBaseSourceDevice, VirtualizationBaseVirtualNetworkInterfaceCardAllOf], 'oneOf': []}