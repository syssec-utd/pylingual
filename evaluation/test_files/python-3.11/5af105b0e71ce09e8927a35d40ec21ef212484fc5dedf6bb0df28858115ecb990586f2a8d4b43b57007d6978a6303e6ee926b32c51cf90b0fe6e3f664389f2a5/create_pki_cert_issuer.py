...
class CreatePKICertIssuer(object):
    ...
    openapi_types = {'allow_any_name': 'bool', 'allow_subdomains': 'bool', 'allowed_domains': 'str', 'allowed_uri_sans': 'str', 'client_flag': 'bool', 'code_signing_flag': 'bool', 'country': 'str', 'delete_protection': 'str', 'description': 'str', 'json': 'bool', 'key_usage': 'str', 'locality': 'str', 'metadata': 'str', 'name': 'str', 'not_enforce_hostnames': 'bool', 'not_require_cn': 'bool', 'organizational_units': 'str', 'organizations': 'str', 'postal_code': 'str', 'province': 'str', 'server_flag': 'bool', 'signer_key_name': 'str', 'street_address': 'str', 'tag': 'list[str]', 'token': 'str', 'ttl': 'int', 'uid_token': 'str'}
    attribute_map = {'allow_any_name': 'allow-any-name', 'allow_subdomains': 'allow-subdomains', 'allowed_domains': 'allowed-domains', 'allowed_uri_sans': 'allowed-uri-sans', 'client_flag': 'client-flag', 'code_signing_flag': 'code-signing-flag', 'country': 'country', 'delete_protection': 'delete_protection', 'description': 'description', 'json': 'json', 'key_usage': 'key-usage', 'locality': 'locality', 'metadata': 'metadata', 'name': 'name', 'not_enforce_hostnames': 'not-enforce-hostnames', 'not_require_cn': 'not-require-cn', 'organizational_units': 'organizational-units', 'organizations': 'organizations', 'postal_code': 'postal-code', 'province': 'province', 'server_flag': 'server-flag', 'signer_key_name': 'signer-key-name', 'street_address': 'street-address', 'tag': 'tag', 'token': 'token', 'ttl': 'ttl', 'uid_token': 'uid-token'}
    ...
    def __init__(self, allow_any_name=None, allow_subdomains=None, allowed_domains=None, allowed_uri_sans=None, client_flag=None, code_signing_flag=None, country=None, delete_protection=None, description=None, json=False, key_usage='DigitalSignature,KeyAgreement,KeyEncipherment', locality=None, metadata=None, name=None, not_enforce_hostnames=None, not_require_cn=None, organizational_units=None, organizations=None, postal_code=None, province=None, server_flag=None, signer_key_name=None, street_address=None, tag=None, token=None, ttl=None, uid_token=None, local_vars_configuration=None):
        """CreatePKICertIssuer - a model defined in OpenAPI"""
    ...
    def signer_key_name(self, signer_key_name):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and signer_key_name is None:
            raise ValueError('Invalid value for `signer_key_name`, must not be `None`')
    ...
    def ttl(self, ttl):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and ttl is None:
