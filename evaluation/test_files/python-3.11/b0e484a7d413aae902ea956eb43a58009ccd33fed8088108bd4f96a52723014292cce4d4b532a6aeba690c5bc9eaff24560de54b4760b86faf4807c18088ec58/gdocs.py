...
class GoogleDocsReader(BaseReader):
    ...
    def __init__(self) -> None:
        ...
        try:
            ...
            raise ImportError('`google_auth_oauthlib`, `googleapiclient` and `google` must be installed to use the GoogleDocsReader.\nPlease run `pip install --upgrade google-api-python-client google-auth-httplib2 google-auth-oauthlib`.')
...
if __name__ == '__main__':
    ...
    logger.info(reader.load_data(document_ids=['11ctUj_tEf5S8vs_dk8_BNi-Zk8wW5YFhXkKqtmU_4B8']))