...
class AnalyticsConversation(object):
    ...
    def __init__(self):
        ...
        """
        self.swagger_types = {'conversation_end': 'datetime', 'conversation_id': 'str', 'conversation_initiator': 'str', 'conversation_start': 'datetime', 'customer_participation': 'bool', 'division_ids': 'list[str]', 'external_tag': 'str', 'knowledge_base_ids': 'list[str]', 'media_stats_min_conversation_mos': 'float', 'media_stats_min_conversation_r_factor': 'float', 'originating_direction': 'str', 'self_served': 'bool', 'evaluations': 'list[AnalyticsEvaluation]', 'surveys': 'list[AnalyticsSurvey]', 'resolutions': 'list[AnalyticsResolution]', 'participants': 'list[AnalyticsParticipant]'}
        self.attribute_map = {'conversation_end': 'conversationEnd', 'conversation_id': 'conversationId', 'conversation_initiator': 'conversationInitiator', 'conversation_start': 'conversationStart', 'customer_participation': 'customerParticipation', 'division_ids': 'divisionIds', 'external_tag': 'externalTag', 'knowledge_base_ids': 'knowledgeBaseIds', 'media_stats_min_conversation_mos': 'mediaStatsMinConversationMos', 'media_stats_min_conversation_r_factor': 'mediaStatsMinConversationRFactor', 'originating_direction': 'originatingDirection', 'self_served': 'selfServed', 'evaluations': 'evaluations', 'surveys': 'surveys', 'resolutions': 'resolutions', 'participants': 'participants'}
    ...
    def conversation_initiator(self):
        """
        Gets the conversation_initiator of this AnalyticsConversation.
        Indicates the participant purpose of the participant initiating a message conversation

        :return: The conversation_initiator of this AnalyticsConversation.
        :rtype: str
        """
    ...
    def conversation_initiator(self, conversation_initiator):
        """
        Sets the conversation_initiator of this AnalyticsConversation.
        Indicates the participant purpose of the participant initiating a message conversation
    ...
    def customer_participation(self):
        """
        Gets the customer_participation of this AnalyticsConversation.
        Indicates a messaging conversation in which the customer participated by sending at least one message

        :return: The customer_participation of this AnalyticsConversation.
        :rtype: bool
        """
    ...
    def customer_participation(self, customer_participation):
        """
        Sets the customer_participation of this AnalyticsConversation.
        Indicates a messaging conversation in which the customer participated by sending at least one message

        :param customer_participation: The customer_participation of this AnalyticsConversation.
        :type: bool
        """
