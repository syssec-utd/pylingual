...
class CreateAgentTimeOffRequest(object):
    ...
    def __init__(self):
        ...
        """
        self.swagger_types = {'activity_code_id': 'str', 'notes': 'str', 'full_day_management_unit_dates': 'list[str]', 'partial_day_start_date_times': 'list[datetime]', 'daily_duration_minutes': 'int'}
        self.attribute_map = {'activity_code_id': 'activityCodeId', 'notes': 'notes', 'full_day_management_unit_dates': 'fullDayManagementUnitDates', 'partial_day_start_date_times': 'partialDayStartDateTimes', 'daily_duration_minutes': 'dailyDurationMinutes'}
