...
class RouteTableForDescribeSubnetAttributesOutput(object):
    ...
    swagger_types = {'route_table_id': 'str', 'route_table_type': 'str'}
    attribute_map = {'route_table_id': 'RouteTableId', 'route_table_type': 'RouteTableType'}

    def __init__(self, route_table_id=None, route_table_type=None, _configuration=None):
        """RouteTableForDescribeSubnetAttributesOutput - a model defined in Swagger"""
