...
class GatewayUpdateK8SAuthConfigOutput(object):
    ...
    openapi_types = {'cluster_id': 'str', 'parts_change': 'ConfigChange', 'total_hash': 'str'}
    attribute_map = {'cluster_id': 'cluster_id', 'parts_change': 'parts_change', 'total_hash': 'total_hash'}

    def __init__(self, cluster_id=None, parts_change=None, total_hash=None, local_vars_configuration=None):
        """GatewayUpdateK8SAuthConfigOutput - a model defined in OpenAPI"""
