...
class Dimension(object):
    ...
    def __init__(self, value):
        ...
        if value is None:
            ...
            if not isinstance(value, compat.bytes_or_text_types) and self._value != value:
  ...
  """
    ...
    """
        if dims is None:
            ...
            raise TypeError('A string has ambiguous TensorShape, please wrap in a list or convert to an int: %s' % dims)
    ...
    * TensorShape([1, 2, 3]) is the most specific TensorShape compatible with
    ...
    def as_proto(self):
        ...
        if self._dims is None:
            ...
            return tensor_shape_pb2.TensorShapeProto(dim=[tensor_shape_pb2.TensorShapeProto.Dim(size=-1 if d.value is None else d.value) for d in self._dims])
