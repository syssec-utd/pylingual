...
class TextLog(ScrollView, can_focus=True):
    ...
    def __init__(self, *, max_lines: int | None=None, min_width: int=78, wrap: bool=False, highlight: bool=False, markup: bool=False, name: str | None=None, id: str | None=None, classes: str | None=None, disabled: bool=False) -> None:
    ...
    def write(self, content: RenderableType | object, width: int | None=None, expand: bool=False, shrink: bool=True) -> None:
    ...
    def _render_line(self, y: int, scroll_x: int, width: int) -> Strip:
        ...
        line = self.lines[y].adjust_cell_length(max(self.max_width, width), self.rich_style).crop(scroll_x, scroll_x + width)
