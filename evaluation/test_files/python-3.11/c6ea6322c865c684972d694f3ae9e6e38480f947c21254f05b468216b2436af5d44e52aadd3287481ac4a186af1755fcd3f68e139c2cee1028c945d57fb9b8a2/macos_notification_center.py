...
class MacOSNotificationCenterTest(test_lib.SQLitePluginTestCase):
    ...
    def testProcess(self):
        ...
        self.assertEqual(number_of_warnings, 0)
        expected_event_values = {'body': 'KeePassXC can now be run', 'bundle_name': 'com.google.santagui', 'creation_time': '2018-05-02T10:59:18.930155+00:00', 'data_type': 'macos:notification_center:entry', 'presented': 1, 'title': 'Santa'}
