...
class ListItems(object):
    ...
    openapi_types = {'accessibility': 'str', 'filter': 'str', 'json': 'bool', 'minimal_view': 'bool', 'pagination_token': 'str', 'path': 'str', 'sub_types': 'list[str]', 'tag': 'str', 'token': 'str', 'type': 'list[str]', 'uid_token': 'str'}
    attribute_map = {'accessibility': 'accessibility', 'filter': 'filter', 'json': 'json', 'minimal_view': 'minimal-view', 'pagination_token': 'pagination-token', 'path': 'path', 'sub_types': 'sub_types', 'tag': 'tag', 'token': 'token', 'type': 'type', 'uid_token': 'uid-token'}

    def __init__(self, accessibility='regular', filter=None, json=False, minimal_view=None, pagination_token=None, path=None, sub_types=None, tag=None, token=None, type=None, uid_token=None, local_vars_configuration=None):
        """ListItems - a model defined in OpenAPI"""
