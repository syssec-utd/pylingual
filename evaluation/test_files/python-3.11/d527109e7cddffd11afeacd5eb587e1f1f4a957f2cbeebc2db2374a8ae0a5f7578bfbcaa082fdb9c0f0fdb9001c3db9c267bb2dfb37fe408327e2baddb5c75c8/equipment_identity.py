...
class EquipmentIdentity(ModelComposed):
    ...
    """
    allowed_values = {('class_id',): {'COMPUTE.BLADEIDENTITY': 'compute.BladeIdentity', 'COMPUTE.RACKUNITIDENTITY': 'compute.RackUnitIdentity', 'EQUIPMENT.CHASSISIDENTITY': 'equipment.ChassisIdentity', 'EQUIPMENT.FEXIDENTITY': 'equipment.FexIdentity', 'FABRIC.ELEMENTIDENTITY': 'fabric.ElementIdentity'}, ('object_type',): {'COMPUTE.BLADEIDENTITY': 'compute.BladeIdentity', 'COMPUTE.RACKUNITIDENTITY': 'compute.RackUnitIdentity', 'EQUIPMENT.CHASSISIDENTITY': 'equipment.ChassisIdentity', 'EQUIPMENT.FEXIDENTITY': 'equipment.FexIdentity', 'FABRIC.ELEMENTIDENTITY': 'fabric.ElementIdentity'}, ('admin_action',): {'NONE': 'None', 'DECOMMISSION': 'Decommission', 'RECOMMISSION': 'Recommission', 'REACK': 'Reack', 'REMOVE': 'Remove', 'REPLACE': 'Replace'}, ('admin_action_state',): {'NONE': 'None', 'APPLIED': 'Applied', 'APPLYING': 'Applying', 'FAILED': 'Failed'}, ('lifecycle',): {'NONE': 'None', 'ACTIVE': 'Active', 'DECOMMISSIONED': 'Decommissioned', 'DECOMMISSIONINPROGRESS': 'DecommissionInProgress', 'RECOMMISSIONINPROGRESS': 'RecommissionInProgress', 'OPERATIONFAILED': 'OperationFailed', 'REACKINPROGRESS': 'ReackInProgress', 'REMOVEINPROGRESS': 'RemoveInProgress', 'DISCOVERED': 'Discovered', 'DISCOVERYINPROGRESS': 'DiscoveryInProgress', 'DISCOVERYFAILED': 'DiscoveryFailed', 'FIRMWAREUPGRADEINPROGRESS': 'FirmwareUpgradeInProgress', 'BLADEMIGRATIONINPROGRESS': 'BladeMigrationInProgress', 'INACTIVE': 'Inactive', 'REPLACEINPROGRESS': 'ReplaceInProgress', 'SLOTMISMATCH': 'SlotMismatch'}}
    validations = {('identifier',): {'inclusive_minimum': 1}}
    ...
    def openapi_types():
        ...
        """
        lazy_import()
        return {'class_id': (str,), 'object_type': (str,), 'admin_action': (str,), 'admin_action_state': (str,), 'identifier': (int,), 'lifecycle': (str,), 'model': (str,), 'serial': (str,), 'vendor': (str,), 'registered_device': (AssetDeviceRegistrationRelationship,), 'account_moid': (str,), 'create_time': (datetime,), 'domain_group_moid': (str,), 'mod_time': (datetime,), 'moid': (str,), 'owners': ([str], none_type), 'shared_scope': (str,), 'tags': ([MoTag], none_type), 'version_context': (MoVersionContext,), 'ancestors': ([MoBaseMoRelationship], none_type), 'parent': (MoBaseMoRelationship,), 'permission_resources': ([MoBaseMoRelationship], none_type), 'display_names': (DisplayNames,)}

    @cached_property
    def discriminator():
        lazy_import()
        val = {'compute.BladeIdentity': ComputeBladeIdentity, 'compute.RackUnitIdentity': ComputeRackUnitIdentity, 'equipment.ChassisIdentity': EquipmentChassisIdentity, 'equipment.FexIdentity': EquipmentFexIdentity, 'equipment.PhysicalIdentity': EquipmentPhysicalIdentity, 'fabric.ElementIdentity': FabricElementIdentity}
        if not val:
            return None
        return {'class_id': val}
    attribute_map = {'class_id': 'ClassId', 'object_type': 'ObjectType', 'admin_action': 'AdminAction', 'admin_action_state': 'AdminActionState', 'identifier': 'Identifier', 'lifecycle': 'Lifecycle', 'model': 'Model', 'serial': 'Serial', 'vendor': 'Vendor', 'registered_device': 'RegisteredDevice', 'account_moid': 'AccountMoid', 'create_time': 'CreateTime', 'domain_group_moid': 'DomainGroupMoid', 'mod_time': 'ModTime', 'moid': 'Moid', 'owners': 'Owners', 'shared_scope': 'SharedScope', 'tags': 'Tags', 'version_context': 'VersionContext', 'ancestors': 'Ancestors', 'parent': 'Parent', 'permission_resources': 'PermissionResources', 'display_names': 'DisplayNames'}
    read_only_vars = {'admin_action_state', 'lifecycle', 'model', 'serial', 'vendor', 'account_moid', 'create_time', 'domain_group_moid', 'mod_time', 'shared_scope', 'ancestors', 'permission_resources'}

    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):
    ...
    def _composed_schemas():
        lazy_import()
        return {'anyOf': [], 'allOf': [EquipmentIdentityAllOf, MoBaseMo], 'oneOf': []}