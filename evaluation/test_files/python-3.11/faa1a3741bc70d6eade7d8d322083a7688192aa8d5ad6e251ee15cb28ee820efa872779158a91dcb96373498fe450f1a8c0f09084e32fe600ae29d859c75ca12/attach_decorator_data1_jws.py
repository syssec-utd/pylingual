...
from pydantic import AnyUrl, BaseModel, EmailStr, validator, Field, Extra
...
class AttachDecoratorData1JWS(BaseModel):
    ...
    def __init__(self, *, header: AttachDecoratorDataJWSHeader=None, signature: str=None, protected: Optional[str]=None, **kwargs):
        super().__init__(header=header, protected=protected, signature=signature, **kwargs)
